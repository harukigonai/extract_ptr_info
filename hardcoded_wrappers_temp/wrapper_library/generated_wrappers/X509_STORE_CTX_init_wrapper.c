...
int bb_X509_STORE_CTX_init(X509_STORE_CTX * arg_a,X509_STORE * arg_b,X509 * arg_c,STACK_OF(X509) * arg_d) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            8884097, 8, 0, /* 4272: pointer.func */
            8884097, 8, 0, /* 4275: pointer.func */
            8884097, 8, 0, /* 4278: pointer.func */
            8884097, 8, 0, /* 4281: pointer.func */
            8884097, 8, 0, /* 4284: pointer.func */
            1, 8, 1, /* 4287: pointer.struct.X509_VERIFY_PARAM_st */
            	4292, 0,
            0, 56, 2, /* 4292: struct.X509_VERIFY_PARAM_st */
            	98, 0,
            	4299, 48,
            1, 8, 1, /* 4299: pointer.struct.stack_st_ASN1_OBJECT */
            	4304, 0,
            0, 32, 2, /* 4304: struct.stack_st_fake_ASN1_OBJECT */
            	4311, 8,
            	365, 24,
            8884099, 8, 2, /* 4311: pointer_to_array_of_pointers_to_stack */
            	4318, 0,
            	362, 20,
            0, 8, 1, /* 4318: pointer.ASN1_OBJECT */
            	1306, 0,
            1, 8, 1, /* 4323: pointer.struct.stack_st_X509_LOOKUP */
            	4328, 0,
            0, 32, 2, /* 4328: struct.stack_st_fake_X509_LOOKUP */
            	4335, 8,
            	365, 24,
            8884099, 8, 2, /* 4335: pointer_to_array_of_pointers_to_stack */
            	4342, 0,
            	362, 20,
            0, 8, 1, /* 4342: pointer.X509_LOOKUP */
            	4347, 0,
            0, 0, 1, /* 4347: X509_LOOKUP */
            	4352, 0,
            0, 32, 3, /* 4352: struct.x509_lookup_st */
            	4361, 8,
            	98, 16,
            	4410, 24,
            1, 8, 1, /* 4361: pointer.struct.x509_lookup_method_st */
            	4366, 0,
            0, 80, 10, /* 4366: struct.x509_lookup_method_st */
            	129, 0,
            	4389, 8,
            	4392, 16,
            	4389, 24,
            ...
            1, 8, 1, /* 4410: pointer.struct.x509_store_st */
            	4415, 0,
            0, 144, 15, /* 4415: struct.x509_store_st */
            	4448, 8,
            	4323, 16,
            	4287, 24,
            	4284, 32,
            	...
            	4284, 112,
            	4674, 120,
            1, 8, 1, /* 4448: pointer.struct.stack_st_X509_OBJECT */
            	4453, 0,
            0, 32, 2, /* 4453: struct.stack_st_fake_X509_OBJECT */
            	4460, 8,
            	365, 24,
            8884099, 8, 2, /* 4460: pointer_to_array_of_pointers_to_stack */
            	4467, 0,
            	362, 20,
            0, 8, 1, /* 4467: pointer.X509_OBJECT */
            	4472, 0,
            0, 0, 1, /* 4472: X509_OBJECT */
            	4477, 0,
            0, 16, 1, /* 4477: struct.x509_object_st */
            	4482, 8,
            0, 8, 4, /* 4482: union.unknown */
            	98, 0,
            	4493, 0,
            	4806, 0,
            	4882, 0,
            1, 8, 1, /* 4493: pointer.struct.x509_st */
            	4498, 0,
            0, 184, 12, /* 4498: struct.x509_st */
            	4525, 0,
            	4565, 8,
            	4640, 16,
            	98, 32,
            	...
            	4754, 144,
            	4759, 176,
            1, 8, 1, /* 4525: pointer.struct.x509_cinf_st */
            	4530, 0,
            0, 104, 11, /* 4530: struct.x509_cinf_st */
            	4555, 0,
            	4555, 8,
            	4565, 16,
            	4570, 24,
            ...
            1, 8, 1, /* 4555: pointer.struct.asn1_string_st */
            	4560, 0,
            0, 24, 1, /* 4560: struct.asn1_string_st */
            	205, 8,
            1, 8, 1, /* 4565: pointer.struct.X509_algor_st */
            	477, 0,
            ...
            0, 32, 2, /* 4589: struct.stack_st_fake_X509_NAME_ENTRY */
            	4596, 8,
            	365, 24,
            8884099, 8, 2, /* 4596: pointer_to_array_of_pointers_to_stack */
            	4603, 0,
            	362, 20,
            ...
            1, 8, 1, /* 4640: pointer.struct.asn1_string_st */
            	4560, 0,
            1, 8, 1, /* 4645: pointer.struct.stack_st_X509_EXTENSION */
            	4650, 0,
            0, 32, 2, /* 4650: struct.stack_st_fake_X509_EXTENSION */
            	4657, 8,
            	365, 24,
            8884099, 8, 2, /* 4657: pointer_to_array_of_pointers_to_stack */
            	4664, 0,
            	362, 20,
            0, 8, 1, /* 4664: pointer.X509_EXTENSION */
            	723, 0,
            0, 24, 1, /* 4669: struct.ASN1_ENCODING_st */
            	205, 0,
            0, 16, 1, /* 4674: struct.crypto_ex_data_st */
            	4679, 0,
            1, 8, 1, /* 4679: pointer.struct.stack_st_void */
            	4684, 0,
            0, 32, 1, /* 4684: struct.stack_st_void */
            	4689, 0,
            0, 32, 2, /* 4689: struct.stack_st */
            	939, 8,
            	365, 24,
            1, 8, 1, /* 4696: pointer.struct.asn1_string_st */
            	4560, 0,
            1, 8, 1, /* 4701: pointer.struct.X509_POLICY_CACHE_st */
            	3577, 0,
            1, 8, 1, /* 4706: pointer.struct.stack_st_DIST_POINT */
            	4711, 0,
            0, 32, 2, /* 4711: struct.stack_st_fake_DIST_POINT */
            	4718, 8,
            	365, 24,
            8884099, 8, 2, /* 4718: pointer_to_array_of_pointers_to_stack */
            	4725, 0,
            	362, 20,
            0, 8, 1, /* 4725: pointer.DIST_POINT */
            	1540, 0,
            1, 8, 1, /* 4730: pointer.struct.stack_st_GENERAL_NAME */
            	4735, 0,
            0, 32, 2, /* 4735: struct.stack_st_fake_GENERAL_NAME */
            	4742, 8,
            	365, 24,
            8884099, 8, 2, /* 4742: pointer_to_array_of_pointers_to_stack */
            	4749, 0,
            	362, 20,
            0, 8, 1, /* 4749: pointer.GENERAL_NAME */
            	55, 0,
            1, 8, 1, /* 4754: pointer.struct.NAME_CONSTRAINTS_st */
            	3689, 0,
            1, 8, 1, /* 4759: pointer.struct.x509_cert_aux_st */
            	4764, 0,
            0, 40, 5, /* 4764: struct.x509_cert_aux_st */
            	4299, 0,
            	4299, 8,
            	4777, 16,
            	4696, 24,
            	4782, 32,
            1, 8, 1, /* 4777: pointer.struct.asn1_string_st */
            	4560, 0,
            1, 8, 1, /* 4782: pointer.struct.stack_st_X509_ALGOR */
            	4787, 0,
            0, 32, 2, /* 4787: struct.stack_st_fake_X509_ALGOR */
            	4794, 8,
            	365, 24,
            8884099, 8, 2, /* 4794: pointer_to_array_of_pointers_to_stack */
            	4801, 0,
            	362, 20,
            0, 8, 1, /* 4801: pointer.X509_ALGOR */
            	1482, 0,
            1, 8, 1, /* 4806: pointer.struct.X509_crl_st */
            	4811, 0,
            0, 120, 10, /* 4811: struct.X509_crl_st */
            	4834, 0,
            	4565, 8,
            	4640, 16,
            	4218, 32,
            	...
            	944, 104,
            	969, 112,
            1, 8, 1, /* 4834: pointer.struct.X509_crl_info_st */
            	4839, 0,
            0, 80, 8, /* 4839: struct.X509_crl_info_st */
            	4555, 0,
            	4565, 8,
            	4570, 16,
            	4630, 24,
            	...
            	4645, 48,
            	4669, 56,
            1, 8, 1, /* 4858: pointer.struct.stack_st_X509_REVOKED */
            	4863, 0,
            0, 32, 2, /* 4863: struct.stack_st_fake_X509_REVOKED */
            	4870, 8,
            	365, 24,
            8884099, 8, 2, /* 4870: pointer_to_array_of_pointers_to_stack */
            	4877, 0,
            	362, 20,
            0, 8, 1, /* 4877: pointer.X509_REVOKED */
            	668, 0,
            1, 8, 1, /* 4882: pointer.struct.evp_pkey_st */
            	4887, 0,
            0, 56, 4, /* 4887: struct.evp_pkey_st */
            	4898, 16,
            	2314, 24,
            	4903, 32,
            	4936, 48,
            1, 8, 1, /* 4898: pointer.struct.evp_pkey_asn1_method_st */
            	1760, 0,
            0, 8, 5, /* 4903: union.unknown */
            	98, 0,
            	4916, 0,
            	4921, 0,
            	4926, 0,
            	4931, 0,
            1, 8, 1, /* 4916: pointer.struct.rsa_st */
            	2222, 0,
            1, 8, 1, /* 4921: pointer.struct.dsa_st */
            	2432, 0,
            1, 8, 1, /* 4926: pointer.struct.dh_st */
            	2559, 0,
            1, 8, 1, /* 4931: pointer.struct.ec_key_st */
            	2673, 0,
            1, 8, 1, /* 4936: pointer.struct.stack_st_X509_ATTRIBUTE */
            	4941, 0,
            0, 32, 2, /* 4941: struct.stack_st_fake_X509_ATTRIBUTE */
            	4948, 8,
            	365, 24,
            8884099, 8, 2, /* 4948: pointer_to_array_of_pointers_to_stack */
            	4955, 0,
            	362, 20,
            0, 8, 1, /* 4955: pointer.X509_ATTRIBUTE */
            	3180, 0,
            8884097, 8, 0, /* 4960: pointer.func */
            8884097, 8, 0, /* 4963: pointer.func */
            8884097, 8, 0, /* 4966: pointer.func */
            8884097, 8, 0, /* 4969: pointer.func */
            0, 144, 15, /* 4972: struct.x509_store_st */
            	5005, 8,
            	5029, 16,
            	5053, 24,
            	4269, 32,
            	...
            	4269, 112,
            	5101, 120,
            1, 8, 1, /* 5005: pointer.struct.stack_st_X509_OBJECT */
            	5010, 0,
            0, 32, 2, /* 5010: struct.stack_st_fake_X509_OBJECT */
            	5017, 8,
            	365, 24,
            8884099, 8, 2, /* 5017: pointer_to_array_of_pointers_to_stack */
            	5024, 0,
            	362, 20,
            0, 8, 1, /* 5024: pointer.X509_OBJECT */
            	4472, 0,
            1, 8, 1, /* 5029: pointer.struct.stack_st_X509_LOOKUP */
            	5034, 0,
            0, 32, 2, /* 5034: struct.stack_st_fake_X509_LOOKUP */
            	5041, 8,
            	365, 24,
            8884099, 8, 2, /* 5041: pointer_to_array_of_pointers_to_stack */
            	5048, 0,
            	362, 20,
            0, 8, 1, /* 5048: pointer.X509_LOOKUP */
            	4347, 0,
            1, 8, 1, /* 5053: pointer.struct.X509_VERIFY_PARAM_st */
            	5058, 0,
            0, 56, 2, /* 5058: struct.X509_VERIFY_PARAM_st */
            	98, 0,
            	5065, 48,
            1, 8, 1, /* 5065: pointer.struct.stack_st_ASN1_OBJECT */
            	5070, 0,
            0, 32, 2, /* 5070: struct.stack_st_fake_ASN1_OBJECT */
            	5077, 8,
            	365, 24,
            8884099, 8, 2, /* 5077: pointer_to_array_of_pointers_to_stack */
            	5084, 0,
            	362, 20,
            0, 8, 1, /* 5084: pointer.ASN1_OBJECT */
            	1306, 0,
            8884097, 8, 0, /* 5089: pointer.func */
            8884097, 8, 0, /* 5092: pointer.func */
            8884097, 8, 0, /* 5095: pointer.func */
            8884097, 8, 0, /* 5098: pointer.func */
            0, 16, 1, /* 5101: struct.crypto_ex_data_st */
            	5106, 0,
            1, 8, 1, /* 5106: pointer.struct.stack_st_void */
            	5111, 0,
            0, 32, 1, /* 5111: struct.stack_st_void */
            	5116, 0,
            0, 32, 2, /* 5116: struct.stack_st */
            	939, 8,
            	365, 24,
            ...
            0, 16, 2, /* 5128: struct.X509_val_st */
            	639, 0,
            	639, 8,
            1, 8, 1, /* 5135: pointer.struct.X509_val_st */
            	5140, 0,
            0, 16, 2, /* 5140: struct.X509_val_st */
            	5147, 0,
            	5147, 8,
            1, 8, 1, /* 5147: pointer.struct.asn1_string_st */
            	5152, 0,
            0, 24, 1, /* 5152: struct.asn1_string_st */
            	205, 8,
            0, 40, 5, /* 5157: struct.x509_cert_aux_st */
            	5065, 0,
            	5065, 8,
            	5170, 16,
            	5175, 24,
            	5180, 32,
            1, 8, 1, /* 5170: pointer.struct.asn1_string_st */
            	443, 0,
            1, 8, 1, /* 5175: pointer.struct.asn1_string_st */
            	443, 0,
            1, 8, 1, /* 5180: pointer.struct.stack_st_X509_ALGOR */
            	5185, 0,
            0, 32, 2, /* 5185: struct.stack_st_fake_X509_ALGOR */
            	5192, 8,
            	365, 24,
            8884099, 8, 2, /* 5192: pointer_to_array_of_pointers_to_stack */
            	5199, 0,
            	362, 20,
            0, 8, 1, /* 5199: pointer.X509_ALGOR */
            	1482, 0,
            1, 8, 1, /* 5204: pointer.struct.x509_cert_aux_st */
            	5157, 0,
            1, 8, 1, /* 5209: pointer.struct.x509_st */
            	5214, 0,
            0, 184, 12, /* 5214: struct.x509_st */
            	5241, 0,
            	472, 8,
            	438, 16,
            	98, 32,
            	...
            	5324, 144,
            	5204, 176,
            1, 8, 1, /* 5241: pointer.struct.x509_cinf_st */
            	5246, 0,
            0, 104, 11, /* 5246: struct.x509_cinf_st */
            	467, 0,
            	467, 8,
            	472, 16,
            	414, 24,
            	...
            	783, 72,
            	807, 80,
            1, 8, 1, /* 5271: pointer.struct.X509_pubkey_st */
            	1715, 0,
            1, 8, 1, /* 5276: pointer.struct.stack_st_DIST_POINT */
            	5281, 0,
            0, 32, 2, /* 5281: struct.stack_st_fake_DIST_POINT */
            	5288, 8,
            	365, 24,
            8884099, 8, 2, /* 5288: pointer_to_array_of_pointers_to_stack */
            	5295, 0,
            	362, 20,
            0, 8, 1, /* 5295: pointer.DIST_POINT */
            	1540, 0,
            1, 8, 1, /* 5300: pointer.struct.stack_st_GENERAL_NAME */
            	5305, 0,
            0, 32, 2, /* 5305: struct.stack_st_fake_GENERAL_NAME */
            	5312, 8,
            	365, 24,
            8884099, 8, 2, /* 5312: pointer_to_array_of_pointers_to_stack */
            	5319, 0,
            	362, 20,
            0, 8, 1, /* 5319: pointer.GENERAL_NAME */
            	55, 0,
            1, 8, 1, /* 5324: pointer.struct.NAME_CONSTRAINTS_st */
            	3689, 0,
            1, 8, 1, /* 5329: pointer.struct.X509_name_st */
            	5334, 0,
            0, 40, 3, /* 5334: struct.X509_name_st */
            	5343, 0,
            	5367, 16,
            	205, 24,
            1, 8, 1, /* 5343: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5348, 0,
            0, 32, 2, /* 5348: struct.stack_st_fake_X509_NAME_ENTRY */
            	5355, 8,
            	365, 24,
            8884099, 8, 2, /* 5355: pointer_to_array_of_pointers_to_stack */
            	5362, 0,
            	362, 20,
            0, 8, 1, /* 5362: pointer.X509_NAME_ENTRY */
            	326, 0,
            1, 8, 1, /* 5367: pointer.struct.buf_mem_st */
            	5372, 0,
            0, 24, 1, /* 5372: struct.buf_mem_st */
            	98, 8,
            1, 8, 1, /* 5377: pointer.struct.x509_cinf_st */
            	5382, 0,
            0, 104, 11, /* 5382: struct.x509_cinf_st */
            	5407, 0,
            	5407, 8,
            	5412, 16,
            	5329, 24,
            	...
            	5427, 72,
            	5451, 80,
            1, 8, 1, /* 5407: pointer.struct.asn1_string_st */
            	5152, 0,
            1, 8, 1, /* 5412: pointer.struct.X509_algor_st */
            	477, 0,
            1, 8, 1, /* 5417: pointer.struct.X509_pubkey_st */
            	1715, 0,
            1, 8, 1, /* 5422: pointer.struct.asn1_string_st */
            	5152, 0,
            1, 8, 1, /* 5427: pointer.struct.stack_st_X509_EXTENSION */
            	5432, 0,
            0, 32, 2, /* 5432: struct.stack_st_fake_X509_EXTENSION */
            	5439, 8,
            	365, 24,
            8884099, 8, 2, /* 5439: pointer_to_array_of_pointers_to_stack */
            	5446, 0,
            	362, 20,
            0, 8, 1, /* 5446: pointer.X509_EXTENSION */
            	723, 0,
            0, 24, 1, /* 5451: struct.ASN1_ENCODING_st */
            	205, 0,
            0, 0, 1, /* 5456: X509 */
            	5461, 0,
            0, 184, 12, /* 5461: struct.x509_st */
            	5377, 0,
            	5412, 8,
            	5422, 16,
            	98, 32,
            	...
            	5527, 144,
            	5532, 176,
            1, 8, 1, /* 5488: pointer.struct.asn1_string_st */
            	5152, 0,
            1, 8, 1, /* 5493: pointer.struct.AUTHORITY_KEYID_st */
            	850, 0,
            1, 8, 1, /* 5498: pointer.struct.X509_POLICY_CACHE_st */
            	3577, 0,
            1, 8, 1, /* 5503: pointer.struct.stack_st_DIST_POINT */
            	5508, 0,
            0, 32, 2, /* 5508: struct.stack_st_fake_DIST_POINT */
            	5515, 8,
            	365, 24,
            8884099, 8, 2, /* 5515: pointer_to_array_of_pointers_to_stack */
            	5522, 0,
            	362, 20,
            0, 8, 1, /* 5522: pointer.DIST_POINT */
            	1540, 0,
            1, 8, 1, /* 5527: pointer.struct.NAME_CONSTRAINTS_st */
            	3689, 0,
            1, 8, 1, /* 5532: pointer.struct.x509_cert_aux_st */
            	5537, 0,
            0, 40, 5, /* 5537: struct.x509_cert_aux_st */
            	5550, 0,
            	5550, 8,
            	5574, 16,
            	5488, 24,
            	5579, 32,
            1, 8, 1, /* 5550: pointer.struct.stack_st_ASN1_OBJECT */
            	5555, 0,
            0, 32, 2, /* 5555: struct.stack_st_fake_ASN1_OBJECT */
            	5562, 8,
            	365, 24,
            8884099, 8, 2, /* 5562: pointer_to_array_of_pointers_to_stack */
            	5569, 0,
            	362, 20,
            0, 8, 1, /* 5569: pointer.ASN1_OBJECT */
            	1306, 0,
            1, 8, 1, /* 5574: pointer.struct.asn1_string_st */
            	5152, 0,
            1, 8, 1, /* 5579: pointer.struct.stack_st_X509_ALGOR */
            	5584, 0,
            0, 32, 2, /* 5584: struct.stack_st_fake_X509_ALGOR */
            	5591, 8,
            	365, 24,
            8884099, 8, 2, /* 5591: pointer_to_array_of_pointers_to_stack */
            	5598, 0,
            	362, 20,
            0, 8, 1, /* 5598: pointer.X509_ALGOR */
            	1482, 0,
            1, 8, 1, /* 5603: pointer.struct.x509_store_st */
            	4972, 0,
            1, 8, 1, /* 5608: pointer.struct.X509_POLICY_TREE_st */
            	4039, 0,
            1, 8, 1, /* 5613: pointer.struct.stack_st_X509 */
            	5618, 0,
            0, 32, 2, /* 5618: struct.stack_st_fake_X509 */
            	5625, 8,
            	365, 24,
            8884099, 8, 2, /* 5625: pointer_to_array_of_pointers_to_stack */
            	5632, 0,
            	362, 20,
            0, 8, 1, /* 5632: pointer.X509 */
            	5456, 0,
            0, 1, 0, /* 5637: char */
            1, 8, 1, /* 5640: pointer.struct.x509_store_ctx_st */
            	5645, 0,
            0, 248, 25, /* 5645: struct.x509_store_ctx_st */
            	5603, 0,
            	5209, 16,
            	5613, 24,
            	4233, 32,
        ...
        .arg_entity_index = { 5640, 5603, 5209, 5613, },
