    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 1, /* 5107: X509_NAME */
            	5055, 0,
            0, 80, 9, /* 5112: struct.bio_method_st */
            	5, 8,
            	5133, 16,
            	5136, 24,
            	5139, 32,
            ...
            8884097, 8, 0, /* 5151: pointer.func */
            1, 8, 1, /* 5154: pointer.struct.bio_st */
            	5159, 0,
            0, 112, 7, /* 5159: struct.bio_st */
            	5176, 0,
            	5181, 8,
            	178, 16,
            	273, 48,
            	...
            	5154, 64,
            	2686, 96,
            1, 8, 1, /* 5176: pointer.struct.bio_method_st */
            	5112, 0,
            8884097, 8, 0, /* 5181: pointer.func */
            0, 1200, 10, /* 5184: struct.ssl3_state_st */
            	5207, 240,
            	5207, 264,
            	5212, 288,
            	5212, 344,
            	...
            	273, 512,
            	5231, 528,
            0, 24, 1, /* 5207: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5212: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5221: pointer.struct.bio_st */
            	5159, 0,
            1, 8, 1, /* 5226: pointer.pointer.struct.env_md_ctx_st */
            	5013, 0,
            0, 528, 8, /* 5231: struct.unknown */
            	4829, 408,
            	2640, 416,
            	4824, 424,
            	5250, 464,
            	...
            	4774, 496,
            	5274, 512,
            1, 8, 1, /* 5250: pointer.struct.stack_st_X509_NAME */
            	5255, 0,
            0, 32, 2, /* 5255: struct.stack_st_fake_X509_NAME */
            	5262, 8,
            	86, 24,
            8884099, 8, 2, /* 5262: pointer_to_array_of_pointers_to_stack */
            	5269, 0,
            	83, 20,
            0, 8, 1, /* 5269: pointer.X509_NAME */
            	5107, 0,
            1, 8, 1, /* 5274: pointer.struct.ssl_comp_st */
            	4881, 0,
            1, 8, 1, /* 5279: pointer.struct.ssl3_enc_method */
            	5284, 0,
            0, 112, 11, /* 5284: struct.ssl3_enc_method */
            	5309, 0,
            	5312, 8,
            	5315, 16,
            	5098, 24,
            ...
            8884097, 8, 0, /* 5333: pointer.func */
            0, 888, 7, /* 5336: struct.dtls1_state_st */
            	5047, 576,
            	5047, 592,
            	5039, 608,
            	5039, 616,
            	...
            	5353, 648,
            	5353, 736,
            0, 88, 1, /* 5353: struct.hm_header_st */
            	4997, 48,
            0, 736, 50, /* 5358: struct.ssl_ctx_st */
            	5461, 0,
            	4839, 8,
            	4839, 16,
            	5552, 24,
            	...
            	273, 720,
            	5720, 728,
            1, 8, 1, /* 5461: pointer.struct.ssl_method_st */
            	5466, 0,
            0, 232, 28, /* 5466: struct.ssl_method_st */
            	5315, 8,
            	2755, 16,
            	2755, 24,
            	5315, 32,
            ...
            8884097, 8, 0, /* 5540: pointer.func */
            8884097, 8, 0, /* 5543: pointer.func */
            8884097, 8, 0, /* 5546: pointer.func */
            8884097, 8, 0, /* 5549: pointer.func */
            ...
            1, 8, 1, /* 5707: pointer.struct.ssl3_buf_freelist_st */
            	5712, 0,
            0, 24, 1, /* 5712: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5717: pointer.func */
            1, 8, 1, /* 5720: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5725, 0,
            0, 32, 2, /* 5725: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5732, 8,
            	86, 24,
            8884099, 8, 2, /* 5732: pointer_to_array_of_pointers_to_stack */
            	5739, 0,
            	83, 20,
            0, 8, 1, /* 5739: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            1, 8, 1, /* 5744: pointer.struct.ssl2_state_st */
            	5749, 0,
            0, 344, 9, /* 5749: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            ...
            0, 808, 51, /* 5770: struct.ssl_st */
            	...
            	5896, 656,
            	242, 680,
            1, 8, 1, /* 5875: pointer.struct.ssl3_state_st */
            	5184, 0,
            1, 8, 1, /* 5880: pointer.struct.dtls1_state_st */
            	5336, 0,
            1, 8, 1, /* 5885: pointer.struct.ssl_ctx_st */
            	5358, 0,
            8884097, 8, 0, /* 5890: pointer.func */
            8884097, 8, 0, /* 5893: pointer.func */
            1, 8, 1, /* 5896: pointer.struct.srtp_protection_profile_st */
            	0, 0,
            0, 1, 0, /* 5901: char */
            1, 8, 1, /* 5904: pointer.struct.ssl_st */
            	5770, 0,
        },
        .arg_entity_index = { 5904, 5101, },
        .ret_entity_index = -1,
    };
