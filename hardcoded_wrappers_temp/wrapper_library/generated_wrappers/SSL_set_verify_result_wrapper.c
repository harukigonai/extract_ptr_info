...
void bb_SSL_set_verify_result(SSL * arg_a,long arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5088: pointer.struct.ssl3_enc_method */
            	5093, 0,
            0, 112, 11, /* 5093: struct.ssl3_enc_method */
            	5118, 0,
            	5121, 8,
            	5124, 16,
            	5079, 24,
            ...
            64097, 8, 0, /* 5133: pointer.func */
            0, 80, 9, /* 5136: struct.bio_method_st */
            	5, 8,
            	5157, 16,
            	5160, 24,
            	5163, 32,
            ...
            64097, 8, 0, /* 5172: pointer.func */
            1, 8, 1, /* 5175: pointer.struct.bio_st */
            	5180, 0,
            0, 112, 7, /* 5180: struct.bio_st */
            	5197, 0,
            	4089, 8,
            	99, 16,
            	273, 48,
            	...
            	5175, 64,
            	2706, 96,
            1, 8, 1, /* 5197: pointer.struct.bio_method_st */
            	5136, 0,
            1, 8, 1, /* 5202: pointer.struct.dtls1_state_st */
            	5207, 0,
            0, 888, 7, /* 5207: struct.dtls1_state_st */
            	5224, 576,
            	5224, 592,
            	5068, 608,
            	5068, 616,
            	...
            	5229, 648,
            	5229, 736,
            0, 16, 1, /* 5224: struct.record_pqueue_st */
            	5068, 8,
            0, 88, 1, /* 5229: struct.hm_header_st */
            	5026, 48,
            0, 344, 9, /* 5234: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            ...
            64097, 8, 0, /* 5261: pointer.func */
            1, 8, 1, /* 5264: pointer.struct.ssl_st */
            	5269, 0,
            0, 808, 51, /* 5269: struct.ssl_st */
            	5374, 8,
            	5471, 16,
            	5471, 24,
            	5471, 32,
            	...
            	5901, 656,
            	242, 680,
            1, 8, 1, /* 5374: pointer.struct.ssl_method_st */
            	5379, 0,
            0, 232, 28, /* 5379: struct.ssl_method_st */
            	5124, 8,
            	5438, 16,
            	5438, 24,
            	5124, 32,
            ...
            64097, 8, 0, /* 5468: pointer.func */
            1, 8, 1, /* 5471: pointer.struct.bio_st */
            	5180, 0,
            1, 8, 1, /* 5476: pointer.struct.ssl2_state_st */
            	5234, 0,
            1, 8, 1, /* 5481: pointer.struct.ssl3_state_st */
            	5486, 0,
            0, 1200, 10, /* 5486: struct.ssl3_state_st */
            	5509, 240,
            	5509, 264,
            	5514, 288,
            	5514, 344,
            	...
            	273, 512,
            	5528, 528,
            0, 24, 1, /* 5509: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5514: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5523: pointer.pointer.struct.env_md_ctx_st */
            	5042, 0,
            0, 528, 8, /* 5528: struct.unknown */
            	4915, 408,
            	4866, 416,
            	4871, 424,
            	5547, 464,
            	...
            	4819, 496,
            	5614, 512,
            1, 8, 1, /* 5547: pointer.struct.stack_st_X509_NAME */
            	5552, 0,
            0, 32, 2, /* 5552: struct.stack_st_fake_X509_NAME */
            	5559, 8,
            	86, 24,
            64099, 8, 2, /* 5559: pointer_to_array_of_pointers_to_stack */
            	5566, 0,
            	83, 20,
            0, 8, 1, /* 5566: pointer.X509_NAME */
            	5571, 0,
            0, 0, 1, /* 5571: X509_NAME */
            	5576, 0,
            0, 40, 3, /* 5576: struct.X509_name_st */
            	5585, 0,
            	5609, 16,
            	78, 24,
            1, 8, 1, /* 5585: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5590, 0,
            0, 32, 2, /* 5590: struct.stack_st_fake_X509_NAME_ENTRY */
            	5597, 8,
            	86, 24,
            64099, 8, 2, /* 5597: pointer_to_array_of_pointers_to_stack */
            	5604, 0,
            	83, 20,
            0, 8, 1, /* 5604: pointer.X509_NAME_ENTRY */
            	128, 0,
            1, 8, 1, /* 5609: pointer.struct.buf_mem_st */
            	5021, 0,
            1, 8, 1, /* 5614: pointer.struct.ssl_comp_st */
            	4082, 0,
