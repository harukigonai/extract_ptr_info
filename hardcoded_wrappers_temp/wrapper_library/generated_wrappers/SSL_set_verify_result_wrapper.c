...
void bb_SSL_set_verify_result(SSL * arg_a,long arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5024: pointer.struct.ssl3_enc_method */
            	5029, 0,
            0, 112, 11, /* 5029: struct.ssl3_enc_method */
            	5054, 0,
            	5057, 8,
            	5060, 16,
            	5015, 24,
            ...
            0, 0, 1, /* 5072: X509_NAME */
            	4446, 0,
            0, 1200, 10, /* 5077: struct.ssl3_state_st */
            	5100, 240,
            	5100, 264,
            	5105, 288,
            	5105, 344,
            	...
            	273, 512,
            	5119, 528,
            0, 24, 1, /* 5100: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5105: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5114: pointer.pointer.struct.env_md_ctx_st */
            	4970, 0,
            0, 528, 8, /* 5119: struct.unknown */
            	4848, 408,
            	4802, 416,
            	4807, 424,
            	5138, 464,
            	...
            	4760, 496,
            	5162, 512,
            1, 8, 1, /* 5138: pointer.struct.stack_st_X509_NAME */
            	5143, 0,
            0, 32, 2, /* 5143: struct.stack_st_fake_X509_NAME */
            	5150, 8,
            	86, 24,
            8884099, 8, 2, /* 5150: pointer_to_array_of_pointers_to_stack */
            	5157, 0,
            	83, 20,
            0, 8, 1, /* 5157: pointer.X509_NAME */
            	5072, 0,
            1, 8, 1, /* 5162: pointer.struct.ssl_comp_st */
            	3960, 0,
            8884097, 8, 0, /* 5167: pointer.func */
            8884097, 8, 0, /* 5170: pointer.func */
            8884097, 8, 0, /* 5173: pointer.func */
            1, 8, 1, /* 5176: pointer.struct.ssl_st */
            	5181, 0,
            0, 808, 51, /* 5181: struct.ssl_st */
            	5286, 8,
            	4317, 16,
            	4317, 24,
            	4317, 32,
            	...
            	5724, 656,
            	242, 680,
            1, 8, 1, /* 5286: pointer.struct.ssl_method_st */
            	5291, 0,
            0, 232, 28, /* 5291: struct.ssl_method_st */
            	5060, 8,
            	5350, 16,
            	5350, 24,
            	5060, 32,
            ...
            1, 8, 1, /* 5383: pointer.struct.ssl2_state_st */
            	5388, 0,
            0, 344, 9, /* 5388: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5409: pointer.struct.ssl3_state_st */
            	5077, 0,
