...
void bb_SSL_set_verify_result(SSL * arg_a,long arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 4837: pointer.struct.ssl3_enc_method */
            	4842, 0,
            0, 112, 11, /* 4842: struct.ssl3_enc_method */
            	4867, 0,
            	4870, 8,
            	4873, 16,
            	4828, 24,
            ...
            0, 80, 9, /* 4885: struct.bio_method_st */
            	5, 8,
            	4906, 16,
            	4909, 24,
            	4912, 32,
            ...
            1, 8, 1, /* 4924: pointer.struct.bio_st */
            	4929, 0,
            0, 112, 7, /* 4929: struct.bio_st */
            	4946, 0,
            	4951, 8,
            	178, 16,
            	273, 48,
            	...
            	4924, 64,
            	2676, 96,
            1, 8, 1, /* 4946: pointer.struct.bio_method_st */
            	4885, 0,
            8884097, 8, 0, /* 4951: pointer.func */
            0, 1200, 10, /* 4954: struct.ssl3_state_st */
            	4977, 240,
            	4977, 264,
            	4982, 288,
            	4982, 344,
            	...
            	273, 512,
            	5001, 528,
            0, 24, 1, /* 4977: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 4982: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 4991: pointer.struct.bio_st */
            	4929, 0,
            1, 8, 1, /* 4996: pointer.pointer.struct.env_md_ctx_st */
            	4786, 0,
            0, 528, 8, /* 5001: struct.unknown */
            	4556, 408,
            	2630, 416,
            	4551, 424,
            	5020, 464,
            	...
            	4501, 496,
            	5049, 512,
            1, 8, 1, /* 5020: pointer.struct.stack_st_X509_NAME */
            	5025, 0,
            0, 32, 2, /* 5025: struct.stack_st_fake_X509_NAME */
            	5032, 8,
            	86, 24,
            8884099, 8, 2, /* 5032: pointer_to_array_of_pointers_to_stack */
            	5039, 0,
            	83, 20,
            0, 8, 1, /* 5039: pointer.X509_NAME */
            	5044, 0,
            0, 0, 1, /* 5044: X509_NAME */
            	4608, 0,
            1, 8, 1, /* 5049: pointer.struct.ssl_comp_st */
            	4685, 0,
            8884097, 8, 0, /* 5054: pointer.func */
            8884097, 8, 0, /* 5057: pointer.func */
            8884097, 8, 0, /* 5060: pointer.func */
            8884097, 8, 0, /* 5063: pointer.func */
            0, 888, 7, /* 5066: struct.dtls1_state_st */
            	4815, 576,
            	4815, 592,
            	4820, 608,
            	4820, 616,
            	...
            	5083, 648,
            	5083, 736,
            0, 88, 1, /* 5083: struct.hm_header_st */
            	4725, 48,
            0, 736, 50, /* 5088: struct.ssl_ctx_st */
            	5191, 0,
            	4566, 8,
            	4566, 16,
            	5282, 24,
            	...
            	273, 720,
            	5448, 728,
            1, 8, 1, /* 5191: pointer.struct.ssl_method_st */
            	5196, 0,
            0, 232, 28, /* 5196: struct.ssl_method_st */
            	4873, 8,
            	2742, 16,
            	2742, 24,
            	4873, 32,
            ...
            1, 8, 1, /* 5282: pointer.struct.x509_store_st */
            	5287, 0,
            0, 144, 15, /* 5287: struct.x509_store_st */
            	5320, 8,
            	5344, 16,
            	5368, 24,
            	434, 32,
            	...
            	434, 112,
            	2676, 120,
            1, 8, 1, /* 5320: pointer.struct.stack_st_X509_OBJECT */
            	5325, 0,
            0, 32, 2, /* 5325: struct.stack_st_fake_X509_OBJECT */
            	5332, 8,
            	86, 24,
            8884099, 8, 2, /* 5332: pointer_to_array_of_pointers_to_stack */
            	5339, 0,
            	83, 20,
            0, 8, 1, /* 5339: pointer.X509_OBJECT */
            	610, 0,
            ...
            0, 8, 1, /* 5363: pointer.X509_LOOKUP */
            	485, 0,
            1, 8, 1, /* 5368: pointer.struct.X509_VERIFY_PARAM_st */
            	5373, 0,
            0, 56, 2, /* 5373: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	4453, 48,
            ...
            1, 8, 1, /* 5392: pointer.struct.cert_st */
            	5397, 0,
            0, 296, 7, /* 5397: struct.cert_st */
            	3675, 0,
            	4546, 48,
            	5414, 56,
            	2630, 64,
            ...
            8884097, 8, 0, /* 5432: pointer.func */
            1, 8, 1, /* 5435: pointer.struct.ssl3_buf_freelist_st */
            	5440, 0,
            0, 24, 1, /* 5440: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5445: pointer.func */
            1, 8, 1, /* 5448: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5453, 0,
            0, 32, 2, /* 5453: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5460, 8,
            	86, 24,
            8884099, 8, 2, /* 5460: pointer_to_array_of_pointers_to_stack */
            	5467, 0,
            	83, 20,
            0, 8, 1, /* 5467: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            1, 8, 1, /* 5472: pointer.struct.ssl2_state_st */
            	5477, 0,
            0, 344, 9, /* 5477: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            ...
            0, 808, 51, /* 5498: struct.ssl_st */
            	...
            	5627, 656,
            	242, 680,
            1, 8, 1, /* 5603: pointer.struct.ssl3_state_st */
            	4954, 0,
            1, 8, 1, /* 5608: pointer.struct.dtls1_state_st */
            	5066, 0,
            1, 8, 1, /* 5613: pointer.struct.ssl_ctx_st */
            	5088, 0,
            8884097, 8, 0, /* 5618: pointer.func */
            8884097, 8, 0, /* 5621: pointer.func */
            8884097, 8, 0, /* 5624: pointer.func */
            1, 8, 1, /* 5627: pointer.struct.srtp_protection_profile_st */
            	0, 0,
            0, 1, 0, /* 5632: char */
            1, 8, 1, /* 5635: pointer.struct.ssl_st */
            	5498, 0,
        },
        .arg_entity_index = { 5635, 4831, },
        .ret_entity_index = -1,
    };
