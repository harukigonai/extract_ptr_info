...
void bb_SSL_set_verify_result(SSL * arg_a,long arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 1, 0, /* 7320: char */
            0, 8, 0, /* 7323: long int */
            1, 8, 1, /* 7326: pointer.struct.ssl3_state_st */
            	7160, 0,
            0, 808, 51, /* 7331: struct.ssl_st */
            	4621, 8,
            	7197, 16,
            	7197, 24,
            	7197, 32,
            	...
            	6793, 656,
            	6727, 680,
            1, 8, 1, /* 7436: pointer.struct.ssl2_state_st */
            	7441, 0,
            0, 344, 9, /* 7441: struct.ssl2_state_st */
            	99, 24,
            	117, 56,
            	117, 64,
            	117, 72,
            	...
            	117, 128,
            	117, 136,
            1, 8, 1, /* 7462: pointer.struct.dtls1_state_st */
            	7467, 0,
            0, 888, 7, /* 7467: struct.dtls1_state_st */
            	6894, 576,
            	6894, 592,
            	6899, 608,
            	6899, 616,
            	...
            	7484, 648,
            	7484, 736,
            0, 88, 1, /* 7484: struct.hm_header_st */
            	7489, 48,
            0, 40, 4, /* 7489: struct.dtls1_retransmit_state */
            	7500, 0,
            	7207, 8,
            	7516, 16,
            	7528, 24,
            1, 8, 1, /* 7500: pointer.struct.evp_cipher_ctx_st */
            	7505, 0,
            0, 168, 4, /* 7505: struct.evp_cipher_ctx_st */
            	7249, 0,
            	5726, 8,
            	15, 96,
            	15, 120,
            1, 8, 1, /* 7516: pointer.struct.comp_ctx_st */
            	7521, 0,
            0, 56, 2, /* 7521: struct.comp_ctx_st */
            	7295, 0,
            	4907, 40,
            1, 8, 1, /* 7528: pointer.struct.ssl_session_st */
            	4934, 0,
            8884097, 8, 0, /* 7533: pointer.func */
            8884097, 8, 0, /* 7536: pointer.func */
            8884097, 8, 0, /* 7539: pointer.func */
            1, 8, 1, /* 7542: pointer.struct.ssl_st */
            	7331, 0,
        },
        .arg_entity_index = { 7542, 7323, },
        .ret_entity_index = -1,
    };
