    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6941: pointer.struct.bio_st */
            	6916, 0,
            1, 8, 1, /* 6946: pointer.struct.ssl_st */
            	6951, 0,
            ...
            0, 80, 8, /* 7117: struct.evp_pkey_ctx_st */
            	...
            	6860, 56,
            	7186, 64,
            1, 8, 1, /* 7136: pointer.struct.evp_pkey_method_st */
            	6694, 0,
            1, 8, 1, /* 7141: pointer.struct.evp_pkey_st */
            	7146, 0,
            0, 56, 4, /* 7146: struct.evp_pkey_st */
            	7157, 16,
            	6632, 24,
            	6645, 32,
            	7162, 48,
            1, 8, 1, /* 7157: pointer.struct.evp_pkey_asn1_method_st */
            	823, 0,
            1, 8, 1, /* 7162: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7167, 0,
            0, 32, 2, /* 7167: struct.stack_st_fake_X509_ATTRIBUTE */
            	7174, 8,
            	125, 24,
            8884099, 8, 2, /* 7174: pointer_to_array_of_pointers_to_stack */
            	7181, 0,
            	122, 20,
            0, 8, 1, /* 7181: pointer.X509_ATTRIBUTE */
            	2240, 0,
            1, 8, 1, /* 7186: pointer.int */
            	122, 0,
            0, 528, 8, /* 7191: struct.unknown */
            	6018, 408,
            	7210, 416,
            	5780, 424,
            	6079, 464,
            	...
            	6037, 496,
            	7215, 512,
            1, 8, 1, /* 7210: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 7215: pointer.struct.ssl_comp_st */
            	7220, 0,
            0, 24, 2, /* 7220: struct.ssl_comp_st */
            	102, 8,
            	7227, 16,
            1, 8, 1, /* 7227: pointer.struct.comp_method_st */
            	7232, 0,
            0, 64, 7, /* 7232: struct.comp_method_st */
            	102, 8,
            	7249, 16,
            	7252, 24,
            	6642, 32,
            ...
            1, 8, 1, /* 7255: pointer.struct.dtls1_state_st */
            	7260, 0,
            0, 888, 7, /* 7260: struct.dtls1_state_st */
            	7277, 576,
            	7277, 592,
            	7282, 608,
            	7282, 616,
            	...
            	7309, 648,
            	7309, 736,
            0, 16, 1, /* 7277: struct.record_pqueue_st */
            	7282, 8,
            1, 8, 1, /* 7282: pointer.struct._pqueue */
            	7287, 0,
            0, 16, 1, /* 7287: struct._pqueue */
            	7292, 0,
            1, 8, 1, /* 7292: pointer.struct._pitem */
            	7297, 0,
            0, 24, 2, /* 7297: struct._pitem */
            	5, 8,
            	7304, 16,
            1, 8, 1, /* 7304: pointer.struct._pitem */
            	7297, 0,
            0, 88, 1, /* 7309: struct.hm_header_st */
            	7314, 48,
            0, 40, 4, /* 7314: struct.dtls1_retransmit_state */
            	6863, 0,
            	7094, 8,
            	7325, 16,
            	7337, 24,
        ...
        .arg_entity_index = { 6946, },
        .ret_entity_index = 102,
    };
