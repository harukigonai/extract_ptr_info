...
int bb_X509_verify_cert(X509_STORE_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 961: pointer.struct.x509_store_ctx_st */
            	966, 0,
            0, 248, 25, /* 966: struct.x509_store_ctx_st */
            	1019, 0,
            	953, 16,
            	418, 24,
            	408, 32,
            	...
            	961, 224,
            	666, 232,
            1, 8, 1, /* 1019: pointer.struct.x509_store_st */
            	1024, 0,
            0, 144, 15, /* 1024: struct.x509_store_st */
            	1057, 8,
            	1067, 16,
            	1077, 24,
            	1089, 32,
            	...
            	1089, 112,
            	666, 120,
            1, 8, 1, /* 1057: pointer.struct.stack_st_X509_OBJECT */
            	1062, 0,
            0, 32, 1, /* 1062: struct.stack_st_X509_OBJECT */
            	33, 0,
            1, 8, 1, /* 1067: pointer.struct.stack_st_X509_LOOKUP */
            	1072, 0,
            0, 32, 1, /* 1072: struct.stack_st_X509_LOOKUP */
            	33, 0,
            1, 8, 1, /* 1077: pointer.struct.X509_VERIFY_PARAM_st */
            	1082, 0,
        ...
        .arg_entity_index = { 961, },
        .ret_entity_index = 1116,
    };
