...
int bb_X509_verify_cert(X509_STORE_CTX * arg_a) 
{
    ...
    em[5599] = 1; em[5600] = 8; em[5601] = 1; /* 5599: pointer.struct.stack_st_GENERAL_NAMES */
    	em[5602] = 5604; em[5603] = 0; 
    em[5604] = 0; em[5605] = 32; em[5606] = 2; /* 5604: struct.stack_st_fake_GENERAL_NAMES */
    	em[5607] = 5611; em[5608] = 8; 
    	em[5609] = 365; em[5610] = 24; 
    em[5611] = 8884099; em[5612] = 8; em[5613] = 2; /* 5611: pointer_to_array_of_pointers_to_stack */
    	em[5614] = 5618; em[5615] = 0; 
    	em[5616] = 362; em[5617] = 20; 
    em[5618] = 0; em[5619] = 8; em[5620] = 1; /* 5618: pointer.GENERAL_NAMES */
    	em[5621] = 980; em[5622] = 0; 
    em[5623] = 0; em[5624] = 1; em[5625] = 0; /* 5623: char */
