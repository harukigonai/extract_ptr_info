...
EVP_PKEY * bb_X509_get_pubkey(X509 * arg_a) 
{
    ...
    em[3543] = 1; em[3544] = 8; em[3545] = 1; /* 3543: pointer.struct.X509_algor_st */
    	em[3546] = 1850; em[3547] = 0; 
    em[3548] = 1; em[3549] = 8; em[3550] = 1; /* 3548: pointer.struct.asn1_string_st */
    	em[3551] = 2088; em[3552] = 0; 
    em[3553] = 0; em[3554] = 104; em[3555] = 11; /* 3553: struct.x509_cinf_st */
    	em[3556] = 3548; em[3557] = 0; 
    	em[3558] = 3548; em[3559] = 8; 
    	em[3560] = 3543; em[3561] = 16; 
    	em[3562] = 3383; em[3563] = 24; 
    	em[3564] = 3363; em[3565] = 32; 
    	em[3566] = 3383; em[3567] = 40; 
    	em[3568] = 3509; em[3569] = 48; 
    	em[3570] = 3308; em[3571] = 56; 
    	em[3572] = 3308; em[3573] = 64; 
    	em[3574] = 3339; em[3575] = 72; 
    	em[3576] = 3578; em[3577] = 80; 
    em[3578] = 0; em[3579] = 24; em[3580] = 1; /* 3578: struct.ASN1_ENCODING_st */
    	em[3581] = 69; em[3582] = 0; 
    em[3583] = 1; em[3584] = 8; em[3585] = 1; /* 3583: pointer.struct.AUTHORITY_KEYID_st */
    	em[3586] = 3588; em[3587] = 0; 
    em[3588] = 0; em[3589] = 24; em[3590] = 3; /* 3588: struct.AUTHORITY_KEYID_st */
    	em[3591] = 3597; em[3592] = 0; 
    	em[3593] = 3274; em[3594] = 8; 
    	em[3595] = 3240; em[3596] = 16; 
    em[3597] = 1; em[3598] = 8; em[3599] = 1; /* 3597: pointer.struct.asn1_string_st */
    	em[3600] = 3245; em[3601] = 0; 
    em[3602] = 1; em[3603] = 8; em[3604] = 1; /* 3602: pointer.struct.x509_cinf_st */
    	em[3605] = 3553; em[3606] = 0; 
    ...
    args_addr->ret_entity_index = 1840;
