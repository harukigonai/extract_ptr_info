    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 24, 1, /* 80: struct.ASN1_ENCODING_st */
            	26, 0,
            1, 8, 1, /* 85: pointer.struct.X509_pubkey_st */
            	90, 0,
            0, 24, 3, /* 90: struct.X509_pubkey_st */
            	99, 0,
            	65, 8,
            	126, 16,
            1, 8, 1, /* 99: pointer.struct.X509_algor_st */
            	104, 0,
            0, 16, 2, /* 104: struct.X509_algor_st */
            	12, 0,
            	111, 8,
            1, 8, 1, /* 111: pointer.struct.asn1_type_st */
            	116, 0,
            0, 16, 1, /* 116: struct.asn1_type_st */
            	121, 8,
            0, 8, 1, /* 121: struct.fnames */
            	26, 0,
            1, 8, 1, /* 126: pointer.struct.evp_pkey_st */
            	131, 0,
            0, 56, 4, /* 131: struct.evp_pkey_st */
            	...
            	121, 32,
            	31, 48,
            1, 8, 1, /* 142: pointer.struct.evp_pkey_asn1_method_st */
            	147, 0,
            ...
            1, 8, 1, /* 240: pointer.struct.engine_st */
            	245, 0,
            0, 216, 24, /* 245: struct.engine_st */
            	...
            	240, 200,
            	240, 208,
            1, 8, 1, /* 296: pointer.struct.rsa_meth_st */
            	301, 0,
            ...
            1, 8, 1, /* 351: pointer.struct.dsa_method */
            	356, 0,
            ...
            1, 8, 1, /* 402: pointer.struct.dh_method */
            	407, 0,
            ...
            1, 8, 1, /* 438: pointer.struct.ecdh_method */
            	443, 0,
            ...
            1, 8, 1, /* 455: pointer.struct.ecdsa_method */
            	460, 0,
            ...
            1, 8, 1, /* 482: pointer.struct.rand_meth_st */
            	487, 0,
            ...
            1, 8, 1, /* 549: pointer.struct.ENGINE_CMD_DEFN_st */
            	554, 0,
            ...
            0, 16, 1, /* 561: struct.crypto_ex_data_st */
            	31, 0,
            1, 8, 1, /* 566: pointer.struct.X509_val_st */
            	571, 0,
            ...
            0, 24, 1, /* 578: struct.buf_mem_st */
            	26, 8,
            1, 8, 1, /* 583: pointer.struct.buf_mem_st */
            	578, 0,
            0, 40, 3, /* 588: struct.X509_name_st */
            	31, 0,
            	583, 16,
            	26, 24,
            1, 8, 1, /* 597: pointer.struct.X509_name_st */
            	588, 0,
            ...
            0, 0, 0, /* 692: func */
            0, 0, 0, /* 695: func */
            1, 8, 1, /* 698: pointer.struct.x509_st */
            	703, 0,
            0, 184, 12, /* 703: struct.x509_st */
            	...
            	747, 144,
            	759, 176,
            1, 8, 1, /* 730: pointer.struct.X509_POLICY_CACHE_st */
            	735, 0,
            0, 40, 2, /* 735: struct.X509_POLICY_CACHE_st */
            	742, 0,
            	31, 8,
            1, 8, 1, /* 742: pointer.struct.X509_POLICY_DATA_st */
            	3, 0,
            1, 8, 1, /* 747: pointer.struct.NAME_CONSTRAINTS_st */
            	752, 0,
            0, 16, 2, /* 752: struct.NAME_CONSTRAINTS_st */
            	31, 0,
            	31, 8,
            1, 8, 1, /* 759: pointer.struct.x509_cert_aux_st */
            	764, 0,
