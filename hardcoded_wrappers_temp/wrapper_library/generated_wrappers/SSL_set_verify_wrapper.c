...
void bb_SSL_set_verify(SSL * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6606: pointer.struct.stack_st_X509_EXTENSION */
            	6611, 0,
            0, 32, 2, /* 6611: struct.stack_st_fake_X509_EXTENSION */
            	6618, 8,
            	125, 24,
            8884099, 8, 2, /* 6618: pointer_to_array_of_pointers_to_stack */
            	6625, 0,
            	122, 20,
            0, 8, 1, /* 6625: pointer.X509_EXTENSION */
            	2624, 0,
            1, 8, 1, /* 6630: pointer.struct.dsa_st */
            	1492, 0,
            1, 8, 1, /* 6635: pointer.struct.engine_st */
            	924, 0,
            0, 24, 1, /* 6640: struct.ssl3_buffer_st */
            	13, 0,
            8884097, 8, 0, /* 6645: pointer.func */
            0, 8, 5, /* 6648: union.unknown */
            	26, 0,
            	6661, 0,
            	6630, 0,
            	6666, 0,
            	6671, 0,
            1, 8, 1, /* 6661: pointer.struct.rsa_st */
            	1290, 0,
            1, 8, 1, /* 6666: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 6671: pointer.struct.ec_key_st */
            	1733, 0,
            8884097, 8, 0, /* 6676: pointer.func */
            8884097, 8, 0, /* 6679: pointer.func */
            8884097, 8, 0, /* 6682: pointer.func */
            0, 56, 3, /* 6685: struct.ssl3_record_st */
            	13, 16,
            	13, 24,
            	13, 32,
            8884097, 8, 0, /* 6694: pointer.func */
            0, 208, 25, /* 6697: struct.evp_pkey_method_st */
            	6750, 8,
            	6694, 16,
            	6753, 24,
            	6750, 32,
            ...
            1, 8, 1, /* 6780: pointer.struct.stack_st_OCSP_RESPID */
            	6785, 0,
            0, 32, 2, /* 6785: struct.stack_st_fake_OCSP_RESPID */
            	6792, 8,
            	125, 24,
            8884099, 8, 2, /* 6792: pointer_to_array_of_pointers_to_stack */
            	6799, 0,
            	122, 20,
            0, 8, 1, /* 6799: pointer.OCSP_RESPID */
            	138, 0,
            8884097, 8, 0, /* 6804: pointer.func */
            1, 8, 1, /* 6807: pointer.struct.bio_method_st */
            	6812, 0,
            0, 80, 9, /* 6812: struct.bio_method_st */
            	102, 8,
            	6777, 16,
            	6804, 24,
            	6682, 32,
            ...
            8884097, 8, 0, /* 6842: pointer.func */
            1, 8, 1, /* 6845: pointer.struct.evp_pkey_method_st */
            	6697, 0,
            0, 112, 7, /* 6850: struct.bio_st */
            	6807, 0,
            	6867, 8,
            	26, 16,
            	5, 48,
            ...
            1, 8, 1, /* 6870: pointer.struct.bio_st */
            	6850, 0,
            1, 8, 1, /* 6875: pointer.struct.bio_st */
            	6850, 0,
            0, 344, 9, /* 6880: struct.ssl2_state_st */
            	107, 24,
            	13, 56,
            	13, 64,
            	13, 72,
            	...
            	13, 128,
            	13, 136,
            8884097, 8, 0, /* 6901: pointer.func */
            0, 168, 4, /* 6904: struct.evp_cipher_ctx_st */
            	6915, 0,
            	5663, 8,
            	5, 96,
            	5, 120,
            1, 8, 1, /* 6915: pointer.struct.evp_cipher_st */
            	6920, 0,
            0, 88, 7, /* 6920: struct.evp_cipher_st */
            	6937, 24,
            	6940, 32,
            	6901, 40,
            	6943, 56,
            	...
            	6946, 72,
            	5, 80,
            8884097, 8, 0, /* 6937: pointer.func */
            8884097, 8, 0, /* 6940: pointer.func */
            8884097, 8, 0, /* 6943: pointer.func */
            8884097, 8, 0, /* 6946: pointer.func */
            0, 808, 51, /* 6949: struct.ssl_st */
            	5008, 8,
            	6875, 16,
            	6875, 24,
            	6875, 32,
            	...
            	7354, 656,
            	6564, 680,
            1, 8, 1, /* 7054: pointer.struct.ssl2_state_st */
            	6880, 0,
            1, 8, 1, /* 7059: pointer.struct.ssl3_state_st */
            	7064, 0,
            0, 1200, 10, /* 7064: struct.ssl3_state_st */
            	6640, 240,
            	6640, 264,
            	6685, 288,
            	6685, 344,
            	...
            	5, 512,
            	7184, 528,
            1, 8, 1, /* 7087: pointer.pointer.struct.env_md_ctx_st */
            	7092, 0,
            1, 8, 1, /* 7092: pointer.struct.env_md_ctx_st */
            	7097, 0,
            0, 48, 5, /* 7097: struct.env_md_ctx_st */
            	6037, 0,
            	5663, 8,
            	5, 24,
            	7110, 32,
            	6064, 40,
            1, 8, 1, /* 7110: pointer.struct.evp_pkey_ctx_st */
            	7115, 0,
            0, 80, 8, /* 7115: struct.evp_pkey_ctx_st */
            	6845, 0,
            	6635, 8,
            	7134, 16,
            	7134, 24,
            	...
            	6842, 56,
            	7179, 64,
            1, 8, 1, /* 7134: pointer.struct.evp_pkey_st */
            	7139, 0,
            0, 56, 4, /* 7139: struct.evp_pkey_st */
            	7150, 16,
            	6635, 24,
            	6648, 32,
            	7155, 48,
            1, 8, 1, /* 7150: pointer.struct.evp_pkey_asn1_method_st */
            	823, 0,
            1, 8, 1, /* 7155: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7160, 0,
            0, 32, 2, /* 7160: struct.stack_st_fake_X509_ATTRIBUTE */
            	7167, 8,
            	125, 24,
            8884099, 8, 2, /* 7167: pointer_to_array_of_pointers_to_stack */
            	7174, 0,
            	122, 20,
            0, 8, 1, /* 7174: pointer.X509_ATTRIBUTE */
            	2240, 0,
            1, 8, 1, /* 7179: pointer.int */
            	122, 0,
            0, 528, 8, /* 7184: struct.unknown */
            	6018, 408,
            	7203, 416,
            	5780, 424,
            	6079, 464,
            ...
            1, 8, 1, /* 7203: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 7208: pointer.struct.ssl_comp_st */
            	7213, 0,
            0, 24, 2, /* 7213: struct.ssl_comp_st */
            	102, 8,
            	7220, 16,
            1, 8, 1, /* 7220: pointer.struct.comp_method_st */
            	7225, 0,
            0, 64, 7, /* 7225: struct.comp_method_st */
            	102, 8,
            	7242, 16,
            	7245, 24,
            	6645, 32,
            ...
            1, 8, 1, /* 7248: pointer.struct.dtls1_state_st */
            	7253, 0,
            0, 888, 7, /* 7253: struct.dtls1_state_st */
            	7270, 576,
            	7270, 592,
            	7275, 608,
            	7275, 616,
            	...
            	7302, 648,
            	7302, 736,
            0, 16, 1, /* 7270: struct.record_pqueue_st */
            	7275, 8,
            1, 8, 1, /* 7275: pointer.struct._pqueue */
            	7280, 0,
            0, 16, 1, /* 7280: struct._pqueue */
            	7285, 0,
            1, 8, 1, /* 7285: pointer.struct._pitem */
            	7290, 0,
            0, 24, 2, /* 7290: struct._pitem */
            	5, 8,
            	7297, 16,
            1, 8, 1, /* 7297: pointer.struct._pitem */
            	7290, 0,
            0, 88, 1, /* 7302: struct.hm_header_st */
            	7307, 48,
            0, 40, 4, /* 7307: struct.dtls1_retransmit_state */
            	7318, 0,
            	7092, 8,
            	7323, 16,
            	7335, 24,
            1, 8, 1, /* 7318: pointer.struct.evp_cipher_ctx_st */
            	6904, 0,
            1, 8, 1, /* 7323: pointer.struct.comp_ctx_st */
            	7328, 0,
            0, 56, 2, /* 7328: struct.comp_ctx_st */
            	7220, 0,
            	4883, 40,
            1, 8, 1, /* 7335: pointer.struct.ssl_session_st */
            	5213, 0,
            8884097, 8, 0, /* 7340: pointer.func */
            1, 8, 1, /* 7343: pointer.struct.tls_session_ticket_ext_st */
            	0, 0,
            8884097, 8, 0, /* 7348: pointer.func */
            8884097, 8, 0, /* 7351: pointer.func */
            1, 8, 1, /* 7354: pointer.struct.srtp_protection_profile_st */
            	4445, 0,
            0, 1, 0, /* 7359: char */
            1, 8, 1, /* 7362: pointer.struct.ssl_st */
            	6949, 0,
        },
        .arg_entity_index = { 7362, 122, 6603, },
        .ret_entity_index = -1,
    };
