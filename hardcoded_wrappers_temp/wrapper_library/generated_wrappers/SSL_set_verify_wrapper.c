...
void bb_SSL_set_verify(SSL * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            4097, 8, 0, /* 1881: pointer.func */
            1, 8, 1, /* 1884: pointer.struct.bio_method_st */
            	1765, 0,
            4097, 8, 0, /* 1889: pointer.func */
            1, 8, 1, /* 1892: pointer.struct.ssl_st */
            	1897, 0,
            0, 808, 51, /* 1897: struct.ssl_st */
            	2002, 8,
            	2095, 16,
            	2095, 24,
            	2095, 32,
            	...
            	1801, 656,
            	1362, 680,
            1, 8, 1, /* 2002: pointer.struct.ssl_method_st */
            	2007, 0,
            0, 232, 28, /* 2007: struct.ssl_method_st */
            	1863, 8,
            	2066, 16,
            	2066, 24,
            	1863, 32,
            ...
            4097, 8, 0, /* 2072: pointer.func */
            4097, 8, 0, /* 2075: pointer.func */
            4097, 8, 0, /* 2078: pointer.func */
            4097, 8, 0, /* 2081: pointer.func */
            1, 8, 1, /* 2084: pointer.struct.ssl3_enc_method */
            	1835, 0,
            4097, 8, 0, /* 2089: pointer.func */
            4097, 8, 0, /* 2092: pointer.func */
            1, 8, 1, /* 2095: pointer.struct.bio_st */
            	2100, 0,
            0, 112, 7, /* 2100: struct.bio_st */
            	1884, 0,
            	2117, 8,
            	154, 16,
            	154, 48,
            	...
            	2095, 64,
            	180, 96,
            4097, 8, 0, /* 2117: pointer.func */
            1, 8, 1, /* 2120: pointer.struct.ssl2_state_st */
            	2125, 0,
            0, 344, 9, /* 2125: struct.ssl2_state_st */
            	154, 24,
            	154, 56,
            	154, 64,
            	154, 72,
            	...
            	154, 128,
            	154, 136,
            1, 8, 1, /* 2146: pointer.struct.ssl3_state_st */
            	2151, 0,
            0, 1200, 10, /* 2151: struct.ssl3_state_st */
            	2174, 240,
            	2174, 264,
            	2179, 288,
            	2179, 344,
            	...
            	8, 512,
            	2193, 528,
            0, 24, 1, /* 2174: struct.ssl3_buffer_st */
            	154, 0,
            0, 56, 3, /* 2179: struct.ssl3_record_st */
            	154, 16,
            	154, 24,
            	154, 32,
            1, 8, 1, /* 2188: pointer.pointer.struct.env_md_ctx_st */
            	1635, 0,
            0, 528, 8, /* 2193: struct.anon */
            	1755, 408,
            	1054, 416,
            	1089, 424,
            	132, 464,
            ...
            1, 8, 1, /* 2215: pointer.struct.ssl_ctx_st */
            	2220, 0,
            0, 736, 50, /* 2220: struct.ssl_ctx_st */
            	2002, 0,
            	132, 8,
            	132, 16,
            	94, 24,
        ...
        .arg_entity_index = { 1892, 1007, 171, },
        .ret_entity_index = -1,
    };
