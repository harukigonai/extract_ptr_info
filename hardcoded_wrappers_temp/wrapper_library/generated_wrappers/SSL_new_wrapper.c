...
SSL * bb_SSL_new(SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            8884097, 8, 0, /* 5321: pointer.func */
            8884097, 8, 0, /* 5324: pointer.func */
            8884097, 8, 0, /* 5327: pointer.func */
            8884097, 8, 0, /* 5330: pointer.func */
            1, 8, 1, /* 5333: pointer.struct.dtls1_state_st */
            	5338, 0,
            0, 888, 7, /* 5338: struct.dtls1_state_st */
            	5047, 576,
            	5047, 592,
            	5039, 608,
            	5039, 616,
            	...
            	5355, 648,
            	5355, 736,
            0, 88, 1, /* 5355: struct.hm_header_st */
            	4997, 48,
            0, 344, 9, /* 5360: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            0, 736, 50, /* 5381: struct.ssl_ctx_st */
            	5484, 0,
            	4839, 8,
            	4839, 16,
            	5575, 24,
            	...
            	273, 720,
            	5743, 728,
            1, 8, 1, /* 5484: pointer.struct.ssl_method_st */
            	5489, 0,
            0, 232, 28, /* 5489: struct.ssl_method_st */
            	5312, 8,
            	2755, 16,
            	2755, 24,
            	5312, 32,
            ...
            8884097, 8, 0, /* 5557: pointer.func */
            8884097, 8, 0, /* 5560: pointer.func */
            8884097, 8, 0, /* 5563: pointer.func */
            8884097, 8, 0, /* 5566: pointer.func */
            8884097, 8, 0, /* 5569: pointer.func */
            8884097, 8, 0, /* 5572: pointer.func */
            1, 8, 1, /* 5575: pointer.struct.x509_store_st */
            	5580, 0,
            0, 144, 15, /* 5580: struct.x509_store_st */
            	5613, 8,
            	5637, 16,
            	5661, 24,
            	435, 32,
            	...
            	435, 112,
            	2686, 120,
            1, 8, 1, /* 5613: pointer.struct.stack_st_X509_OBJECT */
            	5618, 0,
            0, 32, 2, /* 5618: struct.stack_st_fake_X509_OBJECT */
            	5625, 8,
            	86, 24,
            8884099, 8, 2, /* 5625: pointer_to_array_of_pointers_to_stack */
            	5632, 0,
            	83, 20,
            0, 8, 1, /* 5632: pointer.X509_OBJECT */
            	611, 0,
            1, 8, 1, /* 5637: pointer.struct.stack_st_X509_LOOKUP */
            	5642, 0,
            0, 32, 2, /* 5642: struct.stack_st_fake_X509_LOOKUP */
            	5649, 8,
            	86, 24,
            8884099, 8, 2, /* 5649: pointer_to_array_of_pointers_to_stack */
            	5656, 0,
            	83, 20,
            0, 8, 1, /* 5656: pointer.X509_LOOKUP */
            	486, 0,
            1, 8, 1, /* 5661: pointer.struct.X509_VERIFY_PARAM_st */
            	5666, 0,
            0, 56, 2, /* 5666: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	3777, 48,
            8884097, 8, 0, /* 5673: pointer.func */
            8884097, 8, 0, /* 5676: pointer.func */
            8884097, 8, 0, /* 5679: pointer.func */
            8884097, 8, 0, /* 5682: pointer.func */
            1, 8, 1, /* 5685: pointer.struct.lhash_st */
            	417, 0,
            1, 8, 1, /* 5690: pointer.struct.cert_st */
            	5695, 0,
            0, 296, 7, /* 5695: struct.cert_st */
            	4755, 0,
            	4819, 48,
            	2752, 56,
            	2640, 64,
            	...
            	4824, 80,
            	5715, 88,
            8884097, 8, 0, /* 5712: pointer.func */
            8884097, 8, 0, /* 5715: pointer.func */
            8884097, 8, 0, /* 5718: pointer.func */
            8884097, 8, 0, /* 5721: pointer.func */
            8884097, 8, 0, /* 5724: pointer.func */
            8884097, 8, 0, /* 5727: pointer.func */
            1, 8, 1, /* 5730: pointer.struct.ssl3_buf_freelist_st */
            	5735, 0,
            0, 24, 1, /* 5735: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5740: pointer.func */
            1, 8, 1, /* 5743: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5748, 0,
            0, 32, 2, /* 5748: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5755, 8,
            	86, 24,
            8884099, 8, 2, /* 5755: pointer_to_array_of_pointers_to_stack */
            	5762, 0,
            	83, 20,
            0, 8, 1, /* 5762: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            1, 8, 1, /* 5767: pointer.struct.ssl2_state_st */
            	5360, 0,
            0, 808, 51, /* 5772: struct.ssl_st */
            	5484, 8,
            	5218, 16,
            	5218, 24,
            	5218, 32,
            	...
            	5893, 656,
            	242, 680,
            1, 8, 1, /* 5877: pointer.struct.ssl3_state_st */
            	5181, 0,
        ...
        .arg_entity_index = { 5882, },
        .ret_entity_index = 5901,
    };
