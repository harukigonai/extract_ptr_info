...
int bb_SSL_get_shutdown(const SSL * arg_a) 
{
    ...
    em[7513] = 1; em[7514] = 8; em[7515] = 1; /* 7513: pointer.struct.ssl_st */
    	em[7516] = 7150; em[7517] = 0; 
    em[7518] = 0; em[7519] = 1; em[7520] = 0; /* 7518: char */
    args_addr->arg_entity_index[0] = 7513;
