...
int bb_SSL_get_shutdown(const SSL * arg_a) 
{
    ...
    em[7299] = 0; em[7300] = 1; em[7301] = 0; /* 7299: char */
    em[7302] = 1; em[7303] = 8; em[7304] = 1; /* 7302: pointer.struct.ssl_st */
    	em[7305] = 7126; em[7306] = 0; 
    args_addr->arg_entity_index[0] = 7302;
