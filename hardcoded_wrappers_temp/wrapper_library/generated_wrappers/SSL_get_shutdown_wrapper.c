...
int bb_SSL_get_shutdown(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5021: pointer.struct.ssl_st */
            	5026, 0,
            0, 808, 51, /* 5026: struct.ssl_st */
            	5131, 8,
            	4317, 16,
            	4317, 24,
            	4317, 32,
            	...
            	5721, 656,
            	242, 680,
            1, 8, 1, /* 5131: pointer.struct.ssl_method_st */
            	5136, 0,
            0, 232, 28, /* 5136: struct.ssl_method_st */
            	5195, 8,
            	5198, 16,
            	5198, 24,
            	5195, 32,
            ...
            1, 8, 1, /* 5237: pointer.struct.ssl3_enc_method */
            	5242, 0,
            0, 112, 11, /* 5242: struct.ssl3_enc_method */
            	5267, 0,
            	5270, 8,
            	5195, 16,
            	5015, 24,
            ...
            1, 8, 1, /* 5285: pointer.struct.ssl2_state_st */
            	5290, 0,
            0, 344, 9, /* 5290: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5311: pointer.struct.ssl3_state_st */
            	5316, 0,
            0, 1200, 10, /* 5316: struct.ssl3_state_st */
            	5339, 240,
            	5339, 264,
            	5344, 288,
            	5344, 344,
            	...
            	273, 512,
            	5358, 528,
            0, 24, 1, /* 5339: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5344: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5353: pointer.pointer.struct.env_md_ctx_st */
            	4970, 0,
            0, 528, 8, /* 5358: struct.unknown */
            	4848, 408,
            	4802, 416,
            	4807, 424,
            	5377, 464,
            	...
            	4760, 496,
            	5406, 512,
            1, 8, 1, /* 5377: pointer.struct.stack_st_X509_NAME */
            	5382, 0,
            0, 32, 2, /* 5382: struct.stack_st_fake_X509_NAME */
            	5389, 8,
            	86, 24,
            8884099, 8, 2, /* 5389: pointer_to_array_of_pointers_to_stack */
            	5396, 0,
            	83, 20,
            0, 8, 1, /* 5396: pointer.X509_NAME */
            	5401, 0,
            0, 0, 1, /* 5401: X509_NAME */
            	4446, 0,
            1, 8, 1, /* 5406: pointer.struct.ssl_comp_st */
            	3960, 0,
