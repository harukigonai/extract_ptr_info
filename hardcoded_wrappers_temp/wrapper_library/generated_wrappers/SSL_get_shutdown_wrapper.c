...
int bb_SSL_get_shutdown(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5085: pointer.struct.ssl_st */
            	5090, 0,
            0, 808, 51, /* 5090: struct.ssl_st */
            	5195, 8,
            	5349, 16,
            	5349, 24,
            	5349, 32,
            	...
            	5898, 656,
            	242, 680,
            1, 8, 1, /* 5195: pointer.struct.ssl_method_st */
            	5200, 0,
            0, 232, 28, /* 5200: struct.ssl_method_st */
            	5259, 8,
            	5262, 16,
            	5262, 24,
            	5259, 32,
            ...
            1, 8, 1, /* 5301: pointer.struct.ssl3_enc_method */
            	5306, 0,
            0, 112, 11, /* 5306: struct.ssl3_enc_method */
            	5331, 0,
            	5334, 8,
            	5259, 16,
            	5079, 24,
            ...
            1, 8, 1, /* 5349: pointer.struct.bio_st */
            	5354, 0,
            0, 112, 7, /* 5354: struct.bio_st */
            	5371, 0,
            	4089, 8,
            	99, 16,
            	273, 48,
            	...
            	5415, 64,
            	2706, 96,
            1, 8, 1, /* 5371: pointer.struct.bio_method_st */
            	5376, 0,
            0, 80, 9, /* 5376: struct.bio_method_st */
            	5, 8,
            	5397, 16,
            	5400, 24,
            	5403, 32,
            ...
            1, 8, 1, /* 5415: pointer.struct.bio_st */
            	5354, 0,
            1, 8, 1, /* 5420: pointer.struct.ssl2_state_st */
            	5425, 0,
            0, 344, 9, /* 5425: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5446: pointer.struct.ssl3_state_st */
            	5451, 0,
            0, 1200, 10, /* 5451: struct.ssl3_state_st */
            	5474, 240,
            	5474, 264,
            	5479, 288,
            	5479, 344,
            	...
            	273, 512,
            	5493, 528,
            0, 24, 1, /* 5474: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5479: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5488: pointer.pointer.struct.env_md_ctx_st */
            	5042, 0,
            0, 528, 8, /* 5493: struct.unknown */
            	4915, 408,
            	4866, 416,
            	4871, 424,
            	5512, 464,
            	...
            	4819, 496,
            	5579, 512,
            1, 8, 1, /* 5512: pointer.struct.stack_st_X509_NAME */
            	5517, 0,
            0, 32, 2, /* 5517: struct.stack_st_fake_X509_NAME */
            	5524, 8,
            	86, 24,
            64099, 8, 2, /* 5524: pointer_to_array_of_pointers_to_stack */
            	5531, 0,
            	83, 20,
            0, 8, 1, /* 5531: pointer.X509_NAME */
            	5536, 0,
            0, 0, 1, /* 5536: X509_NAME */
            	5541, 0,
            0, 40, 3, /* 5541: struct.X509_name_st */
            	5550, 0,
            	5574, 16,
            	78, 24,
            1, 8, 1, /* 5550: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5555, 0,
            0, 32, 2, /* 5555: struct.stack_st_fake_X509_NAME_ENTRY */
            	5562, 8,
            	86, 24,
            64099, 8, 2, /* 5562: pointer_to_array_of_pointers_to_stack */
            	5569, 0,
            	83, 20,
            0, 8, 1, /* 5569: pointer.X509_NAME_ENTRY */
            	128, 0,
            1, 8, 1, /* 5574: pointer.struct.buf_mem_st */
            	5021, 0,
            1, 8, 1, /* 5579: pointer.struct.ssl_comp_st */
            	4082, 0,
            1, 8, 1, /* 5584: pointer.struct.dtls1_state_st */
            	5589, 0,
            0, 888, 7, /* 5589: struct.dtls1_state_st */
            	5606, 576,
            	5606, 592,
            	5068, 608,
            	5068, 616,
            	...
            	5611, 648,
            	5611, 736,
            0, 16, 1, /* 5606: struct.record_pqueue_st */
            	5068, 8,
            0, 88, 1, /* 5611: struct.hm_header_st */
            	5026, 48,
