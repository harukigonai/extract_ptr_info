...
int bb_SSL_get_shutdown(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 1, /* 5104: X509_NAME */
            	5055, 0,
            1, 8, 1, /* 5109: pointer.struct.ssl_st */
            	5114, 0,
            0, 808, 51, /* 5114: struct.ssl_st */
            	5219, 8,
            	5370, 16,
            	5370, 24,
            	5370, 32,
            	...
            	5898, 656,
            	242, 680,
            1, 8, 1, /* 5219: pointer.struct.ssl_method_st */
            	5224, 0,
            0, 232, 28, /* 5224: struct.ssl_method_st */
            	5283, 8,
            	2755, 16,
            	2755, 24,
            	5283, 32,
            ...
            1, 8, 1, /* 5322: pointer.struct.ssl3_enc_method */
            	5327, 0,
            0, 112, 11, /* 5327: struct.ssl3_enc_method */
            	5352, 0,
            	5355, 8,
            	5283, 16,
            	5098, 24,
            ...
            1, 8, 1, /* 5370: pointer.struct.bio_st */
            	5375, 0,
            0, 112, 7, /* 5375: struct.bio_st */
            	5392, 0,
            	5436, 8,
            	178, 16,
            	273, 48,
            	...
            	5439, 64,
            	2686, 96,
            1, 8, 1, /* 5392: pointer.struct.bio_method_st */
            	5397, 0,
            0, 80, 9, /* 5397: struct.bio_method_st */
            	5, 8,
            	5418, 16,
            	5421, 24,
            	5424, 32,
            ...
            1, 8, 1, /* 5439: pointer.struct.bio_st */
            	5375, 0,
            1, 8, 1, /* 5444: pointer.struct.ssl2_state_st */
            	5449, 0,
            0, 344, 9, /* 5449: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5470: pointer.struct.ssl3_state_st */
            	5475, 0,
            0, 1200, 10, /* 5475: struct.ssl3_state_st */
            	5498, 240,
            	5498, 264,
            	5503, 288,
            	5503, 344,
            	...
            	273, 512,
            	5517, 528,
            0, 24, 1, /* 5498: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5503: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5512: pointer.pointer.struct.env_md_ctx_st */
            	5013, 0,
            0, 528, 8, /* 5517: struct.unknown */
            	4829, 408,
            	2640, 416,
            	4824, 424,
            	5536, 464,
            	...
            	4774, 496,
            	5560, 512,
            1, 8, 1, /* 5536: pointer.struct.stack_st_X509_NAME */
            	5541, 0,
            0, 32, 2, /* 5541: struct.stack_st_fake_X509_NAME */
            	5548, 8,
            	86, 24,
            8884099, 8, 2, /* 5548: pointer_to_array_of_pointers_to_stack */
            	5555, 0,
            	83, 20,
            0, 8, 1, /* 5555: pointer.X509_NAME */
            	5104, 0,
            1, 8, 1, /* 5560: pointer.struct.ssl_comp_st */
            	4881, 0,
            1, 8, 1, /* 5565: pointer.struct.dtls1_state_st */
            	5570, 0,
            0, 888, 7, /* 5570: struct.dtls1_state_st */
            	5047, 576,
            	5047, 592,
            	5039, 608,
            	5039, 616,
            	...
            	5587, 648,
            	5587, 736,
            0, 88, 1, /* 5587: struct.hm_header_st */
            	4997, 48,
            8884097, 8, 0, /* 5592: pointer.func */
            1, 8, 1, /* 5595: pointer.struct.X509_VERIFY_PARAM_st */
            	5600, 0,
            0, 56, 2, /* 5600: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	3777, 48,
            1, 8, 1, /* 5607: pointer.struct.cert_st */
            	5612, 0,
            0, 296, 7, /* 5612: struct.cert_st */
            	4755, 0,
            	4819, 48,
            	2752, 56,
            	2640, 64,
            ...
            1, 8, 1, /* 5647: pointer.struct.ssl_ctx_st */
            	5652, 0,
            0, 736, 50, /* 5652: struct.ssl_ctx_st */
            	5219, 0,
            	4839, 8,
            	4839, 16,
            	5755, 24,
            	...
            	273, 720,
            	5868, 728,
            1, 8, 1, /* 5755: pointer.struct.x509_store_st */
            	5760, 0,
            0, 144, 15, /* 5760: struct.x509_store_st */
            	5793, 8,
            	5817, 16,
            	5595, 24,
            	435, 32,
            	...
            	435, 112,
            	2686, 120,
            1, 8, 1, /* 5793: pointer.struct.stack_st_X509_OBJECT */
            	5798, 0,
            0, 32, 2, /* 5798: struct.stack_st_fake_X509_OBJECT */
            	5805, 8,
            	86, 24,
            8884099, 8, 2, /* 5805: pointer_to_array_of_pointers_to_stack */
            	5812, 0,
            	83, 20,
            0, 8, 1, /* 5812: pointer.X509_OBJECT */
            	611, 0,
            1, 8, 1, /* 5817: pointer.struct.stack_st_X509_LOOKUP */
            	5822, 0,
            0, 32, 2, /* 5822: struct.stack_st_fake_X509_LOOKUP */
            	5829, 8,
            	86, 24,
            8884099, 8, 2, /* 5829: pointer_to_array_of_pointers_to_stack */
            	5836, 0,
            	83, 20,
            0, 8, 1, /* 5836: pointer.X509_LOOKUP */
            	486, 0,
            8884097, 8, 0, /* 5841: pointer.func */
