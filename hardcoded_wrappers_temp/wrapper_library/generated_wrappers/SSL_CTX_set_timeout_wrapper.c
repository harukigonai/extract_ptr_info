    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1860: pointer.func */
            	1865, 0,
            0, 0, 0, /* 1865: func */
            0, 56, 2, /* 1868: struct.X509_VERIFY_PARAM_st */
            	50, 0,
            	290, 48,
            1, 8, 1, /* 1875: pointer.struct.X509_VERIFY_PARAM_st */
            	1868, 0,
            0, 8, 0, /* 1880: long */
            0, 144, 15, /* 1883: struct.x509_store_st */
            	290, 8,
            	290, 16,
            	1875, 24,
            	1916, 32,
            ...
            1, 8, 1, /* 1932: pointer.func */
            	1937, 0,
            0, 0, 0, /* 1937: func */
            1, 8, 1, /* 1940: pointer.struct.x509_store_st */
            	1883, 0,
            0, 0, 0, /* 1945: func */
            ...
            1, 8, 1, /* 1962: pointer.func */
            	1967, 0,
            0, 0, 0, /* 1967: func */
            0, 736, 50, /* 1970: struct.ssl_ctx_st.922 */
            	2073, 0,
            	290, 8,
            	290, 16,
            	1940, 24,
            	...
            	50, 720,
            	290, 728,
            1, 8, 1, /* 2073: pointer.struct.ssl_method_st.924 */
            	2078, 0,
            0, 232, 28, /* 2078: struct.ssl_method_st.924 */
            	2137, 8,
            	2145, 16,
            	2145, 24,
            	2137, 32,
            ...
            0, 24, 1, /* 2361: struct.ssl3_buf_freelist_st */
            	92, 16,
            0, 24, 0, /* 2366: array[6].int */
            1, 8, 1, /* 2369: pointer.struct.ssl_ctx_st.922 */
            	1970, 0,
        ...
        .arg_entity_index = { 2369, 1880, },
        .ret_entity_index = 1880,
    };
