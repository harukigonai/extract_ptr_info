...
long bb_SSL_CTX_set_timeout(SSL_CTX * arg_a,long arg_b) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 0, /* 1071: func */
            0, 0, 0, /* 1074: func */
            0, 56, 2, /* 1077: struct.X509_VERIFY_PARAM_st */
            	37, 0,
            	254, 48,
            1, 8, 1, /* 1084: pointer.struct.X509_VERIFY_PARAM_st */
            	1077, 0,
            0, 8, 0, /* 1089: long */
            0, 144, 4, /* 1092: struct.x509_store_st */
            	254, 8,
            	254, 16,
            	1084, 24,
            	470, 120,
            1, 8, 1, /* 1103: pointer.struct.x509_store_st */
            	1092, 0,
            0, 0, 0, /* 1108: func */
            0, 8, 0, /* 1111: pointer.func */
            0, 8, 0, /* 1114: pointer.func */
            0, 0, 0, /* 1117: func */
            ...
            0, 8, 0, /* 1147: pointer.func */
            0, 8, 0, /* 1150: pointer.func */
            0, 736, 30, /* 1153: struct.ssl_ctx_st.922 */
            	1216, 0,
            	254, 8,
            	254, 16,
            	1103, 24,
            	...
            	37, 720,
            	254, 728,
            1, 8, 1, /* 1216: pointer.struct.ssl_method_st.924 */
            	1221, 0,
            0, 232, 1, /* 1221: struct.ssl_method_st.924 */
            	1226, 200,
            1, 8, 1, /* 1226: pointer.struct.ssl3_enc_method.923 */
            	1231, 0,
            0, 112, 2, /* 1231: struct.ssl3_enc_method.923 */
            	37, 64,
            	37, 80,
            1, 8, 1, /* 1238: pointer.struct.ssl_session_st */
            	1243, 0,
            0, 352, 14, /* 1243: struct.ssl_session_st */
            	37, 144,
            	37, 152,
            	1274, 168,
            	127, 176,
            	...
            	37, 320,
            	37, 344,
            1, 8, 1, /* 1274: pointer.struct.sess_cert_st */
            	1009, 0,
            1, 8, 1, /* 1279: pointer.struct.ssl3_buf_freelist_st */
            	1284, 0,
            0, 24, 1, /* 1284: struct.ssl3_buf_freelist_st */
            	63, 16,
            ...
            1, 8, 1, /* 1328: pointer.struct.ssl_ctx_st.922 */
            	1153, 0,
            0, 0, 0, /* 1333: func */
            0, 0, 0, /* 1336: func */
        ...
        .arg_entity_index = { 1328, 1089, },
        .ret_entity_index = 1089,
    };
