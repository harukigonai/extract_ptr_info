...
const SSL_CIPHER * bb_SSL_get_current_cipher(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 0, /* 1893: func */
            0, 0, 0, /* 1896: func */
            1, 8, 1, /* 1899: pointer.struct.tls_session_ticket_ext_st */
            	1904, 0,
            ...
            0, 0, 0, /* 1921: func */
            1, 8, 1, /* 1924: pointer.struct.ssl3_state_st */
            	1929, 0,
            ...
            0, 56, 3, /* 1957: struct.ssl3_record_st */
            	...
            	116, 24,
            	116, 32,
            1, 8, 1, /* 1966: pointer.struct.bio_st */
            	1971, 0,
            0, 112, 7, /* 1971: struct.bio_st */
            	...
            	1966, 64,
            	154, 96,
            1, 8, 1, /* 1988: pointer.struct.bio_method_st */
            	1993, 0,
            ...
            1, 8, 1, /* 2032: pointer.pointer.struct.env_md_ctx_st */
            	1543, 0,
            0, 0, 0, /* 2037: func */
            ...
            0, 0, 0, /* 2046: func */
            0, 8, 0, /* 2049: long */
            1, 8, 1, /* 2052: pointer.struct.iovec */
            	1020, 0,
            ...
            1, 8, 1, /* 2097: pointer.struct.ssl_ctx_st */
            	2102, 0,
            0, 736, 50, /* 2102: struct.ssl_ctx_st */
            	...
            	1540, 720,
            	94, 728,
            1, 8, 1, /* 2205: pointer.struct.ssl_method_st */
            	2210, 0,
            ...
            1, 8, 1, /* 2302: pointer.struct.ssl3_enc_method */
            	2307, 0,
            ...
            1, 8, 1, /* 2377: pointer.struct.ssl2_state_st */
            	2382, 0,
            ...
            0, 0, 0, /* 2505: func */
            0, 0, 0, /* 2508: func */
            1, 8, 1, /* 2511: pointer.struct.ssl_st */
            	2516, 0,
