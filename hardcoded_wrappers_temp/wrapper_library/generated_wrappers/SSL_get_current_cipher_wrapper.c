    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 352, 14, /* 1361: struct.ssl_session_st */
            	...
            	116, 320,
            	116, 344,
            0, 8, 1, /* 1392: pointer.struct.sess_cert_st */
            	1397, 0,
            0, 248, 6, /* 1397: struct.sess_cert_st */
            	...
            	1028, 224,
            	1063, 232,
            0, 8, 1, /* 1412: pointer.struct.ssl_cipher_st */
            	1417, 0,
            0, 88, 1, /* 1417: struct.ssl_cipher_st */
            	116, 8,
            0, 8, 1, /* 1422: pointer.struct.ssl_session_st */
            	1361, 0,
            4097, 8, 0, /* 1427: pointer.func */
            0, 56, 2, /* 1430: struct.comp_ctx_st */
            	1437, 0,
            	154, 40,
            0, 8, 1, /* 1437: pointer.struct.comp_method_st */
            	1442, 0,
            ...
            0, 40, 4, /* 1476: struct.dtls1_retransmit_state */
            	...
            	1676, 16,
            	1422, 24,
            0, 8, 1, /* 1487: pointer.struct.evp_cipher_ctx_st */
            	1492, 0,
            0, 168, 4, /* 1492: struct.evp_cipher_ctx_st */
            	...
            	1540, 96,
            	1540, 120,
            0, 8, 1, /* 1503: pointer.struct.evp_cipher_st */
            	1508, 0,
            ...
            0, 8, 1, /* 1543: pointer.struct.env_md_ctx_st */
            	1548, 0,
            0, 48, 5, /* 1548: struct.env_md_ctx_st */
            	...
            	1561, 32,
            	906, 40,
            0, 8, 1, /* 1561: pointer.struct.evp_pkey_ctx_st */
            	1566, 0,
            0, 80, 8, /* 1566: struct.evp_pkey_ctx_st */
            	...
            	436, 56,
            	976, 64,
            0, 8, 1, /* 1585: pointer.struct.evp_pkey_method_st */
            	1590, 0,
            ...
            0, 8, 1, /* 1676: pointer.struct.comp_ctx_st */
            	1430, 0,
            4097, 8, 0, /* 1681: pointer.func */
            0, 8, 1, /* 1684: pointer.struct._pitem */
            	1689, 0,
            ...
            0, 8, 1, /* 1707: pointer.struct.dtls1_state_st */
            	1712, 0,
            ...
            0, 16, 1, /* 1729: struct.record_pqueue_st */
            	1734, 8,
            0, 8, 1, /* 1734: pointer.struct._pqueue */
            	1696, 0,
            0, 0, 0, /* 1739: func */
            0, 0, 0, /* 1742: func */
            0, 8, 1, /* 1745: pointer.struct.ssl_comp_st */
            	1750, 0,
            ...
            0, 0, 0, /* 1893: func */
            0, 0, 0, /* 1896: func */
            0, 8, 1, /* 1899: pointer.struct.tls_session_ticket_ext_st */
            	1904, 0,
            0, 16, 1, /* 1904: struct.tls_session_ticket_ext_st */
            	1540, 8,
            0, 0, 0, /* 1909: func */
            4097, 8, 0, /* 1912: pointer.func */
            0, 24, 0, /* 1915: array[6].int */
            0, 2, 0, /* 1918: array[2].char */
            0, 0, 0, /* 1921: func */
            0, 8, 1, /* 1924: pointer.struct.ssl3_state_st */
            	1929, 0,
            0, 1200, 10, /* 1929: struct.ssl3_state_st */
            	1952, 240,
            	1952, 264,
            	1957, 288,
            	1957, 344,
            	...
            	1540, 512,
            	1862, 528,
            0, 24, 1, /* 1952: struct.ssl3_buffer_st */
            	116, 0,
            0, 56, 3, /* 1957: struct.ssl3_record_st */
            	116, 16,
            	116, 24,
            	116, 32,
            0, 8, 1, /* 1966: pointer.struct.bio_st */
            	1971, 0,
            0, 112, 7, /* 1971: struct.bio_st */
            	1988, 0,
            	2029, 8,
            	116, 16,
            	1540, 48,
            	...
            	1966, 64,
            	154, 96,
            0, 8, 1, /* 1988: pointer.struct.bio_method_st */
            	1993, 0,
            0, 80, 9, /* 1993: struct.bio_method_st */
            	116, 8,
            	2014, 16,
            	2014, 24,
            	2017, 32,
            ...
            0, 8, 1, /* 2032: pointer.pointer.struct.env_md_ctx_st */
            	1543, 0,
            0, 0, 0, /* 2037: func */
            0, 72, 0, /* 2040: struct.anon */
            0, 16, 0, /* 2043: array[16].char */
            0, 0, 0, /* 2046: func */
            0, 8, 0, /* 2049: long */
            0, 8, 1, /* 2052: pointer.struct.iovec */
            	1020, 0,
            4097, 8, 0, /* 2057: pointer.func */
            0, 0, 0, /* 2060: func */
            0, 128, 14, /* 2063: struct.srp_ctx_st */
            	1540, 0,
            	2094, 8,
            	15, 16,
            	2057, 24,
            ...
            0, 8, 1, /* 2097: pointer.struct.ssl_ctx_st */
            	2102, 0,
            0, 736, 50, /* 2102: struct.ssl_ctx_st */
            	2205, 0,
            	94, 8,
            	94, 16,
            	56, 24,
            	...
            	1540, 720,
            	94, 728,
            0, 8, 1, /* 2205: pointer.struct.ssl_method_st */
            	2210, 0,
            0, 232, 28, /* 2210: struct.ssl_method_st */
            	2269, 8,
            	2272, 16,
            	2272, 24,
            	2269, 32,
            	...
            	2347, 216,
            	2350, 224,
            4097, 8, 0, /* 2269: pointer.func */
            4097, 8, 0, /* 2272: pointer.func */
            4097, 8, 0, /* 2275: pointer.func */
            ...
            0, 8, 1, /* 2302: pointer.struct.ssl3_enc_method */
            	2307, 0,
            0, 112, 11, /* 2307: struct.ssl3_enc_method */
            	436, 0,
            	2275, 8,
            	2269, 16,
            	2332, 24,
            ...
            0, 8, 1, /* 2377: pointer.struct.ssl2_state_st */
            	2382, 0,
            0, 344, 9, /* 2382: struct.ssl2_state_st */
            	116, 24,
            	116, 56,
            	116, 64,
            	116, 72,
            ...
            0, 0, 0, /* 2505: func */
            0, 0, 0, /* 2508: func */
            0, 8, 1, /* 2511: pointer.struct.ssl_st */
            	2516, 0,
            0, 808, 51, /* 2516: struct.ssl_st */
            	2205, 8,
            	1966, 16,
            	1966, 24,
            	1966, 32,
            ...
            0, 0, 0, /* 2648: func */
            0, 0, 0, /* 2651: func */
            0, 256, 0, /* 2654: array[256].char */
            0, 48, 0, /* 2657: array[48].char */
            0, 0, 0, /* 2660: func */
            0, 0, 0, /* 2663: func */
            0, 0, 0, /* 2666: func */
            0, 2, 0, /* 2669: short */
        ...
        .arg_entity_index = { 2511, },
        .ret_entity_index = 1412,
    };
