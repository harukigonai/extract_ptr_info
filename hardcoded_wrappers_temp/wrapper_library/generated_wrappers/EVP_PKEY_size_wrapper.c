...
int bb_EVP_PKEY_size(EVP_PKEY * arg_a) 
{
    ...
    em[1741] = 1; em[1742] = 8; em[1743] = 1; /* 1741: pointer.struct.asn1_type_st */
    	em[1744] = 86; em[1745] = 0; 
    em[1746] = 1; em[1747] = 8; em[1748] = 1; /* 1746: pointer.struct.engine_st */
    	em[1749] = 331; em[1750] = 0; 
    em[1751] = 1; em[1752] = 8; em[1753] = 1; /* 1751: pointer.struct.evp_pkey_st */
    	em[1754] = 1756; em[1755] = 0; 
    em[1756] = 0; em[1757] = 56; em[1758] = 4; /* 1756: struct.evp_pkey_st */
    	em[1759] = 1643; em[1760] = 16; 
    	em[1761] = 1746; em[1762] = 24; 
    	em[1763] = 873; em[1764] = 32; 
    	em[1765] = 1767; em[1766] = 48; 
    em[1767] = 1; em[1768] = 8; em[1769] = 1; /* 1767: pointer.struct.stack_st_X509_ATTRIBUTE */
    	em[1770] = 1772; em[1771] = 0; 
    em[1772] = 0; em[1773] = 32; em[1774] = 2; /* 1772: struct.stack_st_fake_X509_ATTRIBUTE */
    	em[1775] = 1779; em[1776] = 8; 
    	em[1777] = 287; em[1778] = 24; 
    em[1779] = 8884099; em[1780] = 8; em[1781] = 2; /* 1779: pointer_to_array_of_pointers_to_stack */
    	em[1782] = 1786; em[1783] = 0; 
    	em[1784] = 243; em[1785] = 20; 
    em[1786] = 0; em[1787] = 8; em[1788] = 1; /* 1786: pointer.X509_ATTRIBUTE */
    	em[1789] = 1791; em[1790] = 0; 
    em[1791] = 0; em[1792] = 0; em[1793] = 1; /* 1791: X509_ATTRIBUTE */
    	em[1794] = 1796; em[1795] = 0; 
    em[1796] = 0; em[1797] = 24; em[1798] = 2; /* 1796: struct.x509_attributes_st */
    	em[1799] = 139; em[1800] = 0; 
    	em[1801] = 1803; em[1802] = 16; 
    em[1803] = 0; em[1804] = 8; em[1805] = 3; /* 1803: union.unknown */
    	em[1806] = 134; em[1807] = 0; 
    	em[1808] = 1812; em[1809] = 0; 
    	em[1810] = 1741; em[1811] = 0; 
    em[1812] = 1; em[1813] = 8; em[1814] = 1; /* 1812: pointer.struct.stack_st_ASN1_TYPE */
    	em[1815] = 1817; em[1816] = 0; 
    em[1817] = 0; em[1818] = 32; em[1819] = 2; /* 1817: struct.stack_st_fake_ASN1_TYPE */
    	em[1820] = 1496; em[1821] = 8; 
    	em[1822] = 287; em[1823] = 24; 
    em[1824] = 0; em[1825] = 1; em[1826] = 0; /* 1824: char */
    args_addr->arg_entity_index[0] = 1751;
    args_addr->ret_entity_index = 243;
