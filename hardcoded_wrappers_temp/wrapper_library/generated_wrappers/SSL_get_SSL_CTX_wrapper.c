    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 16, 1, /* 9: struct._pqueue */
            	14, 0,
            0, 8, 1, /* 14: pointer.struct._pitem */
            	19, 0,
            ...
            0, 8, 1, /* 26: pointer.char */
            	4096, 0,
            0, 8, 1, /* 31: pointer.struct.dtls1_state_st */
            	36, 0,
            ...
            0, 16, 1, /* 53: struct.record_pqueue_st */
            	58, 8,
            0, 8, 1, /* 58: pointer.struct._pqueue */
            	9, 0,
            ...
            0, 40, 4, /* 68: struct.dtls1_retransmit_state */
            	...
            	796, 16,
            	842, 24,
            0, 8, 1, /* 79: pointer.struct.evp_cipher_ctx_st */
            	84, 0,
            0, 168, 4, /* 84: struct.evp_cipher_ctx_st */
            	...
            	132, 96,
            	132, 120,
            0, 8, 1, /* 95: pointer.struct.evp_cipher_st */
            	100, 0,
            ...
            0, 8, 1, /* 135: pointer.struct.engine_st */
            	140, 0,
            0, 216, 24, /* 140: struct.engine_st */
            	...
            	135, 200,
            	135, 208,
            0, 8, 1, /* 191: pointer.struct.rsa_meth_st */
            	196, 0,
            ...
            0, 8, 1, /* 246: pointer.struct.dsa_method */
            	251, 0,
            ...
            0, 8, 1, /* 297: pointer.struct.dh_method */
            	302, 0,
            ...
            0, 8, 1, /* 333: pointer.struct.ecdh_method */
            	338, 0,
            ...
            0, 8, 1, /* 350: pointer.struct.ecdsa_method */
            	355, 0,
            ...
            0, 8, 1, /* 377: pointer.struct.rand_meth_st */
            	382, 0,
            ...
            0, 8, 1, /* 412: pointer.struct.store_method_st */
            	417, 0,
            ...
            0, 8, 1, /* 444: pointer.struct.ENGINE_CMD_DEFN_st */
            	449, 0,
            ...
            0, 16, 1, /* 456: struct.crypto_ex_data_st */
            	461, 0,
            0, 8, 1, /* 461: pointer.struct.stack_st_OPENSSL_STRING */
            	466, 0,
            ...
            0, 32, 2, /* 471: struct.stack_st */
            	478, 8,
            	483, 24,
            0, 8, 1, /* 478: pointer.pointer.char */
            	26, 0,
            4097, 8, 0, /* 483: pointer.func */
            0, 8, 1, /* 486: pointer.struct.env_md_ctx_st */
            	491, 0,
            0, 48, 5, /* 491: struct.env_md_ctx_st */
            	...
            	549, 32,
            	531, 40,
            0, 8, 1, /* 504: pointer.struct.env_md_st */
            	509, 0,
            ...
            0, 8, 1, /* 549: pointer.struct.evp_pkey_ctx_st */
            	554, 0,
            0, 80, 8, /* 554: struct.evp_pkey_ctx_st */
            	...
            	631, 56,
            	788, 64,
            0, 8, 1, /* 573: pointer.struct.evp_pkey_method_st */
            	578, 0,
            0, 208, 25, /* 578: struct.evp_pkey_method_st */
            	...
            	666, 192,
            	669, 200,
            0, 8, 1, /* 631: pointer.struct.unnamed */
            	636, 0,
            ...
            0, 8, 1, /* 672: pointer.struct.evp_pkey_st */
            	677, 0,
            0, 56, 4, /* 677: struct.evp_pkey_st */
            	...
            	783, 32,
            	461, 48,
            0, 8, 1, /* 688: pointer.struct.evp_pkey_asn1_method_st */
            	693, 0,
            ...
            0, 8, 1, /* 783: struct.fnames */
            	26, 0,
            0, 8, 1, /* 788: pointer.int */
            	793, 0,
            0, 4, 0, /* 793: int */
            0, 8, 1, /* 796: pointer.struct.comp_ctx_st */
            	801, 0,
            0, 56, 2, /* 801: struct.comp_ctx_st */
            	808, 0,
            	456, 40,
            0, 8, 1, /* 808: pointer.struct.comp_method_st */
            	813, 0,
            ...
            0, 8, 1, /* 842: pointer.struct.ssl_session_st */
            	847, 0,
            0, 352, 14, /* 847: struct.ssl_session_st */
            	...
            	26, 320,
            	26, 344,
            0, 8, 1, /* 878: pointer.struct.sess_cert_st */
            	883, 0,
            0, 248, 6, /* 883: struct.sess_cert_st */
            	...
            	1257, 224,
            	1289, 232,
            0, 8, 1, /* 898: pointer.struct.cert_pkey_st */
            	903, 0,
            0, 24, 3, /* 903: struct.cert_pkey_st */
            	912, 0,
            	672, 8,
            	504, 16,
            0, 8, 1, /* 912: pointer.struct.x509_st */
            	917, 0,
            0, 184, 12, /* 917: struct.x509_st */
            	...
            	1115, 144,
            	1127, 176,
            0, 8, 1, /* 944: pointer.struct.x509_cinf_st */
            	949, 0,
            0, 104, 11, /* 949: struct.x509_cinf_st */
            	...
            	461, 72,
            	1070, 80,
            0, 8, 1, /* 974: pointer.struct.asn1_string_st */
            	979, 0,
            0, 24, 1, /* 979: struct.asn1_string_st */
            	26, 8,
            0, 8, 1, /* 984: pointer.struct.X509_algor_st */
            	989, 0,
            0, 16, 2, /* 989: struct.X509_algor_st */
            	996, 0,
            	1010, 8,
            0, 8, 1, /* 996: pointer.struct.asn1_object_st */
            	1001, 0,
            0, 40, 3, /* 1001: struct.asn1_object_st */
            	26, 0,
            	26, 8,
            	26, 24,
            0, 8, 1, /* 1010: pointer.struct.asn1_type_st */
            	1015, 0,
            0, 16, 1, /* 1015: struct.asn1_type_st */
            	783, 8,
            0, 8, 1, /* 1020: pointer.struct.X509_name_st */
            	1025, 0,
            0, 40, 3, /* 1025: struct.X509_name_st */
            	461, 0,
            	1034, 16,
            	26, 24,
            0, 8, 1, /* 1034: pointer.struct.buf_mem_st */
            	1039, 0,
            0, 24, 1, /* 1039: struct.buf_mem_st */
            	26, 8,
            0, 8, 1, /* 1044: pointer.struct.X509_val_st */
            	1049, 0,
            0, 16, 2, /* 1049: struct.X509_val_st */
            	974, 0,
            	974, 8,
            0, 8, 1, /* 1056: pointer.struct.X509_pubkey_st */
            	1061, 0,
            ...
            0, 24, 1, /* 1070: struct.ASN1_ENCODING_st */
            	26, 0,
            0, 8, 1, /* 1075: pointer.struct.AUTHORITY_KEYID_st */
            	1080, 0,
            0, 24, 3, /* 1080: struct.AUTHORITY_KEYID_st */
            	974, 0,
            	461, 8,
            	974, 16,
            0, 8, 1, /* 1089: pointer.struct.X509_POLICY_CACHE_st */
            	1094, 0,
            0, 40, 2, /* 1094: struct.X509_POLICY_CACHE_st */
            	1101, 0,
            	461, 8,
            0, 8, 1, /* 1101: pointer.struct.X509_POLICY_DATA_st */
            	1106, 0,
            0, 32, 3, /* 1106: struct.X509_POLICY_DATA_st */
            	996, 8,
            	461, 16,
            	461, 24,
            0, 8, 1, /* 1115: pointer.struct.NAME_CONSTRAINTS_st */
            	1120, 0,
            0, 16, 2, /* 1120: struct.NAME_CONSTRAINTS_st */
            	461, 0,
            	461, 8,
            0, 8, 1, /* 1127: pointer.struct.x509_cert_aux_st */
            	1132, 0,
            ...
            0, 192, 8, /* 1145: array[8].struct.cert_pkey_st */
            	...
            	903, 144,
            	903, 168,
            0, 8, 1, /* 1164: pointer.struct.rsa_st */
            	1169, 0,
            0, 168, 17, /* 1169: struct.rsa_st */
            	...
            	1230, 152,
            	1230, 160,
            0, 8, 1, /* 1206: pointer.struct.bignum_st */
            	1211, 0,
            0, 24, 1, /* 1211: struct.bignum_st */
            	788, 0,
            0, 8, 1, /* 1216: pointer.struct.bn_mont_ctx_st */
            	1221, 0,
            0, 96, 3, /* 1221: struct.bn_mont_ctx_st */
            	1211, 8,
            	1211, 32,
            	1211, 56,
            0, 8, 1, /* 1230: pointer.struct.bn_blinding_st */
            	1235, 0,
            ...
            0, 16, 1, /* 1252: struct.iovec */
            	26, 0,
            0, 8, 1, /* 1257: pointer.struct.dh_st */
            	1262, 0,
            0, 144, 12, /* 1262: struct.dh_st */
            	...
            	297, 128,
            	135, 136,
            0, 8, 1, /* 1289: pointer.struct.ec_key_st */
            	1294, 0,
            0, 56, 4, /* 1294: struct.ec_key_st */
            	...
            	1206, 24,
            	1498, 48,
            0, 8, 1, /* 1305: pointer.struct.ec_group_st */
            	1310, 0,
            0, 232, 12, /* 1310: struct.ec_group_st */
            	...
            	26, 216,
            	1522, 224,
            0, 8, 1, /* 1337: pointer.struct.ec_method_st */
            	1342, 0,
            ...
            0, 8, 1, /* 1482: pointer.struct.ec_point_st */
            	1487, 0,
            0, 88, 4, /* 1487: struct.ec_point_st */
            	...
            	1211, 32,
            	1211, 56,
            0, 8, 1, /* 1498: pointer.struct.ec_extra_data_st */
            	1503, 0,
            ...
            0, 8, 1, /* 1525: pointer.struct.ssl_cipher_st */
            	1530, 0,
            ...
            0, 528, 8, /* 1553: struct.anon */
            	...
            	504, 496,
            	1572, 512,
            0, 8, 1, /* 1572: pointer.struct.ssl_comp_st */
            	1577, 0,
            ...
            0, 0, 0, /* 1587: func */
            0, 0, 0, /* 1590: func */
            0, 8, 1, /* 1593: pointer.struct.ssl3_state_st */
            	1598, 0,
            ...
            0, 56, 3, /* 1626: struct.ssl3_record_st */
            	...
            	26, 24,
            	26, 32,
            0, 8, 1, /* 1635: pointer.struct.bio_st */
            	1640, 0,
            0, 112, 7, /* 1640: struct.bio_st */
            	...
            	1635, 64,
            	456, 96,
            0, 8, 1, /* 1657: pointer.struct.bio_method_st */
            	1662, 0,
            ...
            0, 8, 1, /* 1701: pointer.pointer.struct.env_md_ctx_st */
            	486, 0,
            0, 72, 0, /* 1706: struct.anon */
            0, 0, 0, /* 1709: func */
            0, 8, 1, /* 1712: pointer.struct.ssl_st */
            	1717, 0,
            0, 808, 51, /* 1717: struct.ssl_st */
            	...
            	2334, 656,
            	2284, 680,
            0, 8, 1, /* 1822: pointer.struct.ssl_method_st */
            	1827, 0,
            ...
            0, 8, 1, /* 1922: pointer.struct.ssl3_enc_method */
            	1927, 0,
            ...
            0, 8, 1, /* 1973: pointer.struct.ssl2_state_st */
            	1978, 0,
            ...
            0, 8, 1, /* 2002: pointer.struct.X509_VERIFY_PARAM_st */
            	2007, 0,
            0, 56, 2, /* 2007: struct.X509_VERIFY_PARAM_st */
            	26, 0,
            	461, 48,
            0, 8, 1, /* 2014: pointer.struct.cert_st */
            	2019, 0,
            ...
            0, 8, 1, /* 2059: pointer.struct.ssl_ctx_st */
            	2064, 0,
            0, 736, 50, /* 2064: struct.ssl_ctx_st */
            	...
            	132, 720,
            	461, 728,
            0, 8, 1, /* 2167: pointer.struct.x509_store_st */
            	2172, 0,
            ...
            0, 8, 1, /* 2226: pointer.struct.in_addr */
            	2231, 0,
            ...
            0, 8, 1, /* 2264: pointer.struct.ssl3_buf_freelist_st */
            	2269, 0,
            0, 24, 1, /* 2269: struct.ssl3_buf_freelist_st */
            	2274, 16,
            0, 8, 1, /* 2274: pointer.struct.ssl3_buf_freelist_entry_st */
            	2279, 0,
            ...
            0, 8, 1, /* 2324: pointer.struct.tls_session_ticket_ext_st */
            	2329, 0,
            0, 16, 1, /* 2329: struct.tls_session_ticket_ext_st */
            	132, 8,
            0, 8, 1, /* 2334: pointer.struct.iovec */
            	1252, 0,
            0, 0, 0, /* 2339: func */
