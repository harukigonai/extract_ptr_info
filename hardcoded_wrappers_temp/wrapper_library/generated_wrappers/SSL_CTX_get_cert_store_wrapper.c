    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 248, 6, /* 972: struct.sess_cert_st */
            	...
            	667, 232,
            0, 0, 0, /* 987: func */
            0, 8, 0, /* 990: pointer.func */
            0, 0, 0, /* 993: func */
            0, 8, 0, /* 996: pointer.func */
            0, 352, 14, /* 999: struct.ssl_session_st */
            	169, 144,
            	169, 152,
            	1030, 168,
            	97, 176,
            	...
            	169, 320,
            	169, 344,
            1, 8, 1, /* 1030: pointer.struct.sess_cert_st */
            	972, 0,
            1, 8, 1, /* 1035: pointer.struct.ssl_session_st */
            	999, 0,
            0, 0, 0, /* 1040: func */
            0, 8, 0, /* 1043: pointer.func */
            0, 8, 0, /* 1046: pointer.func */
            1, 8, 1, /* 1049: pointer.struct.in_addr */
            	942, 0,
            0, 8, 0, /* 1054: pointer.func */
            0, 8, 0, /* 1057: pointer.func */
            0, 0, 0, /* 1060: func */
            0, 0, 0, /* 1063: func */
            0, 0, 0, /* 1066: func */
            1, 8, 1, /* 1069: pointer.struct.x509_store_st */
            	1074, 0,
            0, 144, 4, /* 1074: struct.x509_store_st */
            	232, 8,
            	232, 16,
            	1085, 24,
            	448, 120,
            1, 8, 1, /* 1085: pointer.struct.X509_VERIFY_PARAM_st */
            	1090, 0,
            0, 56, 2, /* 1090: struct.X509_VERIFY_PARAM_st */
            	169, 0,
            	232, 48,
            0, 8, 0, /* 1097: pointer.func */
            0, 8, 0, /* 1100: pointer.func */
            0, 8, 0, /* 1103: pointer.func */
            0, 0, 0, /* 1106: func */
            1, 8, 1, /* 1109: pointer.struct.ssl3_enc_method.753 */
            	1114, 0,
            0, 112, 4, /* 1114: struct.ssl3_enc_method.753 */
            	318, 0,
            	318, 32,
            	169, 64,
            	169, 80,
            ...
            0, 0, 0, /* 1128: func */
            0, 0, 0, /* 1131: func */
            0, 8, 0, /* 1134: pointer.func */
            0, 8, 0, /* 1137: pointer.func */
            0, 8, 0, /* 1140: pointer.func */
            0, 8, 0, /* 1143: pointer.func */
            0, 8, 0, /* 1146: pointer.func */
            0, 8, 0, /* 1149: pointer.func */
            0, 0, 0, /* 1152: func */
            0, 0, 0, /* 1155: func */
            0, 0, 0, /* 1158: func */
            0, 0, 0, /* 1161: func */
            0, 8, 0, /* 1164: pointer.func */
            0, 0, 0, /* 1167: func */
            0, 8, 0, /* 1170: pointer.func */
            0, 8, 0, /* 1173: pointer.func */
            0, 8, 0, /* 1176: pointer.func */
            0, 8, 0, /* 1179: pointer.func */
            0, 0, 0, /* 1182: func */
            0, 32, 0, /* 1185: array[32].char */
            0, 8, 0, /* 1188: pointer.func */
            0, 0, 0, /* 1191: func */
            0, 8, 0, /* 1194: pointer.func */
            0, 0, 0, /* 1197: func */
            0, 8, 0, /* 1200: pointer.func */
            0, 8, 0, /* 1203: pointer.func */
            0, 0, 0, /* 1206: func */
            0, 0, 0, /* 1209: func */
            0, 8, 0, /* 1212: pointer.func */
            0, 8, 0, /* 1215: pointer.func */
            0, 0, 0, /* 1218: func */
            0, 8, 0, /* 1221: pointer.func */
            0, 8, 0, /* 1224: pointer.func */
            0, 0, 0, /* 1227: func */
            0, 8, 0, /* 1230: array[8].char */
            0, 8, 0, /* 1233: pointer.func */
            0, 0, 0, /* 1236: func */
            0, 8, 0, /* 1239: pointer.func */
            0, 128, 11, /* 1242: struct.srp_ctx_st.751 */
            	169, 0,
            	169, 32,
            	578, 40,
            	578, 48,
            	...
            	578, 96,
            	169, 104,
            0, 8, 0, /* 1267: pointer.func */
            0, 8, 0, /* 1270: pointer.func */
            0, 8, 0, /* 1273: pointer.func */
            0, 0, 0, /* 1276: func */
            0, 24, 1, /* 1279: struct.ssl3_buf_freelist_st */
            	54, 16,
            0, 8, 0, /* 1284: long */
            0, 8, 0, /* 1287: pointer.func */
            0, 8, 0, /* 1290: pointer.func */
            0, 8, 0, /* 1293: pointer.func */
            0, 0, 0, /* 1296: func */
            0, 0, 0, /* 1299: func */
            0, 8, 0, /* 1302: pointer.func */
            0, 8, 0, /* 1305: pointer.func */
            0, 8, 0, /* 1308: pointer.func */
            0, 0, 0, /* 1311: func */
            0, 0, 0, /* 1314: func */
            0, 0, 0, /* 1317: func */
            0, 0, 0, /* 1320: func */
            0, 232, 1, /* 1323: struct.ssl_method_st.754 */
            	1109, 200,
            0, 20, 0, /* 1328: array[5].int */
            1, 8, 1, /* 1331: pointer.struct.ssl_ctx_st.752 */
            	1336, 0,
            0, 736, 30, /* 1336: struct.ssl_ctx_st.752 */
            	1399, 0,
            	232, 8,
            	232, 16,
            	1069, 24,
            	...
            	169, 720,
            	232, 728,
            1, 8, 1, /* 1399: pointer.struct.ssl_method_st.754 */
            	1323, 0,
            1, 8, 1, /* 1404: pointer.struct.ssl3_buf_freelist_st */
            	1279, 0,
            0, 0, 0, /* 1409: func */
        ...
        .arg_entity_index = { 1331, },
        .ret_entity_index = 1069,
    };
