...
X509_STORE * bb_SSL_CTX_get_cert_store(const SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5266: pointer.struct.ssl3_enc_method */
            	5271, 0,
            0, 112, 11, /* 5271: struct.ssl3_enc_method */
            	5263, 0,
            	5296, 8,
            	5299, 16,
            	5260, 24,
            ...
            1, 8, 1, /* 5326: pointer.struct.ssl_ctx_st */
            	5331, 0,
            0, 736, 50, /* 5331: struct.ssl_ctx_st */
            	5434, 0,
            	5173, 8,
            	5173, 16,
            	5522, 24,
            	...
            	41, 720,
            	6547, 728,
            1, 8, 1, /* 5434: pointer.struct.ssl_method_st */
            	5439, 0,
            0, 232, 28, /* 5439: struct.ssl_method_st */
            	5323, 8,
            	5498, 16,
            	5498, 24,
            	5323, 32,
            ...
            1, 8, 1, /* 5522: pointer.struct.x509_store_st */
            	5527, 0,
            0, 144, 15, /* 5527: struct.x509_store_st */
            	5560, 8,
            	6234, 16,
            	6446, 24,
            	6458, 32,
            	...
            	6458, 112,
            	5141, 120,
            1, 8, 1, /* 5560: pointer.struct.stack_st_X509_OBJECT */
            	5565, 0,
            0, 32, 2, /* 5565: struct.stack_st_fake_X509_OBJECT */
            	5572, 8,
            	180, 24,
            8884099, 8, 2, /* 5572: pointer_to_array_of_pointers_to_stack */
            	5579, 0,
            	1052, 20,
            0, 8, 1, /* 5579: pointer.X509_OBJECT */
            	5584, 0,
            0, 0, 1, /* 5584: X509_OBJECT */
            	5589, 0,
            0, 16, 1, /* 5589: struct.x509_object_st */
            	5594, 8,
            0, 8, 4, /* 5594: union.unknown */
            	53, 0,
            	5605, 0,
            	5947, 0,
            	6156, 0,
            1, 8, 1, /* 5605: pointer.struct.x509_st */
            	5610, 0,
            0, 184, 12, /* 5610: struct.x509_st */
            	5637, 0,
            	5677, 8,
            	5752, 16,
            	53, 32,
            	...
            	5871, 144,
            	5876, 176,
            1, 8, 1, /* 5637: pointer.struct.x509_cinf_st */
            	5642, 0,
            0, 104, 11, /* 5642: struct.x509_cinf_st */
            	5667, 0,
            	5667, 8,
            	5677, 16,
            	5682, 24,
            	...
            	5757, 72,
            	5781, 80,
            1, 8, 1, /* 5667: pointer.struct.asn1_string_st */
            	5672, 0,
            0, 24, 1, /* 5672: struct.asn1_string_st */
            	145, 8,
            1, 8, 1, /* 5677: pointer.struct.X509_algor_st */
            	2059, 0,
            1, 8, 1, /* 5682: pointer.struct.X509_name_st */
            	5687, 0,
            0, 40, 3, /* 5687: struct.X509_name_st */
            	5696, 0,
            	5720, 16,
            	145, 24,
            1, 8, 1, /* 5696: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5701, 0,
            0, 32, 2, /* 5701: struct.stack_st_fake_X509_NAME_ENTRY */
            	5708, 8,
            	180, 24,
            8884099, 8, 2, /* 5708: pointer_to_array_of_pointers_to_stack */
            	5715, 0,
            	1052, 20,
            0, 8, 1, /* 5715: pointer.X509_NAME_ENTRY */
            	2470, 0,
            1, 8, 1, /* 5720: pointer.struct.buf_mem_st */
            	5725, 0,
            0, 24, 1, /* 5725: struct.buf_mem_st */
            	53, 8,
            1, 8, 1, /* 5730: pointer.struct.X509_val_st */
            	5735, 0,
            0, 16, 2, /* 5735: struct.X509_val_st */
            	5742, 0,
            	5742, 8,
            1, 8, 1, /* 5742: pointer.struct.asn1_string_st */
            	5672, 0,
            1, 8, 1, /* 5747: pointer.struct.X509_pubkey_st */
            	2303, 0,
            1, 8, 1, /* 5752: pointer.struct.asn1_string_st */
            	5672, 0,
            1, 8, 1, /* 5757: pointer.struct.stack_st_X509_EXTENSION */
            	5762, 0,
            0, 32, 2, /* 5762: struct.stack_st_fake_X509_EXTENSION */
            	5769, 8,
            	180, 24,
            8884099, 8, 2, /* 5769: pointer_to_array_of_pointers_to_stack */
            	5776, 0,
            	1052, 20,
            0, 8, 1, /* 5776: pointer.X509_EXTENSION */
            	2262, 0,
            0, 24, 1, /* 5781: struct.ASN1_ENCODING_st */
            	145, 0,
            0, 16, 1, /* 5786: struct.crypto_ex_data_st */
            	5791, 0,
            1, 8, 1, /* 5791: pointer.struct.stack_st_void */
            	5796, 0,
            0, 32, 1, /* 5796: struct.stack_st_void */
            	5801, 0,
            0, 32, 2, /* 5801: struct.stack_st */
            	175, 8,
            	180, 24,
            1, 8, 1, /* 5808: pointer.struct.asn1_string_st */
            	5672, 0,
            1, 8, 1, /* 5813: pointer.struct.AUTHORITY_KEYID_st */
            	2596, 0,
            1, 8, 1, /* 5818: pointer.struct.X509_POLICY_CACHE_st */
            	2919, 0,
            1, 8, 1, /* 5823: pointer.struct.stack_st_DIST_POINT */
            	5828, 0,
            0, 32, 2, /* 5828: struct.stack_st_fake_DIST_POINT */
            	5835, 8,
            	180, 24,
            8884099, 8, 2, /* 5835: pointer_to_array_of_pointers_to_stack */
            	5842, 0,
            	1052, 20,
            0, 8, 1, /* 5842: pointer.DIST_POINT */
            	3360, 0,
            1, 8, 1, /* 5847: pointer.struct.stack_st_GENERAL_NAME */
            	5852, 0,
            0, 32, 2, /* 5852: struct.stack_st_fake_GENERAL_NAME */
            	5859, 8,
            	180, 24,
            8884099, 8, 2, /* 5859: pointer_to_array_of_pointers_to_stack */
            	5866, 0,
            	1052, 20,
            0, 8, 1, /* 5866: pointer.GENERAL_NAME */
            	2639, 0,
            1, 8, 1, /* 5871: pointer.struct.NAME_CONSTRAINTS_st */
            	3504, 0,
            1, 8, 1, /* 5876: pointer.struct.x509_cert_aux_st */
            	5881, 0,
            0, 40, 5, /* 5881: struct.x509_cert_aux_st */
            	5894, 0,
            	5894, 8,
            	5918, 16,
            	5808, 24,
            	5923, 32,
            1, 8, 1, /* 5894: pointer.struct.stack_st_ASN1_OBJECT */
            	5899, 0,
            0, 32, 2, /* 5899: struct.stack_st_fake_ASN1_OBJECT */
            	5906, 8,
            	180, 24,
            8884099, 8, 2, /* 5906: pointer_to_array_of_pointers_to_stack */
            	5913, 0,
            	1052, 20,
            0, 8, 1, /* 5913: pointer.ASN1_OBJECT */
            	1993, 0,
            1, 8, 1, /* 5918: pointer.struct.asn1_string_st */
            	5672, 0,
            1, 8, 1, /* 5923: pointer.struct.stack_st_X509_ALGOR */
            	5928, 0,
            0, 32, 2, /* 5928: struct.stack_st_fake_X509_ALGOR */
            	5935, 8,
            	180, 24,
            8884099, 8, 2, /* 5935: pointer_to_array_of_pointers_to_stack */
            	5942, 0,
            	1052, 20,
            0, 8, 1, /* 5942: pointer.X509_ALGOR */
            	2054, 0,
            1, 8, 1, /* 5947: pointer.struct.X509_crl_st */
            	5952, 0,
            0, 120, 10, /* 5952: struct.X509_crl_st */
            	5975, 0,
            	5677, 8,
            	5752, 16,
            	5813, 32,
            	...
            	6131, 104,
            	41, 112,
            1, 8, 1, /* 5975: pointer.struct.X509_crl_info_st */
            	5980, 0,
            0, 80, 8, /* 5980: struct.X509_crl_info_st */
            	5667, 0,
            	5677, 8,
            	5682, 16,
            	5742, 24,
            	...
            	5757, 48,
            	5781, 56,
            1, 8, 1, /* 5999: pointer.struct.stack_st_X509_REVOKED */
            	6004, 0,
            0, 32, 2, /* 6004: struct.stack_st_fake_X509_REVOKED */
            	6011, 8,
            	180, 24,
            8884099, 8, 2, /* 6011: pointer_to_array_of_pointers_to_stack */
            	6018, 0,
            	1052, 20,
            0, 8, 1, /* 6018: pointer.X509_REVOKED */
            	6023, 0,
            0, 0, 1, /* 6023: X509_REVOKED */
            	6028, 0,
            0, 40, 4, /* 6028: struct.x509_revoked_st */
            	6039, 0,
            	6049, 8,
            	6054, 16,
            	4217, 24,
            1, 8, 1, /* 6039: pointer.struct.asn1_string_st */
            	6044, 0,
            0, 24, 1, /* 6044: struct.asn1_string_st */
            	145, 8,
            1, 8, 1, /* 6049: pointer.struct.asn1_string_st */
            	6044, 0,
            1, 8, 1, /* 6054: pointer.struct.stack_st_X509_EXTENSION */
            	6059, 0,
            0, 32, 2, /* 6059: struct.stack_st_fake_X509_EXTENSION */
            	6066, 8,
            	180, 24,
            8884099, 8, 2, /* 6066: pointer_to_array_of_pointers_to_stack */
            	6073, 0,
            	1052, 20,
            0, 8, 1, /* 6073: pointer.X509_EXTENSION */
            	2262, 0,
            1, 8, 1, /* 6078: pointer.struct.ISSUING_DIST_POINT_st */
            	6083, 0,
            0, 32, 2, /* 6083: struct.ISSUING_DIST_POINT_st */
            	3374, 0,
            	3465, 16,
            1, 8, 1, /* 6090: pointer.struct.stack_st_GENERAL_NAMES */
            	6095, 0,
            0, 32, 2, /* 6095: struct.stack_st_fake_GENERAL_NAMES */
            	6102, 8,
            	180, 24,
            8884099, 8, 2, /* 6102: pointer_to_array_of_pointers_to_stack */
            	6109, 0,
            	1052, 20,
            0, 8, 1, /* 6109: pointer.GENERAL_NAMES */
            	6114, 0,
            0, 0, 1, /* 6114: GENERAL_NAMES */
            	6119, 0,
            0, 32, 1, /* 6119: struct.stack_st_GENERAL_NAME */
            	6124, 0,
            0, 32, 2, /* 6124: struct.stack_st */
            	175, 8,
            	180, 24,
            1, 8, 1, /* 6131: pointer.struct.x509_crl_method_st */
            	6136, 0,
            0, 40, 4, /* 6136: struct.x509_crl_method_st */
            	6147, 8,
            	6147, 16,
            	6150, 24,
            	6153, 32,
            8884097, 8, 0, /* 6147: pointer.func */
            8884097, 8, 0, /* 6150: pointer.func */
            8884097, 8, 0, /* 6153: pointer.func */
            1, 8, 1, /* 6156: pointer.struct.evp_pkey_st */
            	6161, 0,
            0, 56, 4, /* 6161: struct.evp_pkey_st */
            	6172, 16,
            	219, 24,
            	6177, 32,
            	6210, 48,
            1, 8, 1, /* 6172: pointer.struct.evp_pkey_asn1_method_st */
            	1858, 0,
            0, 8, 5, /* 6177: union.unknown */
            	53, 0,
            	6190, 0,
            	6195, 0,
            	6200, 0,
            	6205, 0,
            1, 8, 1, /* 6190: pointer.struct.rsa_st */
            	572, 0,
            1, 8, 1, /* 6195: pointer.struct.dsa_st */
            	1224, 0,
            1, 8, 1, /* 6200: pointer.struct.dh_st */
            	94, 0,
            1, 8, 1, /* 6205: pointer.struct.ec_key_st */
            	1356, 0,
            1, 8, 1, /* 6210: pointer.struct.stack_st_X509_ATTRIBUTE */
            	6215, 0,
            0, 32, 2, /* 6215: struct.stack_st_fake_X509_ATTRIBUTE */
            	6222, 8,
            	180, 24,
            8884099, 8, 2, /* 6222: pointer_to_array_of_pointers_to_stack */
            	6229, 0,
            	1052, 20,
            0, 8, 1, /* 6229: pointer.X509_ATTRIBUTE */
            	833, 0,
            1, 8, 1, /* 6234: pointer.struct.stack_st_X509_LOOKUP */
            	6239, 0,
            0, 32, 2, /* 6239: struct.stack_st_fake_X509_LOOKUP */
            	6246, 8,
            	180, 24,
            8884099, 8, 2, /* 6246: pointer_to_array_of_pointers_to_stack */
            	6253, 0,
            	1052, 20,
            0, 8, 1, /* 6253: pointer.X509_LOOKUP */
            	6258, 0,
            0, 0, 1, /* 6258: X509_LOOKUP */
            	6263, 0,
            0, 32, 3, /* 6263: struct.x509_lookup_st */
            	6272, 8,
            	53, 16,
            	6321, 24,
            1, 8, 1, /* 6272: pointer.struct.x509_lookup_method_st */
            	6277, 0,
            0, 80, 10, /* 6277: struct.x509_lookup_method_st */
            	5, 0,
            	6300, 8,
            	6303, 16,
            	6300, 24,
            ...
            8884097, 8, 0, /* 6312: pointer.func */
            8884097, 8, 0, /* 6315: pointer.func */
            8884097, 8, 0, /* 6318: pointer.func */
            1, 8, 1, /* 6321: pointer.struct.x509_store_st */
            	6326, 0,
            0, 144, 15, /* 6326: struct.x509_store_st */
            	6359, 8,
            	6383, 16,
            	6407, 24,
            	6419, 32,
            	...
            	6419, 112,
            	5786, 120,
            1, 8, 1, /* 6359: pointer.struct.stack_st_X509_OBJECT */
            	6364, 0,
            0, 32, 2, /* 6364: struct.stack_st_fake_X509_OBJECT */
            	6371, 8,
            	180, 24,
            8884099, 8, 2, /* 6371: pointer_to_array_of_pointers_to_stack */
            	6378, 0,
            	1052, 20,
            0, 8, 1, /* 6378: pointer.X509_OBJECT */
            	5584, 0,
            1, 8, 1, /* 6383: pointer.struct.stack_st_X509_LOOKUP */
            	6388, 0,
            0, 32, 2, /* 6388: struct.stack_st_fake_X509_LOOKUP */
            	6395, 8,
            	180, 24,
            8884099, 8, 2, /* 6395: pointer_to_array_of_pointers_to_stack */
            	6402, 0,
            	1052, 20,
            0, 8, 1, /* 6402: pointer.X509_LOOKUP */
            	6258, 0,
            1, 8, 1, /* 6407: pointer.struct.X509_VERIFY_PARAM_st */
            	6412, 0,
            0, 56, 2, /* 6412: struct.X509_VERIFY_PARAM_st */
            	53, 0,
            	5894, 48,
            8884097, 8, 0, /* 6419: pointer.func */
            ...
            8884097, 8, 0, /* 6437: pointer.func */
            8884097, 8, 0, /* 6440: pointer.func */
            8884097, 8, 0, /* 6443: pointer.func */
            1, 8, 1, /* 6446: pointer.struct.X509_VERIFY_PARAM_st */
            	6451, 0,
            0, 56, 2, /* 6451: struct.X509_VERIFY_PARAM_st */
            	53, 0,
            	4353, 48,
            8884097, 8, 0, /* 6458: pointer.func */
            8884097, 8, 0, /* 6461: pointer.func */
            8884097, 8, 0, /* 6464: pointer.func */
            8884097, 8, 0, /* 6467: pointer.func */
            8884097, 8, 0, /* 6470: pointer.func */
            8884097, 8, 0, /* 6473: pointer.func */
            8884097, 8, 0, /* 6476: pointer.func */
            8884097, 8, 0, /* 6479: pointer.func */
            8884097, 8, 0, /* 6482: pointer.func */
            8884097, 8, 0, /* 6485: pointer.func */
            8884097, 8, 0, /* 6488: pointer.func */
            8884097, 8, 0, /* 6491: pointer.func */
            1, 8, 1, /* 6494: pointer.struct.env_md_st */
            	6499, 0,
            0, 120, 8, /* 6499: struct.env_md_st */
            	6518, 24,
            	6521, 32,
            	4320, 40,
            	4317, 48,
            ...
            1, 8, 1, /* 6536: pointer.struct.ssl3_buf_freelist_st */
            	4568, 0,
            8884097, 8, 0, /* 6541: pointer.func */
            8884097, 8, 0, /* 6544: pointer.func */
            1, 8, 1, /* 6547: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	6552, 0,
            0, 32, 2, /* 6552: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	6559, 8,
            	180, 24,
            8884099, 8, 2, /* 6559: pointer_to_array_of_pointers_to_stack */
            	6566, 0,
            	1052, 20,
            0, 8, 1, /* 6566: pointer.SRTP_PROTECTION_PROFILE */
            	6571, 0,
            0, 0, 1, /* 6571: SRTP_PROTECTION_PROFILE */
            	0, 0,
            0, 1, 0, /* 6576: char */
            1, 8, 1, /* 6579: pointer.struct.x509_store_st */
            	5527, 0,
        },
        .arg_entity_index = { 5326, },
        .ret_entity_index = 6579,
    };
