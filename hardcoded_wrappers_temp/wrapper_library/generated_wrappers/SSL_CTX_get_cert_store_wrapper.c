    ...
    struct lib_enter_args args = {
        .entity_metadata = {
            ...
            1, 8, 1, /* 2116: pointer.func */
            	2121, 0,
            0, 0, 0, /* 2121: func */
            0, 352, 34, /* 2124: struct.ssl_session_st */
            	267, 0,
            	267, 4,
            	2195, 8,
            	267, 16,
            ...
            0, 32, 32, /* 2313: array[32].char */
            	...
            	86, 30,
            	86, 31,
            1, 8, 1, /* 2380: pointer.struct.sess_cert_st */
            	2094, 0,
            1, 8, 1, /* 2385: pointer.struct.ssl_session_st */
            	2124, 0,
            0, 0, 0, /* 2390: func */
            1, 8, 1, /* 2393: pointer.func */
            	2398, 0,
            0, 0, 0, /* 2398: func */
            1, 8, 1, /* 2401: pointer.struct.in_addr */
            	2073, 0,
            1, 8, 1, /* 2406: pointer.func */
            	2411, 0,
            0, 0, 0, /* 2411: func */
            0, 0, 0, /* 2414: func */
            0, 0, 0, /* 2417: func */
            1, 8, 1, /* 2420: pointer.struct.x509_store_st */
            	2425, 0,
            0, 144, 17, /* 2425: struct.x509_store_st */
            	267, 0,
            	345, 8,
            	345, 16,
            	2462, 24,
            	...
            	1135, 120,
            	267, 136,
            1, 8, 1, /* 2462: pointer.struct.X509_VERIFY_PARAM_st */
            	2467, 0,
            0, 56, 8, /* 2467: struct.X509_VERIFY_PARAM_st */
            	270, 0,
            	275, 8,
            	275, 16,
            	275, 24,
            	...
            	267, 40,
            	345, 48,
            1, 8, 1, /* 2486: pointer.func */
            	2491, 0,
            0, 0, 0, /* 2491: func */
            1, 8, 1, /* 2494: pointer.func */
            	2499, 0,
            0, 0, 0, /* 2499: func */
            1, 8, 1, /* 2502: pointer.func */
            	2507, 0,
            0, 0, 0, /* 2507: func */
            1, 8, 1, /* 2510: pointer.func */
            	2515, 0,
            0, 0, 0, /* 2515: func */
            1, 8, 1, /* 2518: pointer.func */
            	2523, 0,
            0, 0, 0, /* 2523: func */
            ...
            1, 8, 1, /* 2550: pointer.func */
            	8, 0,
            1, 8, 1, /* 2555: pointer.func */
            	2414, 0,
            1, 8, 1, /* 2560: pointer.struct.ssl3_enc_method.753 */
            	2565, 0,
            0, 112, 14, /* 2565: struct.ssl3_enc_method.753 */
            	507, 0,
            	2596, 8,
            	2116, 16,
            	2406, 24,
            	...
            	2393, 96,
            	2620, 104,
            1, 8, 1, /* 2596: pointer.func */
            	2601, 0,
            0, 0, 0, /* 2601: func */
            1, 8, 1, /* 2604: pointer.func */
            	2609, 0,
            0, 0, 0, /* 2609: func */
            ...
            1, 8, 1, /* 2660: pointer.func */
            	89, 0,
            0, 128, 16, /* 2665: struct.srp_ctx_st.751 */
            	270, 0,
            	2660, 8,
            	38, 16,
            	11, 24,
            ...
            1, 8, 1, /* 2700: pointer.func */
            	2705, 0,
            0, 0, 0, /* 2705: func */
            0, 24, 3, /* 2708: struct.ssl3_buf_freelist_st */
            	275, 0,
            	267, 8,
            	108, 16,
            1, 8, 1, /* 2717: pointer.func */
            	2657, 0,
            0, 232, 29, /* 2722: struct.ssl_method_st.754 */
            	267, 0,
            	2116, 8,
            	2644, 16,
            	2644, 24,
            ...
            1, 8, 1, /* 2783: pointer.func */
            	2788, 0,
            0, 0, 0, /* 2788: func */
            1, 8, 1, /* 2791: pointer.func */
            	2625, 0,
            1, 8, 1, /* 2796: pointer.func */
            	2801, 0,
            0, 0, 0, /* 2801: func */
            1, 8, 1, /* 2804: pointer.func */
            	2809, 0,
            0, 0, 0, /* 2809: func */
            1, 8, 1, /* 2812: pointer.func */
            	2817, 0,
            0, 0, 0, /* 2817: func */
            1, 8, 1, /* 2820: pointer.func */
            	2636, 0,
            1, 8, 1, /* 2825: pointer.struct.ssl_ctx_st.752 */
            	2830, 0,
            0, 736, 68, /* 2830: struct.ssl_ctx_st.752 */
            	2969, 0,
            	345, 8,
            	345, 16,
            	2420, 24,
            	...
            	270, 720,
            	345, 728,
            1, 8, 1, /* 2969: pointer.struct.ssl_method_st.754 */
            	2722, 0,
            1, 8, 1, /* 2974: pointer.func */
            	2070, 0,
            1, 8, 1, /* 2979: pointer.func */
            	2984, 0,
            0, 0, 0, /* 2984: func */
            1, 8, 1, /* 2987: pointer.func */
            	2992, 0,
            0, 0, 0, /* 2992: func */
            1, 8, 1, /* 2995: pointer.struct.ssl3_buf_freelist_st */
            	2708, 0,
        },
        .arg_entity_index = { 2825, },
        .ret_entity_index = 2420,
    };
