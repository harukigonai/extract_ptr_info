...
const char * bb_SSL_get_servername(const SSL * arg_a,const int arg_b) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 2, 0, /* 2994: array[2].char */
            0, 48, 0, /* 2997: array[48].char */
            0, 16, 0, /* 3000: array[16].char */
            0, 808, 51, /* 3003: struct.ssl_st.776 */
            	254, 8,
            	2864, 16,
            	2864, 24,
            	2864, 32,
            	...
            	3113, 656,
            	2331, 680,
            1, 8, 1, /* 3108: pointer.struct.tls_session_ticket_ext_st */
            	8, 0,
            1, 8, 1, /* 3113: pointer.struct.iovec */
            	1799, 0,
            0, 72, 0, /* 3118: struct.anon.25 */
            1, 8, 1, /* 3121: pointer.struct.ssl_st.776 */
            	3003, 0,
            0, 8, 0, /* 3126: array[8].char */
            0, 8, 0, /* 3129: long */
            0, 32, 0, /* 3132: array[32].char */
            0, 2, 0, /* 3135: short */
            0, 256, 0, /* 3138: array[256].char */
            0, 20, 0, /* 3141: array[20].char */
        },
        .arg_entity_index = { 3121, 1760, },
        .ret_entity_index = 13,
    };
