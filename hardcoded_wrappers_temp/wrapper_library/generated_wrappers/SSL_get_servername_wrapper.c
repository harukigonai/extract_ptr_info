...
const char * bb_SSL_get_servername(const SSL * arg_a,const int arg_b) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            8884097, 8, 0, /* 6807: pointer.func */
            0, 112, 7, /* 6810: struct.bio_st */
            	6827, 0,
            	6859, 8,
            	26, 16,
            	5, 48,
            	...
            	6862, 64,
            	4883, 96,
            1, 8, 1, /* 6827: pointer.struct.bio_method_st */
            	6832, 0,
            0, 80, 9, /* 6832: struct.bio_method_st */
            	102, 8,
            	6774, 16,
            	6801, 24,
            	6679, 32,
            	...
            	6853, 64,
            	6856, 72,
            8884097, 8, 0, /* 6853: pointer.func */
            8884097, 8, 0, /* 6856: pointer.func */
            8884097, 8, 0, /* 6859: pointer.func */
            1, 8, 1, /* 6862: pointer.struct.bio_st */
            	6810, 0,
            1, 8, 1, /* 6867: pointer.struct.bio_st */
            	6810, 0,
            1, 8, 1, /* 6872: pointer.struct.ssl_st */
            	6877, 0,
            0, 808, 51, /* 6877: struct.ssl_st */
            	5008, 8,
            	6867, 16,
            	6867, 24,
            	6867, 32,
            ...
            0, 80, 8, /* 7064: struct.evp_pkey_ctx_st */
            	...
            	6804, 56,
            	7133, 64,
            1, 8, 1, /* 7083: pointer.struct.evp_pkey_method_st */
            	6694, 0,
            ...
            1, 8, 1, /* 7356: pointer.struct.srtp_protection_profile_st */
            	4445, 0,
            0, 1, 0, /* 7361: char */
            0, 0, 0, /* 7364: unknown_deriv_type */
        },
        .arg_entity_index = { 6872, 7364, },
