...
void bb_SSL_CTX_set_tmp_dh_callback(SSL_CTX * arg_a,DH *(*arg_b)(SSL *, int, int)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6260: pointer.struct.ssl_ctx_st */
            	6265, 0,
            0, 736, 50, /* 6265: struct.ssl_ctx_st */
            	6368, 0,
            	5173, 8,
            	5173, 16,
            	6474, 24,
            	...
            	41, 720,
            	6552, 728,
            1, 8, 1, /* 6368: pointer.struct.ssl_method_st */
            	6373, 0,
            0, 232, 28, /* 6373: struct.ssl_method_st */
            	6432, 8,
            	6435, 16,
            	6435, 24,
            	6432, 32,
            ...
            8884097, 8, 0, /* 6465: pointer.func */
            8884097, 8, 0, /* 6468: pointer.func */
            8884097, 8, 0, /* 6471: pointer.func */
            1, 8, 1, /* 6474: pointer.struct.x509_store_st */
            	6479, 0,
            0, 144, 15, /* 6479: struct.x509_store_st */
            	6233, 8,
            	6092, 16,
            	6512, 24,
            	5248, 32,
            	...
            	5248, 112,
            	5141, 120,
            1, 8, 1, /* 6512: pointer.struct.X509_VERIFY_PARAM_st */
            	6172, 0,
            8884097, 8, 0, /* 6517: pointer.func */
            ...
            1, 8, 1, /* 6535: pointer.struct.env_md_st */
            	6130, 0,
            8884097, 8, 0, /* 6540: pointer.func */
            8884097, 8, 0, /* 6543: pointer.func */
            8884097, 8, 0, /* 6546: pointer.func */
            8884097, 8, 0, /* 6549: pointer.func */
            1, 8, 1, /* 6552: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	6557, 0,
            0, 32, 2, /* 6557: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	6564, 8,
            	180, 24,
            8884099, 8, 2, /* 6564: pointer_to_array_of_pointers_to_stack */
            	6571, 0,
            	1052, 20,
            0, 8, 1, /* 6571: pointer.SRTP_PROTECTION_PROFILE */
            	6158, 0,
            0, 1, 0, /* 6576: char */
            8884097, 8, 0, /* 6579: pointer.func */
        },
        .arg_entity_index = { 6260, 6579, },
        .ret_entity_index = -1,
    };
