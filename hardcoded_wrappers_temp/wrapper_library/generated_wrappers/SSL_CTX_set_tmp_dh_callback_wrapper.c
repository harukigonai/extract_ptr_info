...
void bb_SSL_CTX_set_tmp_dh_callback(SSL_CTX * arg_a,DH *(*arg_b)(SSL *, int, int)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 144, 15, /* 1099: struct.x509_store_st */
            	1075, 8,
            	1132, 16,
            	1137, 24,
            	1149, 32,
            	...
            	1149, 112,
            	560, 120,
            1, 8, 1, /* 1132: pointer.struct.stack_st_X509_LOOKUP */
            	1091, 0,
            ...
            1, 8, 1, /* 1192: pointer.struct.lhash_node_st */
            	1197, 0,
            0, 24, 2, /* 1197: struct.lhash_node_st */
            	1016, 0,
            	1204, 8,
            1, 8, 1, /* 1204: pointer.struct.lhash_node_st */
            	1197, 0,
            ...
            0, 176, 3, /* 1281: struct.lhash_st */
            	1290, 0,
            	22, 8,
            	1295, 16,
            1, 8, 1, /* 1290: pointer.pointer.struct.lhash_node_st */
            	1192, 0,
            ...
            1, 8, 1, /* 1313: pointer.struct.ssl_method_st */
            	1318, 0,
            0, 232, 28, /* 1318: struct.ssl_method_st */
            	1377, 8,
            	1275, 16,
            	1275, 24,
            	1377, 32,
            ...
            0, 736, 50, /* 1440: struct.ssl_ctx_st */
            	1313, 0,
            	1267, 8,
            	1267, 16,
            	1543, 24,
            	...
            	1016, 720,
            	1184, 728,
            1, 8, 1, /* 1543: pointer.struct.x509_store_st */
            	1099, 0,
            1, 8, 1, /* 1548: pointer.struct.lhash_st */
            	1281, 0,
