...
void bb_SSL_CTX_set_tmp_dh_callback(SSL_CTX * arg_a,DH *(*arg_b)(SSL *, int, int)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 736, 50, /* 4735: struct.ssl_ctx_st */
            	4301, 0,
            	4510, 8,
            	4510, 16,
            	4505, 24,
            ...
            1, 8, 1, /* 4969: pointer.struct.stack_st_X509_NAME */
            	4974, 0,
            0, 32, 2, /* 4974: struct.stack_st_fake_X509_NAME */
            	4981, 8,
            	456, 24,
            8884099, 8, 2, /* 4981: pointer_to_array_of_pointers_to_stack */
            	4988, 0,
            	453, 20,
            0, 8, 1, /* 4988: pointer.X509_NAME */
            	4993, 0,
            0, 0, 1, /* 4993: X509_NAME */
            	2210, 0,
            8884097, 8, 0, /* 4998: pointer.func */
            1, 8, 1, /* 5001: pointer.struct.ssl3_buf_freelist_st */
            	5006, 0,
            0, 24, 1, /* 5006: struct.ssl3_buf_freelist_st */
            	84, 16,
            1, 8, 1, /* 5011: pointer.struct.ssl_ctx_st */
            	4735, 0,
            0, 1, 0, /* 5016: char */
        },
        .arg_entity_index = { 5011, 103, },
        .ret_entity_index = -1,
    };
