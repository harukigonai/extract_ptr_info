...
int bb_EVP_DigestUpdate(EVP_MD_CTX * arg_a, const void * arg_b,size_t arg_c) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 62: pointer.struct.env_md_ctx_st */
            	67, 0,
            0, 48, 5, /* 67: struct.env_md_ctx_st */
            	80, 0,
            	11, 8,
            	85, 24,
            	3, 32,
            	50, 40,
            1, 8, 1, /* 80: pointer.struct.env_md_st */
            	28, 0,
            0, 8, 0, /* 85: pointer.void */
        },
        .arg_entity_index = { 62, 85, 25, },
        .ret_entity_index = 19,
    };
