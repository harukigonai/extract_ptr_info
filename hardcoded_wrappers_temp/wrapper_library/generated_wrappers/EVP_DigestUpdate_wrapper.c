...
int bb_EVP_DigestUpdate(EVP_MD_CTX * arg_a, const void * arg_b,size_t arg_c) 
{
    ...
    em[1953] = 0; em[1954] = 1; em[1955] = 0; /* 1953: char */
    em[1956] = 8884097; em[1957] = 8; em[1958] = 0; /* 1956: pointer.func */
    em[1959] = 0; em[1960] = 0; em[1961] = 0; /* 1959: size_t */
    em[1962] = 0; em[1963] = 120; em[1964] = 8; /* 1962: struct.env_md_st */
    	em[1965] = 1956; em[1966] = 24; 
    	em[1967] = 1981; em[1968] = 32; 
    	em[1969] = 1984; em[1970] = 40; 
    	em[1971] = 1987; em[1972] = 48; 
    	em[1973] = 1956; em[1974] = 56; 
    	em[1975] = 1990; em[1976] = 64; 
    	em[1977] = 1950; em[1978] = 72; 
    	em[1979] = 1993; em[1980] = 112; 
    ...
    em[1996] = 0; em[1997] = 48; em[1998] = 5; /* 1996: struct.env_md_ctx_st */
    	em[1999] = 2009; em[2000] = 0; 
    	em[2001] = 1070; em[2002] = 8; 
    	em[2003] = 932; em[2004] = 24; 
    	em[2005] = 952; em[2006] = 32; 
    	em[2007] = 1981; em[2008] = 40; 
    em[2009] = 1; em[2010] = 8; em[2011] = 1; /* 2009: pointer.struct.env_md_st */
    	em[2012] = 1962; em[2013] = 0; 
    em[2014] = 1; em[2015] = 8; em[2016] = 1; /* 2014: pointer.struct.env_md_ctx_st */
    	em[2017] = 1996; em[2018] = 0; 
    args_addr->arg_entity_index[0] = 2014;
    args_addr->arg_entity_index[1] = 932;
    args_addr->arg_entity_index[2] = 1959;
