    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 16, 1, /* 848: struct.crypto_ex_data_st */
            	13, 0,
            0, 8, 0, /* 853: long */
            1, 8, 1, /* 856: pointer.struct.x509_st.3164 */
            	861, 0,
            0, 184, 12, /* 861: struct.x509_st.3164 */
            	888, 0,
            	322, 8,
            	51, 16,
            	35, 32,
            	...
            	73, 144,
            	61, 176,
            1, 8, 1, /* 888: pointer.struct.x509_cinf_st.3159 */
            	893, 0,
            0, 104, 11, /* 893: struct.x509_cinf_st.3159 */
            	51, 0,
            	51, 8,
            	322, 16,
            	918, 24,
            	...
            	13, 72,
            	959, 80,
            1, 8, 1, /* 918: pointer.struct.X509_name_st */
            	923, 0,
            0, 40, 3, /* 923: struct.X509_name_st */
            	13, 0,
            	932, 16,
            	35, 24,
            1, 8, 1, /* 932: pointer.struct.buf_mem_st */
            	937, 0,
            0, 24, 1, /* 937: struct.buf_mem_st */
            	35, 8,
            1, 8, 1, /* 942: pointer.struct.X509_val_st */
            	947, 0,
            0, 16, 2, /* 947: struct.X509_val_st */
            	51, 0,
            	51, 8,
            1, 8, 1, /* 954: pointer.struct.X509_pubkey_st.2915 */
            	313, 0,
            0, 24, 1, /* 959: struct.ASN1_ENCODING_st */
            	35, 0,
            0, 20, 0, /* 964: array[20].char */
            0, 4, 0, /* 967: int */
        },
        .arg_entity_index = { 856, 349, },
        .ret_entity_index = 967,
    };
