    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 24, 1, /* 1927: struct.buf_mem_st */
            	106, 8,
            0, 16, 2, /* 1932: struct.X509_val_st */
            	1939, 0,
            	1939, 8,
            1, 8, 1, /* 1939: pointer.struct.asn1_string_st */
            	281, 0,
            0, 104, 11, /* 1944: struct.x509_cinf_st */
            	891, 0,
            	891, 8,
            	1667, 16,
            	1969, 24,
            	...
            	2027, 72,
            	2073, 80,
            1, 8, 1, /* 1969: pointer.struct.X509_name_st */
            	1974, 0,
            0, 40, 3, /* 1974: struct.X509_name_st */
            	1983, 0,
            	2007, 16,
            	10, 24,
            1, 8, 1, /* 1983: pointer.struct.stack_st_X509_NAME_ENTRY */
            	1988, 0,
            0, 32, 2, /* 1988: struct.stack_st_fake_X509_NAME_ENTRY */
            	1995, 8,
            	217, 24,
            8884099, 8, 2, /* 1995: pointer_to_array_of_pointers_to_stack */
            	2002, 0,
            	214, 20,
            0, 8, 1, /* 2002: pointer.X509_NAME_ENTRY */
            	1188, 0,
