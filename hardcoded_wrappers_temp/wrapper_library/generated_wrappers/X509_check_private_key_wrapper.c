...
int bb_X509_check_private_key(X509 * arg_a,EVP_PKEY * arg_b) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 0, /* 640: func */
            0, 8, 0, /* 643: long */
            1, 8, 1, /* 646: pointer.struct.x509_st */
            	651, 0,
            0, 184, 12, /* 651: struct.x509_st */
            	...
            	97, 144,
            	744, 176,
            1, 8, 1, /* 678: pointer.struct.x509_cinf_st */
            	683, 0,
            ...
            0, 40, 3, /* 713: struct.X509_name_st */
            	...
            	722, 16,
            	26, 24,
            1, 8, 1, /* 722: pointer.struct.buf_mem_st */
            	727, 0,
            0, 24, 1, /* 727: struct.buf_mem_st */
            	26, 8,
            1, 8, 1, /* 732: pointer.struct.X509_val_st */
            	737, 0,
            0, 16, 2, /* 737: struct.X509_val_st */
            	65, 0,
            	65, 8,
            1, 8, 1, /* 744: pointer.struct.x509_cert_aux_st */
            	749, 0,
