...
int bb_EVP_DigestInit_ex(EVP_MD_CTX * arg_a,const EVP_MD * arg_b,ENGINE * arg_c) 
{
    ...
    em[1988] = 0; em[1989] = 120; em[1990] = 8; /* 1988: struct.env_md_st */
    	em[1991] = 1985; em[1992] = 24; 
    	em[1993] = 2007; em[1994] = 32; 
    	em[1995] = 2010; em[1996] = 40; 
    	em[1997] = 1982; em[1998] = 48; 
    	em[1999] = 1985; em[2000] = 56; 
    	em[2001] = 1979; em[2002] = 64; 
    	em[2003] = 2013; em[2004] = 72; 
    	em[2005] = 2016; em[2006] = 112; 
    ...
    em[2019] = 0; em[2020] = 48; em[2021] = 5; /* 2019: struct.env_md_ctx_st */
    	...
    	em[2024] = 1801; em[2025] = 8; 
    	em[2026] = 704; em[2027] = 24; 
    ...
    em[2037] = 1; em[2038] = 8; em[2039] = 1; /* 2037: pointer.struct.env_md_ctx_st */
    	em[2040] = 2019; em[2041] = 0; 
    args_addr->arg_entity_index[0] = 2037;
    args_addr->arg_entity_index[1] = 2032;
    args_addr->arg_entity_index[2] = 1801;
