...
int bb_EVP_DigestInit_ex(EVP_MD_CTX * arg_a,const EVP_MD * arg_b,ENGINE * arg_c) 
{
    ...
    em[1798] = 0; em[1799] = 48; em[1800] = 5; /* 1798: struct.env_md_ctx_st */
    	em[1801] = 1811; em[1802] = 0; 
    	em[1803] = 1455; em[1804] = 8; 
    	em[1805] = 76; em[1806] = 24; 
    	em[1807] = 1349; em[1808] = 32; 
    	em[1809] = 1323; em[1810] = 40; 
    em[1811] = 1; em[1812] = 8; em[1813] = 1; /* 1811: pointer.struct.env_md_st */
    	em[1814] = 1301; em[1815] = 0; 
    em[1816] = 0; em[1817] = 1; em[1818] = 0; /* 1816: char */
    em[1819] = 1; em[1820] = 8; em[1821] = 1; /* 1819: pointer.struct.env_md_ctx_st */
    	em[1822] = 1798; em[1823] = 0; 
    args_addr->arg_entity_index[0] = 1819;
    args_addr->arg_entity_index[1] = 1811;
    args_addr->arg_entity_index[2] = 1455;
