...
int bb_EVP_DigestInit_ex(EVP_MD_CTX * arg_a,const EVP_MD * arg_b,ENGINE * arg_c) 
{
    ...
    em[1682] = 0; em[1683] = 1; em[1684] = 0; /* 1682: char */
    em[1685] = 8884099; em[1686] = 8; em[1687] = 2; /* 1685: pointer_to_array_of_pointers_to_stack */
    	em[1688] = 1692; em[1689] = 0; 
    	em[1690] = 5; em[1691] = 20; 
    em[1692] = 0; em[1693] = 8; em[1694] = 1; /* 1692: pointer.ASN1_TYPE */
    	em[1695] = 241; em[1696] = 0; 
    ...
    em[1801] = 0; em[1802] = 208; em[1803] = 25; /* 1801: struct.evp_pkey_method_st */
    	...
    	em[1812] = 1793; em[1813] = 40; 
    	em[1814] = 1787; em[1815] = 48; 
    	em[1816] = 1793; em[1817] = 56; 
    ...
    em[1883] = 0; em[1884] = 32; em[1885] = 2; /* 1883: struct.stack_st_fake_ASN1_TYPE */
    	em[1886] = 1685; em[1887] = 8; 
    	em[1888] = 1308; em[1889] = 24; 
    em[1890] = 8884097; em[1891] = 8; em[1892] = 0; /* 1890: pointer.func */
    em[1893] = 1; em[1894] = 8; em[1895] = 1; /* 1893: pointer.struct.evp_pkey_asn1_method_st */
    	em[1896] = 1709; em[1897] = 0; 
    em[1898] = 8884097; em[1899] = 8; em[1900] = 0; /* 1898: pointer.func */
    em[1901] = 0; em[1902] = 120; em[1903] = 8; /* 1901: struct.env_md_st */
    	em[1904] = 1898; em[1905] = 24; 
    	em[1906] = 1920; em[1907] = 32; 
    	em[1908] = 1890; em[1909] = 40; 
    	em[1910] = 887; em[1911] = 48; 
    	em[1912] = 1898; em[1913] = 56; 
    	em[1914] = 1923; em[1915] = 64; 
    	em[1916] = 1790; em[1917] = 72; 
    	em[1918] = 1875; em[1919] = 112; 
    em[1920] = 8884097; em[1921] = 8; em[1922] = 0; /* 1920: pointer.func */
    em[1923] = 8884097; em[1924] = 8; em[1925] = 0; /* 1923: pointer.func */
    em[1926] = 1; em[1927] = 8; em[1928] = 1; /* 1926: pointer.struct.env_md_ctx_st */
    	em[1929] = 1931; em[1930] = 0; 
    em[1931] = 0; em[1932] = 48; em[1933] = 5; /* 1931: struct.env_md_ctx_st */
    	em[1934] = 1944; em[1935] = 0; 
    	em[1936] = 1665; em[1937] = 8; 
    	em[1938] = 821; em[1939] = 24; 
    	em[1940] = 1949; em[1941] = 32; 
    	em[1942] = 1920; em[1943] = 40; 
    em[1944] = 1; em[1945] = 8; em[1946] = 1; /* 1944: pointer.struct.env_md_st */
    	em[1947] = 1901; em[1948] = 0; 
    ...
    em[1954] = 0; em[1955] = 80; em[1956] = 8; /* 1954: struct.evp_pkey_ctx_st */
    	em[1957] = 1796; em[1958] = 0; 
    	em[1959] = 1665; em[1960] = 8; 
    	em[1961] = 1973; em[1962] = 16; 
    	em[1963] = 1973; em[1964] = 24; 
    	em[1965] = 821; em[1966] = 40; 
    	em[1967] = 821; em[1968] = 48; 
    	em[1969] = 8; em[1970] = 56; 
    	em[1971] = 0; em[1972] = 64; 
    em[1973] = 1; em[1974] = 8; em[1975] = 1; /* 1973: pointer.struct.evp_pkey_st */
    	em[1976] = 1978; em[1977] = 0; 
    em[1978] = 0; em[1979] = 56; em[1980] = 4; /* 1978: struct.evp_pkey_st */
    	em[1981] = 1893; em[1982] = 16; 
    	em[1983] = 1665; em[1984] = 24; 
    	em[1985] = 1401; em[1986] = 32; 
    	em[1987] = 1989; em[1988] = 48; 
    em[1989] = 1; em[1990] = 8; em[1991] = 1; /* 1989: pointer.struct.stack_st_X509_ATTRIBUTE */
    	em[1992] = 1994; em[1993] = 0; 
    em[1994] = 0; em[1995] = 32; em[1996] = 2; /* 1994: struct.stack_st_fake_X509_ATTRIBUTE */
    	em[1997] = 2001; em[1998] = 8; 
    	em[1999] = 1308; em[2000] = 24; 
    em[2001] = 8884099; em[2002] = 8; em[2003] = 2; /* 2001: pointer_to_array_of_pointers_to_stack */
    	em[2004] = 2008; em[2005] = 0; 
    	em[2006] = 5; em[2007] = 20; 
    em[2008] = 0; em[2009] = 8; em[2010] = 1; /* 2008: pointer.X509_ATTRIBUTE */
    	em[2011] = 2013; em[2012] = 0; 
    em[2013] = 0; em[2014] = 0; em[2015] = 1; /* 2013: X509_ATTRIBUTE */
    	em[2016] = 2018; em[2017] = 0; 
    em[2018] = 0; em[2019] = 24; em[2020] = 2; /* 2018: struct.x509_attributes_st */
    	em[2021] = 130; em[2022] = 0; 
    	em[2023] = 2025; em[2024] = 16; 
    em[2025] = 0; em[2026] = 8; em[2027] = 3; /* 2025: union.unknown */
    	em[2028] = 120; em[2029] = 0; 
    	em[2030] = 1878; em[2031] = 0; 
    	em[2032] = 2034; em[2033] = 0; 
    em[2034] = 1; em[2035] = 8; em[2036] = 1; /* 2034: pointer.struct.asn1_type_st */
    	em[2037] = 179; em[2038] = 0; 
    args_addr->arg_entity_index[0] = 1926;
    args_addr->arg_entity_index[1] = 1944;
    args_addr->arg_entity_index[2] = 1665;
