...
{
    if (syscall(890))
        return _SSL_get_ex_new_index(arg_a,arg_b,arg_c,arg_d,arg_e);
    else {
...
int _SSL_get_ex_new_index(long arg_a,void * arg_b,CRYPTO_EX_new * arg_c,CRYPTO_EX_dup * arg_d,CRYPTO_EX_free * arg_e) 
{
