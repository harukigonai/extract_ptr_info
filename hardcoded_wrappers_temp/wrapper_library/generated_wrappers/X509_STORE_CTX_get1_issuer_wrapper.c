    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 32, 3, /* 209: struct.X509_POLICY_DATA_st */
            	...
            	34, 16,
            	34, 24,
            1, 8, 1, /* 218: pointer.struct.X509_POLICY_LEVEL_st */
            	223, 0,
            0, 32, 3, /* 223: struct.X509_POLICY_LEVEL_st */
            	232, 0,
            	34, 8,
            	192, 16,
            1, 8, 1, /* 232: pointer.struct.x509_st */
            	237, 0,
            0, 184, 12, /* 237: struct.x509_st */
            	...
            	791, 144,
            	803, 176,
            1, 8, 1, /* 264: pointer.struct.x509_cinf_st */
            	269, 0,
            0, 104, 11, /* 269: struct.x509_cinf_st */
            	...
            	34, 72,
            	182, 80,
            1, 8, 1, /* 294: pointer.struct.X509_val_st */
            	299, 0,
            0, 16, 2, /* 299: struct.X509_val_st */
            	107, 0,
            	107, 8,
            1, 8, 1, /* 306: pointer.struct.X509_pubkey_st */
            	311, 0,
            0, 24, 3, /* 311: struct.X509_pubkey_st */
            	141, 0,
            	107, 8,
            	320, 16,
            1, 8, 1, /* 320: pointer.struct.evp_pkey_st */
            	325, 0,
            0, 56, 4, /* 325: struct.evp_pkey_st */
            	...
            	177, 32,
            	34, 48,
            1, 8, 1, /* 336: pointer.struct.evp_pkey_asn1_method_st */
            	341, 0,
            0, 208, 24, /* 341: struct.evp_pkey_asn1_method_st */
            	...
            	433, 192,
            	436, 200,
            1, 8, 1, /* 392: pointer.struct.unnamed */
            	397, 0,
            ...
            1, 8, 1, /* 439: pointer.struct.engine_st */
            	444, 0,
            0, 216, 24, /* 444: struct.engine_st */
            	...
            	439, 200,
            	439, 208,
            1, 8, 1, /* 495: pointer.struct.rsa_meth_st */
            	500, 0,
            ...
            1, 8, 1, /* 550: pointer.struct.dsa_method */
            	555, 0,
            ...
            1, 8, 1, /* 601: pointer.struct.dh_method */
            	606, 0,
            ...
            1, 8, 1, /* 637: pointer.struct.ecdh_method */
            	642, 0,
            ...
            1, 8, 1, /* 654: pointer.struct.ecdsa_method */
            	659, 0,
            ...
            1, 8, 1, /* 681: pointer.struct.rand_meth_st */
            	686, 0,
            ...
            1, 8, 1, /* 716: pointer.struct.store_method_st */
            	721, 0,
            ...
            1, 8, 1, /* 748: pointer.struct.ENGINE_CMD_DEFN_st */
            	753, 0,
            ...
            0, 40, 2, /* 784: struct.X509_POLICY_CACHE_st */
            	204, 0,
            	34, 8,
            1, 8, 1, /* 791: pointer.struct.NAME_CONSTRAINTS_st */
            	796, 0,
            0, 16, 2, /* 796: struct.NAME_CONSTRAINTS_st */
            	34, 0,
            	34, 8,
            1, 8, 1, /* 803: pointer.struct.x509_cert_aux_st */
            	808, 0,
            0, 40, 5, /* 808: struct.x509_cert_aux_st */
            	...
            	107, 24,
            	34, 32,
            1, 8, 1, /* 821: pointer.struct.X509_POLICY_TREE_st */
            	826, 0,
            ...
            0, 56, 2, /* 852: struct.X509_VERIFY_PARAM_st */
            	...
            	34, 48,
            0, 0, 0, /* 859: func */
            1, 8, 1, /* 862: pointer.struct.X509_VERIFY_PARAM_st */
            	852, 0,
            ...
            0, 0, 0, /* 969: func */
            0, 8, 0, /* 972: long */
            1, 8, 1, /* 975: pointer.struct.X509_crl_st */
            	980, 0,
            0, 120, 10, /* 980: struct.X509_crl_st */
            	117, 0,
            	141, 8,
            	107, 16,
            	765, 32,
            	...
            	1003, 104,
            	1008, 112,
            1, 8, 1, /* 1003: pointer.struct.x509_crl_method_st */
            	15, 0,
