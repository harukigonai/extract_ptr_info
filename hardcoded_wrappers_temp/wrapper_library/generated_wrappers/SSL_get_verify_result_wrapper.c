...
long bb_SSL_get_verify_result(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5024: pointer.struct.ssl_st */
            	5029, 0,
            0, 808, 51, /* 5029: struct.ssl_st */
            	5134, 8,
            	4317, 16,
            	4317, 24,
            	4317, 32,
            	...
            	5724, 656,
            	242, 680,
            1, 8, 1, /* 5134: pointer.struct.ssl_method_st */
            	5139, 0,
            0, 232, 28, /* 5139: struct.ssl_method_st */
            	5198, 8,
            	5201, 16,
            	5201, 24,
            	5198, 32,
            ...
            8884097, 8, 0, /* 5228: pointer.func */
            8884097, 8, 0, /* 5231: pointer.func */
            8884097, 8, 0, /* 5234: pointer.func */
            8884097, 8, 0, /* 5237: pointer.func */
            1, 8, 1, /* 5240: pointer.struct.ssl3_enc_method */
            	5245, 0,
            0, 112, 11, /* 5245: struct.ssl3_enc_method */
            	5270, 0,
            	5273, 8,
            	5198, 16,
            	5015, 24,
            ...
            8884097, 8, 0, /* 5279: pointer.func */
            8884097, 8, 0, /* 5282: pointer.func */
            8884097, 8, 0, /* 5285: pointer.func */
            1, 8, 1, /* 5288: pointer.struct.ssl2_state_st */
            	5293, 0,
            0, 344, 9, /* 5293: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5314: pointer.struct.ssl3_state_st */
            	5319, 0,
            0, 1200, 10, /* 5319: struct.ssl3_state_st */
            	5342, 240,
            	5342, 264,
            	5347, 288,
            	5347, 344,
            	...
            	273, 512,
            	5361, 528,
            0, 24, 1, /* 5342: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5347: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5356: pointer.pointer.struct.env_md_ctx_st */
            	4970, 0,
            0, 528, 8, /* 5361: struct.unknown */
            	4848, 408,
            	4802, 416,
            	4807, 424,
            	5380, 464,
            	...
            	4760, 496,
            	5409, 512,
            1, 8, 1, /* 5380: pointer.struct.stack_st_X509_NAME */
            	5385, 0,
            0, 32, 2, /* 5385: struct.stack_st_fake_X509_NAME */
            	5392, 8,
            	86, 24,
            8884099, 8, 2, /* 5392: pointer_to_array_of_pointers_to_stack */
            	5399, 0,
            	83, 20,
            0, 8, 1, /* 5399: pointer.X509_NAME */
            	5404, 0,
            0, 0, 1, /* 5404: X509_NAME */
            	4446, 0,
            1, 8, 1, /* 5409: pointer.struct.ssl_comp_st */
            	3960, 0,
            1, 8, 1, /* 5414: pointer.struct.dtls1_state_st */
            	5419, 0,
            0, 888, 7, /* 5419: struct.dtls1_state_st */
            	5007, 576,
            	5007, 592,
            	4999, 608,
            	4999, 616,
            	...
            	5436, 648,
            	5436, 736,
            0, 88, 1, /* 5436: struct.hm_header_st */
            	4954, 48,
            8884097, 8, 0, /* 5441: pointer.func */
            1, 8, 1, /* 5444: pointer.struct.X509_VERIFY_PARAM_st */
            	5449, 0,
            0, 56, 2, /* 5449: struct.X509_VERIFY_PARAM_st */
            	99, 0,
            	3663, 48,
            1, 8, 1, /* 5456: pointer.struct.cert_st */
            	5461, 0,
            0, 296, 7, /* 5461: struct.cert_st */
            	4741, 0,
            	2524, 48,
            	5478, 56,
            	4802, 64,
            ...
            1, 8, 1, /* 5499: pointer.struct.ssl_ctx_st */
            	5504, 0,
            0, 736, 50, /* 5504: struct.ssl_ctx_st */
            	5134, 0,
            	4858, 8,
            	4858, 16,
            	5607, 24,
            	...
            	273, 720,
            	5694, 728,
            1, 8, 1, /* 5607: pointer.struct.x509_store_st */
            	5612, 0,
            0, 144, 15, /* 5612: struct.x509_store_st */
            	5645, 8,
            	2484, 16,
            	5444, 24,
            	437, 32,
            	...
            	437, 112,
            	2629, 120,
            1, 8, 1, /* 5645: pointer.struct.stack_st_X509_OBJECT */
            	5650, 0,
            0, 32, 2, /* 5650: struct.stack_st_fake_X509_OBJECT */
            	5657, 8,
            	86, 24,
            8884099, 8, 2, /* 5657: pointer_to_array_of_pointers_to_stack */
            	5664, 0,
            	83, 20,
            0, 8, 1, /* 5664: pointer.X509_OBJECT */
            	613, 0,
            8884097, 8, 0, /* 5669: pointer.func */
            8884097, 8, 0, /* 5672: pointer.func */
            8884097, 8, 0, /* 5675: pointer.func */
            8884097, 8, 0, /* 5678: pointer.func */
            1, 8, 1, /* 5681: pointer.struct.ssl3_buf_freelist_st */
            	5686, 0,
            0, 24, 1, /* 5686: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5691: pointer.func */
            1, 8, 1, /* 5694: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5699, 0,
            0, 32, 2, /* 5699: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5706, 8,
            	86, 24,
            8884099, 8, 2, /* 5706: pointer_to_array_of_pointers_to_stack */
            	5713, 0,
            	83, 20,
            0, 8, 1, /* 5713: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            8884097, 8, 0, /* 5718: pointer.func */
            8884097, 8, 0, /* 5721: pointer.func */
            1, 8, 1, /* 5724: pointer.struct.srtp_protection_profile_st */
            	0, 0,
            0, 1, 0, /* 5729: char */
        },
        .arg_entity_index = { 5024, },
        .ret_entity_index = 5018,
    };
