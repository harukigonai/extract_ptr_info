...
long bb_SSL_get_verify_result(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 4837: pointer.struct.ssl_st */
            	4842, 0,
            0, 808, 51, /* 4842: struct.ssl_st */
            	4947, 8,
            	5098, 16,
            	5098, 24,
            	5098, 32,
            	...
            	5632, 656,
            	242, 680,
            1, 8, 1, /* 4947: pointer.struct.ssl_method_st */
            	4952, 0,
            0, 232, 28, /* 4952: struct.ssl_method_st */
            	5011, 8,
            	2742, 16,
            	2742, 24,
            	5011, 32,
            	...
            	4695, 216,
            	5095, 224,
            8884097, 8, 0, /* 5011: pointer.func */
            8884097, 8, 0, /* 5014: pointer.func */
            8884097, 8, 0, /* 5017: pointer.func */
            8884097, 8, 0, /* 5020: pointer.func */
            8884097, 8, 0, /* 5023: pointer.func */
            8884097, 8, 0, /* 5026: pointer.func */
            8884097, 8, 0, /* 5029: pointer.func */
            8884097, 8, 0, /* 5032: pointer.func */
            8884097, 8, 0, /* 5035: pointer.func */
            8884097, 8, 0, /* 5038: pointer.func */
            8884097, 8, 0, /* 5041: pointer.func */
            8884097, 8, 0, /* 5044: pointer.func */
            8884097, 8, 0, /* 5047: pointer.func */
            1, 8, 1, /* 5050: pointer.struct.ssl3_enc_method */
            	5055, 0,
            0, 112, 11, /* 5055: struct.ssl3_enc_method */
            	5080, 0,
            	5083, 8,
            	5011, 16,
            	4828, 24,
            ...
            1, 8, 1, /* 5098: pointer.struct.bio_st */
            	5103, 0,
            0, 112, 7, /* 5103: struct.bio_st */
            	5120, 0,
            	5164, 8,
            	178, 16,
            	273, 48,
            	...
            	5167, 64,
            	2676, 96,
            1, 8, 1, /* 5120: pointer.struct.bio_method_st */
            	5125, 0,
            0, 80, 9, /* 5125: struct.bio_method_st */
            	5, 8,
            	5146, 16,
            	5149, 24,
            	5152, 32,
            ...
            1, 8, 1, /* 5167: pointer.struct.bio_st */
            	5103, 0,
            1, 8, 1, /* 5172: pointer.struct.ssl2_state_st */
            	5177, 0,
            0, 344, 9, /* 5177: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5198: pointer.struct.ssl3_state_st */
            	5203, 0,
            0, 1200, 10, /* 5203: struct.ssl3_state_st */
            	5226, 240,
            	5226, 264,
            	5231, 288,
            	5231, 344,
            	...
            	273, 512,
            	5245, 528,
            0, 24, 1, /* 5226: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5231: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5240: pointer.pointer.struct.env_md_ctx_st */
            	4786, 0,
            0, 528, 8, /* 5245: struct.unknown */
            	4556, 408,
            	2630, 416,
            	4551, 424,
            	5264, 464,
            	...
            	4501, 496,
            	5293, 512,
            1, 8, 1, /* 5264: pointer.struct.stack_st_X509_NAME */
            	5269, 0,
            0, 32, 2, /* 5269: struct.stack_st_fake_X509_NAME */
            	5276, 8,
            	86, 24,
            8884099, 8, 2, /* 5276: pointer_to_array_of_pointers_to_stack */
            	5283, 0,
            	83, 20,
            0, 8, 1, /* 5283: pointer.X509_NAME */
            	5288, 0,
            0, 0, 1, /* 5288: X509_NAME */
            	4608, 0,
            1, 8, 1, /* 5293: pointer.struct.ssl_comp_st */
            	4685, 0,
            1, 8, 1, /* 5298: pointer.struct.dtls1_state_st */
            	5303, 0,
            0, 888, 7, /* 5303: struct.dtls1_state_st */
            	4815, 576,
            	4815, 592,
            	4820, 608,
            	4820, 616,
            	...
            	5320, 648,
            	5320, 736,
            0, 88, 1, /* 5320: struct.hm_header_st */
            	4725, 48,
            8884097, 8, 0, /* 5325: pointer.func */
            1, 8, 1, /* 5328: pointer.struct.X509_VERIFY_PARAM_st */
            	5333, 0,
            0, 56, 2, /* 5333: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	4453, 48,
            1, 8, 1, /* 5340: pointer.struct.cert_st */
            	5345, 0,
            0, 296, 7, /* 5345: struct.cert_st */
            	3675, 0,
            	4546, 48,
            	5362, 56,
            	2630, 64,
            ...
            1, 8, 1, /* 5383: pointer.struct.ssl_ctx_st */
            	5388, 0,
            0, 736, 50, /* 5388: struct.ssl_ctx_st */
            	4947, 0,
            	4566, 8,
            	4566, 16,
            	5491, 24,
            	...
            	273, 720,
            	5599, 728,
            1, 8, 1, /* 5491: pointer.struct.x509_store_st */
            	5496, 0,
            0, 144, 15, /* 5496: struct.x509_store_st */
            	5529, 8,
            	5553, 16,
            	5328, 24,
            	434, 32,
            	...
            	434, 112,
            	2676, 120,
            1, 8, 1, /* 5529: pointer.struct.stack_st_X509_OBJECT */
            	5534, 0,
            0, 32, 2, /* 5534: struct.stack_st_fake_X509_OBJECT */
            	5541, 8,
            	86, 24,
            8884099, 8, 2, /* 5541: pointer_to_array_of_pointers_to_stack */
            	5548, 0,
            	83, 20,
            0, 8, 1, /* 5548: pointer.X509_OBJECT */
            	610, 0,
            1, 8, 1, /* 5553: pointer.struct.stack_st_X509_LOOKUP */
            	5558, 0,
            0, 32, 2, /* 5558: struct.stack_st_fake_X509_LOOKUP */
            	5565, 8,
            	86, 24,
            8884099, 8, 2, /* 5565: pointer_to_array_of_pointers_to_stack */
            	5572, 0,
            	83, 20,
            0, 8, 1, /* 5572: pointer.X509_LOOKUP */
            	485, 0,
            8884097, 8, 0, /* 5577: pointer.func */
            8884097, 8, 0, /* 5580: pointer.func */
            8884097, 8, 0, /* 5583: pointer.func */
            1, 8, 1, /* 5586: pointer.struct.ssl3_buf_freelist_st */
            	5591, 0,
            0, 24, 1, /* 5591: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5596: pointer.func */
            1, 8, 1, /* 5599: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5604, 0,
            0, 32, 2, /* 5604: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5611, 8,
            	86, 24,
            8884099, 8, 2, /* 5611: pointer_to_array_of_pointers_to_stack */
            	5618, 0,
            	83, 20,
            0, 8, 1, /* 5618: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            8884097, 8, 0, /* 5623: pointer.func */
            8884097, 8, 0, /* 5626: pointer.func */
            8884097, 8, 0, /* 5629: pointer.func */
            1, 8, 1, /* 5632: pointer.struct.srtp_protection_profile_st */
            	0, 0,
            0, 1, 0, /* 5637: char */
        },
        .arg_entity_index = { 4837, },
        .ret_entity_index = 4831,
    };
