    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6875: pointer.struct.bio_st */
            	6850, 0,
            1, 8, 1, /* 6880: pointer.struct.ssl_st */
            	6885, 0,
            0, 808, 51, /* 6885: struct.ssl_st */
            	5008, 8,
            	6875, 16,
            	6875, 24,
            	6875, 32,
            	...
            	7359, 656,
            	6564, 680,
            1, 8, 1, /* 6990: pointer.struct.ssl2_state_st */
            	6995, 0,
            0, 344, 9, /* 6995: struct.ssl2_state_st */
            	107, 24,
            	13, 56,
            	13, 64,
            	13, 72,
            	...
            	13, 128,
            	13, 136,
            1, 8, 1, /* 7016: pointer.struct.ssl3_state_st */
            	7021, 0,
            0, 1200, 10, /* 7021: struct.ssl3_state_st */
            	6637, 240,
            	6637, 264,
            	6682, 288,
            	6682, 344,
            	...
            	5, 512,
            	7141, 528,
            1, 8, 1, /* 7044: pointer.pointer.struct.env_md_ctx_st */
            	7049, 0,
            1, 8, 1, /* 7049: pointer.struct.env_md_ctx_st */
            	7054, 0,
            0, 48, 5, /* 7054: struct.env_md_ctx_st */
            	6037, 0,
            	5663, 8,
            	5, 24,
            	7067, 32,
            	6064, 40,
            1, 8, 1, /* 7067: pointer.struct.evp_pkey_ctx_st */
            	7072, 0,
            0, 80, 8, /* 7072: struct.evp_pkey_ctx_st */
            	6842, 0,
            	6632, 8,
            	7091, 16,
            	7091, 24,
            	...
            	6839, 56,
            	7136, 64,
            1, 8, 1, /* 7091: pointer.struct.evp_pkey_st */
            	7096, 0,
            0, 56, 4, /* 7096: struct.evp_pkey_st */
            	7107, 16,
            	6632, 24,
            	6645, 32,
            	7112, 48,
            1, 8, 1, /* 7107: pointer.struct.evp_pkey_asn1_method_st */
            	823, 0,
            1, 8, 1, /* 7112: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7117, 0,
            0, 32, 2, /* 7117: struct.stack_st_fake_X509_ATTRIBUTE */
            	7124, 8,
            	125, 24,
            8884099, 8, 2, /* 7124: pointer_to_array_of_pointers_to_stack */
            	7131, 0,
            	122, 20,
            0, 8, 1, /* 7131: pointer.X509_ATTRIBUTE */
            	2240, 0,
            1, 8, 1, /* 7136: pointer.int */
            	122, 0,
            0, 528, 8, /* 7141: struct.unknown */
            	6018, 408,
            	7160, 416,
            	5780, 424,
            	6079, 464,
            	...
            	6037, 496,
            	7202, 512,
            1, 8, 1, /* 7160: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 7165: pointer.struct.evp_cipher_st */
            	7170, 0,
            0, 88, 7, /* 7170: struct.evp_cipher_st */
            	7187, 24,
            	7190, 32,
            	7193, 40,
            	7196, 56,
            ...
            8884097, 8, 0, /* 7199: pointer.func */
            1, 8, 1, /* 7202: pointer.struct.ssl_comp_st */
            	7207, 0,
            0, 24, 2, /* 7207: struct.ssl_comp_st */
            	102, 8,
            	7214, 16,
            1, 8, 1, /* 7214: pointer.struct.comp_method_st */
            	7219, 0,
            0, 64, 7, /* 7219: struct.comp_method_st */
            	102, 8,
            	7236, 16,
            	7239, 24,
            	6642, 32,
            ...
            1, 8, 1, /* 7242: pointer.struct.dtls1_state_st */
            	7247, 0,
            0, 888, 7, /* 7247: struct.dtls1_state_st */
            	7264, 576,
            	7264, 592,
            	7269, 608,
            	7269, 616,
            	...
            	7296, 648,
            	7296, 736,
            0, 16, 1, /* 7264: struct.record_pqueue_st */
            	7269, 8,
            1, 8, 1, /* 7269: pointer.struct._pqueue */
            	7274, 0,
            0, 16, 1, /* 7274: struct._pqueue */
            	7279, 0,
            1, 8, 1, /* 7279: pointer.struct._pitem */
            	7284, 0,
            0, 24, 2, /* 7284: struct._pitem */
            	5, 8,
            	7291, 16,
            1, 8, 1, /* 7291: pointer.struct._pitem */
            	7284, 0,
            0, 88, 1, /* 7296: struct.hm_header_st */
            	7301, 48,
            0, 40, 4, /* 7301: struct.dtls1_retransmit_state */
            	7312, 0,
            	7049, 8,
            	7328, 16,
            	7340, 24,
            1, 8, 1, /* 7312: pointer.struct.evp_cipher_ctx_st */
            	7317, 0,
            0, 168, 4, /* 7317: struct.evp_cipher_ctx_st */
            	7165, 0,
            	5663, 8,
            	5, 96,
            	5, 120,
            1, 8, 1, /* 7328: pointer.struct.comp_ctx_st */
            	7333, 0,
            0, 56, 2, /* 7333: struct.comp_ctx_st */
            	7214, 0,
            	4883, 40,
            1, 8, 1, /* 7340: pointer.struct.ssl_session_st */
            	5213, 0,
            8884097, 8, 0, /* 7345: pointer.func */
            1, 8, 1, /* 7348: pointer.struct.tls_session_ticket_ext_st */
            	0, 0,
            8884097, 8, 0, /* 7353: pointer.func */
            8884097, 8, 0, /* 7356: pointer.func */
            1, 8, 1, /* 7359: pointer.struct.srtp_protection_profile_st */
            	4445, 0,
            0, 1, 0, /* 7364: char */
        },
        .arg_entity_index = { 6880, },
        .ret_entity_index = 6847,
    };
