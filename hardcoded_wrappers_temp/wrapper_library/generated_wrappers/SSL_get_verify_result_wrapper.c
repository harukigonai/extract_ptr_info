    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 808, 51, /* 1881: struct.ssl_st */
            	...
            	1801, 656,
            	1362, 680,
            1, 8, 1, /* 1986: pointer.struct.ssl_method_st */
            	1991, 0,
            0, 232, 28, /* 1991: struct.ssl_method_st */
            	1863, 8,
            	2050, 16,
            	2050, 24,
            	1863, 32,
            ...
            4097, 8, 0, /* 2065: pointer.func */
            4097, 8, 0, /* 2068: pointer.func */
            4097, 8, 0, /* 2071: pointer.func */
            1, 8, 1, /* 2074: pointer.struct.ssl3_enc_method */
            	1835, 0,
            4097, 8, 0, /* 2079: pointer.func */
            4097, 8, 0, /* 2082: pointer.func */
            1, 8, 1, /* 2085: pointer.struct.bio_st */
            	2090, 0,
            0, 112, 7, /* 2090: struct.bio_st */
            	2107, 0,
            	2112, 8,
            	154, 16,
            	154, 48,
            	...
            	2085, 64,
            	180, 96,
            1, 8, 1, /* 2107: pointer.struct.bio_method_st */
            	1765, 0,
            4097, 8, 0, /* 2112: pointer.func */
            1, 8, 1, /* 2115: pointer.struct.ssl2_state_st */
            	2120, 0,
            0, 344, 9, /* 2120: struct.ssl2_state_st */
            	154, 24,
            	154, 56,
            	154, 64,
            	154, 72,
            	...
            	154, 128,
            	154, 136,
            1, 8, 1, /* 2141: pointer.struct.ssl3_state_st */
            	2146, 0,
            0, 1200, 10, /* 2146: struct.ssl3_state_st */
            	2169, 240,
            	2169, 264,
            	2174, 288,
            	2174, 344,
            	...
            	8, 512,
            	2188, 528,
            0, 24, 1, /* 2169: struct.ssl3_buffer_st */
            	154, 0,
            0, 56, 3, /* 2174: struct.ssl3_record_st */
            	154, 16,
            	154, 24,
            	154, 32,
            1, 8, 1, /* 2183: pointer.pointer.struct.env_md_ctx_st */
            	1635, 0,
            0, 528, 8, /* 2188: struct.anon */
            	1755, 408,
            	1054, 416,
            	1089, 424,
            	132, 464,
            	...
            	905, 496,
            	1823, 512,
            4097, 8, 0, /* 2207: pointer.func */
            1, 8, 1, /* 2210: pointer.struct.ssl_ctx_st */
            	2215, 0,
            0, 736, 50, /* 2215: struct.ssl_ctx_st */
            	1986, 0,
            	132, 8,
            	132, 16,
            	94, 24,
            ...
            1, 8, 1, /* 2324: pointer.struct.ssl_st */
            	1881, 0,
            0, 1, 0, /* 2329: char */
            0, 8, 0, /* 2332: long */
        },
        .arg_entity_index = { 2324, },
        .ret_entity_index = 2332,
    };
