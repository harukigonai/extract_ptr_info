...
long _SSL_get_verify_result(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 2997: pointer.struct.ssl_st.776 */
            	3002, 0,
            0, 808, 51, /* 3002: struct.ssl_st.776 */
            	254, 8,
            	2864, 16,
            	2864, 24,
            	2864, 32,
            	...
            	3112, 656,
            	2331, 680,
            1, 8, 1, /* 3107: pointer.struct.tls_session_ticket_ext_st */
            	8, 0,
            1, 8, 1, /* 3112: pointer.struct.iovec */
            	1799, 0,
            0, 16, 0, /* 3117: array[16].char */
            0, 2, 0, /* 3120: array[2].char */
            0, 48, 0, /* 3123: array[48].char */
            0, 72, 0, /* 3126: struct.anon.25 */
            0, 8, 0, /* 3129: long */
            0, 2, 0, /* 3132: short */
        ...
        .arg_entity_index = { 2997, },
        .ret_entity_index = 3129,
    };
