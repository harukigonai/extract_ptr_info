...
long bb_SSL_get_verify_result(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 40, 3, /* 5055: struct.X509_name_st */
            	5064, 0,
            	5088, 16,
            	78, 24,
            1, 8, 1, /* 5064: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5069, 0,
            0, 32, 2, /* 5069: struct.stack_st_fake_X509_NAME_ENTRY */
            	5076, 8,
            	86, 24,
            8884099, 8, 2, /* 5076: pointer_to_array_of_pointers_to_stack */
            	5083, 0,
            	83, 20,
            0, 8, 1, /* 5083: pointer.X509_NAME_ENTRY */
            	132, 0,
            1, 8, 1, /* 5088: pointer.struct.buf_mem_st */
            	5093, 0,
            0, 24, 1, /* 5093: struct.buf_mem_st */
            	178, 8,
            8884097, 8, 0, /* 5098: pointer.func */
            0, 8, 0, /* 5101: long int */
            8884097, 8, 0, /* 5104: pointer.func */
            0, 0, 1, /* 5107: X509_NAME */
            	5055, 0,
            1, 8, 1, /* 5112: pointer.struct.ssl_st */
            	5117, 0,
            0, 808, 51, /* 5117: struct.ssl_st */
            	5222, 8,
            	5373, 16,
            	5373, 24,
            	5373, 32,
            	...
            	5901, 656,
            	242, 680,
            1, 8, 1, /* 5222: pointer.struct.ssl_method_st */
            	5227, 0,
            0, 232, 28, /* 5227: struct.ssl_method_st */
            	5286, 8,
            	2755, 16,
            	2755, 24,
            	5286, 32,
            ...
            8884097, 8, 0, /* 5301: pointer.func */
            8884097, 8, 0, /* 5304: pointer.func */
            ...
            1, 8, 1, /* 5325: pointer.struct.ssl3_enc_method */
            	5330, 0,
            0, 112, 11, /* 5330: struct.ssl3_enc_method */
            	5355, 0,
            	5358, 8,
            	5286, 16,
            	5098, 24,
            	...
            	5367, 96,
            	5104, 104,
            8884097, 8, 0, /* 5355: pointer.func */
            8884097, 8, 0, /* 5358: pointer.func */
            8884097, 8, 0, /* 5361: pointer.func */
            8884097, 8, 0, /* 5364: pointer.func */
            8884097, 8, 0, /* 5367: pointer.func */
            8884097, 8, 0, /* 5370: pointer.func */
            1, 8, 1, /* 5373: pointer.struct.bio_st */
            	5378, 0,
            0, 112, 7, /* 5378: struct.bio_st */
            	5395, 0,
            	5439, 8,
            	178, 16,
            	273, 48,
            	...
            	5442, 64,
            	2686, 96,
            1, 8, 1, /* 5395: pointer.struct.bio_method_st */
            	5400, 0,
            0, 80, 9, /* 5400: struct.bio_method_st */
            	5, 8,
            	5421, 16,
            	5424, 24,
            	5427, 32,
            ...
            1, 8, 1, /* 5442: pointer.struct.bio_st */
            	5378, 0,
            1, 8, 1, /* 5447: pointer.struct.ssl2_state_st */
            	5452, 0,
            0, 344, 9, /* 5452: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5473: pointer.struct.ssl3_state_st */
            	5478, 0,
            0, 1200, 10, /* 5478: struct.ssl3_state_st */
            	5501, 240,
            	5501, 264,
            	5506, 288,
            	5506, 344,
            	...
            	273, 512,
            	5520, 528,
            0, 24, 1, /* 5501: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5506: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5515: pointer.pointer.struct.env_md_ctx_st */
            	5013, 0,
            0, 528, 8, /* 5520: struct.unknown */
            	4829, 408,
            	2640, 416,
            	4824, 424,
            	5539, 464,
            	...
            	4774, 496,
            	5563, 512,
            1, 8, 1, /* 5539: pointer.struct.stack_st_X509_NAME */
            	5544, 0,
            0, 32, 2, /* 5544: struct.stack_st_fake_X509_NAME */
            	5551, 8,
            	86, 24,
            8884099, 8, 2, /* 5551: pointer_to_array_of_pointers_to_stack */
            	5558, 0,
            	83, 20,
            0, 8, 1, /* 5558: pointer.X509_NAME */
            	5107, 0,
            1, 8, 1, /* 5563: pointer.struct.ssl_comp_st */
            	4881, 0,
            1, 8, 1, /* 5568: pointer.struct.dtls1_state_st */
            	5573, 0,
            0, 888, 7, /* 5573: struct.dtls1_state_st */
            	5047, 576,
            	5047, 592,
            	5039, 608,
            	5039, 616,
            	...
            	5590, 648,
            	5590, 736,
            0, 88, 1, /* 5590: struct.hm_header_st */
            	4997, 48,
            8884097, 8, 0, /* 5595: pointer.func */
            1, 8, 1, /* 5598: pointer.struct.X509_VERIFY_PARAM_st */
            	5603, 0,
            0, 56, 2, /* 5603: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	3777, 48,
            1, 8, 1, /* 5610: pointer.struct.cert_st */
            	5615, 0,
            0, 296, 7, /* 5615: struct.cert_st */
            	4755, 0,
            	4819, 48,
            	2752, 56,
            	2640, 64,
            	...
            	4824, 80,
            	5635, 88,
            8884097, 8, 0, /* 5632: pointer.func */
            8884097, 8, 0, /* 5635: pointer.func */
            8884097, 8, 0, /* 5638: pointer.func */
            8884097, 8, 0, /* 5641: pointer.func */
            8884097, 8, 0, /* 5644: pointer.func */
            8884097, 8, 0, /* 5647: pointer.func */
            1, 8, 1, /* 5650: pointer.struct.ssl_ctx_st */
            	5655, 0,
            0, 736, 50, /* 5655: struct.ssl_ctx_st */
            	5222, 0,
            	4839, 8,
            	4839, 16,
            	5758, 24,
            	...
            	273, 720,
            	5871, 728,
            1, 8, 1, /* 5758: pointer.struct.x509_store_st */
            	5763, 0,
            0, 144, 15, /* 5763: struct.x509_store_st */
            	5796, 8,
            	5820, 16,
            	5598, 24,
            	435, 32,
            	...
            	435, 112,
            	2686, 120,
            1, 8, 1, /* 5796: pointer.struct.stack_st_X509_OBJECT */
            	5801, 0,
            0, 32, 2, /* 5801: struct.stack_st_fake_X509_OBJECT */
            	5808, 8,
            	86, 24,
            8884099, 8, 2, /* 5808: pointer_to_array_of_pointers_to_stack */
            	5815, 0,
            	83, 20,
            0, 8, 1, /* 5815: pointer.X509_OBJECT */
            	611, 0,
            1, 8, 1, /* 5820: pointer.struct.stack_st_X509_LOOKUP */
            	5825, 0,
            0, 32, 2, /* 5825: struct.stack_st_fake_X509_LOOKUP */
            	5832, 8,
            	86, 24,
            8884099, 8, 2, /* 5832: pointer_to_array_of_pointers_to_stack */
            	5839, 0,
            	83, 20,
            0, 8, 1, /* 5839: pointer.X509_LOOKUP */
            	486, 0,
            8884097, 8, 0, /* 5844: pointer.func */
            8884097, 8, 0, /* 5847: pointer.func */
            8884097, 8, 0, /* 5850: pointer.func */
        ...
        .arg_entity_index = { 5112, },
        .ret_entity_index = 5101,
    };
