...
long bb_SSL_get_verify_result(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 8, 0, /* 5082: long int */
            64097, 8, 0, /* 5085: pointer.func */
            1, 8, 1, /* 5088: pointer.struct.ssl_st */
            	5093, 0,
            0, 808, 51, /* 5093: struct.ssl_st */
            	5198, 8,
            	5352, 16,
            	5352, 24,
            	5352, 32,
            	...
            	5901, 656,
            	242, 680,
            1, 8, 1, /* 5198: pointer.struct.ssl_method_st */
            	5203, 0,
            0, 232, 28, /* 5203: struct.ssl_method_st */
            	5262, 8,
            	5265, 16,
            	5265, 24,
            	5262, 32,
            	...
            	4232, 216,
            	5349, 224,
            64097, 8, 0, /* 5262: pointer.func */
            64097, 8, 0, /* 5265: pointer.func */
            64097, 8, 0, /* 5268: pointer.func */
            64097, 8, 0, /* 5271: pointer.func */
            64097, 8, 0, /* 5274: pointer.func */
            64097, 8, 0, /* 5277: pointer.func */
            64097, 8, 0, /* 5280: pointer.func */
            64097, 8, 0, /* 5283: pointer.func */
            64097, 8, 0, /* 5286: pointer.func */
            64097, 8, 0, /* 5289: pointer.func */
            64097, 8, 0, /* 5292: pointer.func */
            64097, 8, 0, /* 5295: pointer.func */
            64097, 8, 0, /* 5298: pointer.func */
            64097, 8, 0, /* 5301: pointer.func */
            1, 8, 1, /* 5304: pointer.struct.ssl3_enc_method */
            	5309, 0,
            0, 112, 11, /* 5309: struct.ssl3_enc_method */
            	5334, 0,
            	5337, 8,
            	5262, 16,
            	5079, 24,
            	...
            	5346, 96,
            	5085, 104,
            64097, 8, 0, /* 5334: pointer.func */
            64097, 8, 0, /* 5337: pointer.func */
            64097, 8, 0, /* 5340: pointer.func */
            64097, 8, 0, /* 5343: pointer.func */
            64097, 8, 0, /* 5346: pointer.func */
            64097, 8, 0, /* 5349: pointer.func */
            1, 8, 1, /* 5352: pointer.struct.bio_st */
            	5357, 0,
            0, 112, 7, /* 5357: struct.bio_st */
            	5374, 0,
            	4089, 8,
            	99, 16,
            	273, 48,
            	...
            	5418, 64,
            	2706, 96,
            1, 8, 1, /* 5374: pointer.struct.bio_method_st */
            	5379, 0,
            0, 80, 9, /* 5379: struct.bio_method_st */
            	5, 8,
            	5400, 16,
            	5403, 24,
            	5406, 32,
            ...
            1, 8, 1, /* 5418: pointer.struct.bio_st */
            	5357, 0,
            1, 8, 1, /* 5423: pointer.struct.ssl2_state_st */
            	5428, 0,
            0, 344, 9, /* 5428: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5449: pointer.struct.ssl3_state_st */
            	5454, 0,
            0, 1200, 10, /* 5454: struct.ssl3_state_st */
            	5477, 240,
            	5477, 264,
            	5482, 288,
            	5482, 344,
            	...
            	273, 512,
            	5496, 528,
            0, 24, 1, /* 5477: struct.ssl3_buffer_st */
            	78, 0,
            0, 56, 3, /* 5482: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5491: pointer.pointer.struct.env_md_ctx_st */
            	5042, 0,
            0, 528, 8, /* 5496: struct.unknown */
            	4915, 408,
            	4866, 416,
            	4871, 424,
            	5515, 464,
            	...
            	4819, 496,
            	5582, 512,
            1, 8, 1, /* 5515: pointer.struct.stack_st_X509_NAME */
            	5520, 0,
            0, 32, 2, /* 5520: struct.stack_st_fake_X509_NAME */
            	5527, 8,
            	86, 24,
            64099, 8, 2, /* 5527: pointer_to_array_of_pointers_to_stack */
            	5534, 0,
            	83, 20,
            0, 8, 1, /* 5534: pointer.X509_NAME */
            	5539, 0,
            0, 0, 1, /* 5539: X509_NAME */
            	5544, 0,
            0, 40, 3, /* 5544: struct.X509_name_st */
            	5553, 0,
            	5577, 16,
            	78, 24,
            1, 8, 1, /* 5553: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5558, 0,
            0, 32, 2, /* 5558: struct.stack_st_fake_X509_NAME_ENTRY */
            	5565, 8,
            	86, 24,
            64099, 8, 2, /* 5565: pointer_to_array_of_pointers_to_stack */
            	5572, 0,
            	83, 20,
            0, 8, 1, /* 5572: pointer.X509_NAME_ENTRY */
            	128, 0,
            1, 8, 1, /* 5577: pointer.struct.buf_mem_st */
            	5021, 0,
            1, 8, 1, /* 5582: pointer.struct.ssl_comp_st */
            	4082, 0,
            1, 8, 1, /* 5587: pointer.struct.dtls1_state_st */
            	5592, 0,
            0, 888, 7, /* 5592: struct.dtls1_state_st */
            	5609, 576,
            	5609, 592,
            	5068, 608,
            	5068, 616,
            	...
            	5614, 648,
            	5614, 736,
            0, 16, 1, /* 5609: struct.record_pqueue_st */
            	5068, 8,
            0, 88, 1, /* 5614: struct.hm_header_st */
            	5026, 48,
            64097, 8, 0, /* 5619: pointer.func */
            1, 8, 1, /* 5622: pointer.struct.X509_VERIFY_PARAM_st */
            	5627, 0,
            0, 56, 2, /* 5627: struct.X509_VERIFY_PARAM_st */
            	99, 0,
            	3793, 48,
            1, 8, 1, /* 5634: pointer.struct.cert_st */
            	5639, 0,
            0, 296, 7, /* 5639: struct.cert_st */
            	4800, 0,
            	4861, 48,
            	5656, 56,
            	4866, 64,
            ...
            64097, 8, 0, /* 5674: pointer.func */
            1, 8, 1, /* 5677: pointer.struct.ssl_ctx_st */
            	5682, 0,
            0, 736, 50, /* 5682: struct.ssl_ctx_st */
            	5198, 0,
            	4925, 8,
            	4925, 16,
            	5785, 24,
            	...
            	273, 720,
            	5871, 728,
            1, 8, 1, /* 5785: pointer.struct.x509_store_st */
            	5790, 0,
            0, 144, 15, /* 5790: struct.x509_store_st */
            	5823, 8,
            	2627, 16,
            	5622, 24,
            	438, 32,
            	...
            	438, 112,
            	2706, 120,
            1, 8, 1, /* 5823: pointer.struct.stack_st_X509_OBJECT */
            	5828, 0,
            0, 32, 2, /* 5828: struct.stack_st_fake_X509_OBJECT */
            	5835, 8,
            	86, 24,
            64099, 8, 2, /* 5835: pointer_to_array_of_pointers_to_stack */
            	5842, 0,
            	83, 20,
            0, 8, 1, /* 5842: pointer.X509_OBJECT */
            	617, 0,
            64097, 8, 0, /* 5847: pointer.func */
            64097, 8, 0, /* 5850: pointer.func */
            1, 8, 1, /* 5853: pointer.struct.lhash_st */
            	417, 0,
            1, 8, 1, /* 5858: pointer.struct.ssl3_buf_freelist_st */
            	5863, 0,
            0, 24, 1, /* 5863: struct.ssl3_buf_freelist_st */
            	303, 16,
            64097, 8, 0, /* 5868: pointer.func */
            1, 8, 1, /* 5871: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5876, 0,
            0, 32, 2, /* 5876: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5883, 8,
            	86, 24,
            64099, 8, 2, /* 5883: pointer_to_array_of_pointers_to_stack */
            	5890, 0,
            	83, 20,
            0, 8, 1, /* 5890: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
        ...
        .arg_entity_index = { 5088, },
        .ret_entity_index = 5082,
    };
