...
void bb_EVP_PKEY_free(EVP_PKEY * arg_a) 
{
    ...
    em[1805] = 1; em[1806] = 8; em[1807] = 1; /* 1805: pointer.struct.evp_pkey_st */
    	em[1808] = 1810; em[1809] = 0; 
    em[1810] = 0; em[1811] = 56; em[1812] = 4; /* 1810: struct.evp_pkey_st */
    	em[1813] = 1589; em[1814] = 16; 
    	em[1815] = 206; em[1816] = 24; 
    	em[1817] = 1564; em[1818] = 32; 
    	em[1819] = 1821; em[1820] = 48; 
    em[1821] = 1; em[1822] = 8; em[1823] = 1; /* 1821: pointer.struct.stack_st_X509_ATTRIBUTE */
    	em[1824] = 1826; em[1825] = 0; 
    em[1826] = 0; em[1827] = 32; em[1828] = 2; /* 1826: struct.stack_st_fake_X509_ATTRIBUTE */
    	em[1829] = 1833; em[1830] = 8; 
    	em[1831] = 157; em[1832] = 24; 
    em[1833] = 8884099; em[1834] = 8; em[1835] = 2; /* 1833: pointer_to_array_of_pointers_to_stack */
    	em[1836] = 1840; em[1837] = 0; 
    	em[1838] = 91; em[1839] = 20; 
    em[1840] = 0; em[1841] = 8; em[1842] = 1; /* 1840: pointer.X509_ATTRIBUTE */
    	em[1843] = 1845; em[1844] = 0; 
    em[1845] = 0; em[1846] = 0; em[1847] = 1; /* 1845: X509_ATTRIBUTE */
    	em[1848] = 1690; em[1849] = 0; 
    args_addr->arg_entity_index[0] = 1805;
