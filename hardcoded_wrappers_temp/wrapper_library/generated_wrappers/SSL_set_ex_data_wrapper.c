...
int bb_SSL_set_ex_data(SSL * arg_a,int arg_b,void * arg_c) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 16, 0, /* 2994: array[16].char */
            0, 808, 51, /* 2997: struct.ssl_st.776 */
            	254, 8,
            	2864, 16,
            	2864, 24,
            	2864, 32,
            	...
            	3107, 656,
            	2331, 680,
            1, 8, 1, /* 3102: pointer.struct.tls_session_ticket_ext_st */
            	8, 0,
            1, 8, 1, /* 3107: pointer.struct.iovec */
            	1799, 0,
            0, 2, 0, /* 3112: array[2].char */
            0, 48, 0, /* 3115: array[48].char */
            1, 8, 1, /* 3118: pointer.struct.ssl_st.776 */
            	2997, 0,
            0, 72, 0, /* 3123: struct.anon.25 */
            0, 8, 0, /* 3126: long */
            0, 32, 0, /* 3129: array[32].char */
            0, 2, 0, /* 3132: short */
            0, 8, 0, /* 3135: array[8].char */
            0, 256, 0, /* 3138: array[256].char */
            0, 20, 0, /* 3141: array[20].char */
        },
        .arg_entity_index = { 3118, 1760, 13, },
        .ret_entity_index = 1760,
    };
