...
int bb_SSL_set_ex_data(SSL * arg_a,int arg_b,void * arg_c) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1890: pointer.struct.ssl_st */
            	1895, 0,
            0, 808, 51, /* 1895: struct.ssl_st */
            	2000, 8,
            	2093, 16,
            	2093, 24,
            	2093, 32,
            	...
            	1801, 656,
            	1362, 680,
            1, 8, 1, /* 2000: pointer.struct.ssl_method_st */
            	2005, 0,
            0, 232, 28, /* 2005: struct.ssl_method_st */
            	1863, 8,
            	2064, 16,
            	2064, 24,
            	1863, 32,
