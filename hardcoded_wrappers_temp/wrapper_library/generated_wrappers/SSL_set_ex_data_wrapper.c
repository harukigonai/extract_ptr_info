...
int bb_SSL_set_ex_data(SSL * arg_a,int arg_b,void * arg_c) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 888, 7, /* 5330: struct.dtls1_state_st */
            	5047, 576,
            	5047, 592,
            	5039, 608,
            	5039, 616,
            	...
            	5347, 648,
            	5347, 736,
            0, 88, 1, /* 5347: struct.hm_header_st */
            	4997, 48,
            0, 736, 50, /* 5352: struct.ssl_ctx_st */
            	5455, 0,
            	4839, 8,
            	4839, 16,
            	5549, 24,
            	...
            	273, 720,
            	5717, 728,
            1, 8, 1, /* 5455: pointer.struct.ssl_method_st */
            	5460, 0,
            0, 232, 28, /* 5460: struct.ssl_method_st */
            	5312, 8,
            	2755, 16,
            	2755, 24,
            	5312, 32,
            ...
            1, 8, 1, /* 5549: pointer.struct.x509_store_st */
            	5554, 0,
            0, 144, 15, /* 5554: struct.x509_store_st */
            	5587, 8,
            	5611, 16,
            	5635, 24,
            	435, 32,
            	...
            	435, 112,
            	2686, 120,
            1, 8, 1, /* 5587: pointer.struct.stack_st_X509_OBJECT */
            	5592, 0,
            0, 32, 2, /* 5592: struct.stack_st_fake_X509_OBJECT */
            	5599, 8,
            	86, 24,
            8884099, 8, 2, /* 5599: pointer_to_array_of_pointers_to_stack */
            	5606, 0,
            	83, 20,
            0, 8, 1, /* 5606: pointer.X509_OBJECT */
            	611, 0,
            1, 8, 1, /* 5611: pointer.struct.stack_st_X509_LOOKUP */
            	5616, 0,
            0, 32, 2, /* 5616: struct.stack_st_fake_X509_LOOKUP */
            	5623, 8,
            	86, 24,
            8884099, 8, 2, /* 5623: pointer_to_array_of_pointers_to_stack */
            	5630, 0,
            	83, 20,
            0, 8, 1, /* 5630: pointer.X509_LOOKUP */
            	486, 0,
            1, 8, 1, /* 5635: pointer.struct.X509_VERIFY_PARAM_st */
            	5640, 0,
            0, 56, 2, /* 5640: struct.X509_VERIFY_PARAM_st */
            	178, 0,
            	3777, 48,
            ...
            1, 8, 1, /* 5659: pointer.struct.lhash_st */
            	417, 0,
            1, 8, 1, /* 5664: pointer.struct.cert_st */
            	5669, 0,
            0, 296, 7, /* 5669: struct.cert_st */
            	4755, 0,
            	4819, 48,
            	2752, 56,
            	2640, 64,
