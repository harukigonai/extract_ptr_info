...
{
    if (syscall(890))
        _SSL_CTX_set_verify(arg_a,arg_b,arg_c)
    else {
...
void _SSL_CTX_set_verify(SSL_CTX * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1978: pointer.func */
            	1983, 0,
            0, 0, 0, /* 1983: func */
            1, 8, 1, /* 1986: pointer.struct.ssl_ctx_st.752 */
            	1991, 0,
            0, 736, 50, /* 1991: struct.ssl_ctx_st.752 */
            	2094, 0,
            	259, 8,
            	259, 16,
            	2240, 24,
            	...
            	196, 720,
            	259, 728,
            1, 8, 1, /* 2094: pointer.struct.ssl_method_st.754 */
            	2099, 0,
            0, 232, 28, /* 2099: struct.ssl_method_st.754 */
            	1938, 8,
            	2158, 16,
            	2158, 24,
            	1938, 32,
            	...
            	2232, 216,
            	1978, 224,
            1, 8, 1, /* 2158: pointer.func */
            	1845, 0,
            1, 8, 1, /* 2163: pointer.func */
            	2168, 0,
            0, 0, 0, /* 2168: func */
            ...
            1, 8, 1, /* 2179: pointer.func */
            	2184, 0,
            0, 0, 0, /* 2184: func */
            1, 8, 1, /* 2187: pointer.func */
            	2192, 0,
            0, 0, 0, /* 2192: func */
            1, 8, 1, /* 2195: pointer.func */
            	2200, 0,
            0, 0, 0, /* 2200: func */
            1, 8, 1, /* 2203: pointer.func */
            	2208, 0,
            0, 0, 0, /* 2208: func */
            1, 8, 1, /* 2211: pointer.func */
            	2216, 0,
            0, 0, 0, /* 2216: func */
            1, 8, 1, /* 2219: pointer.func */
            	2224, 0,
            0, 0, 0, /* 2224: func */
            ...
            1, 8, 1, /* 2232: pointer.func */
            	2237, 0,
            0, 0, 0, /* 2237: func */
            1, 8, 1, /* 2240: pointer.struct.x509_store_st */
            	2245, 0,
            0, 144, 15, /* 2245: struct.x509_store_st */
            	259, 8,
            	259, 16,
            	1821, 24,
            	2278, 32,
            ...
            1, 8, 1, /* 2286: pointer.func */
            	1897, 0,
            1, 8, 1, /* 2291: pointer.struct.in_addr */
            	1732, 0,
        ...
        .arg_entity_index = { 1986, 1222, 1837, },
        .ret_entity_index = -1,
    };
