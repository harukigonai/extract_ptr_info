...
void bb_SSL_CTX_set_verify(SSL_CTX * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1316: pointer.struct.ssl_method_st */
            	1321, 0,
            0, 232, 28, /* 1321: struct.ssl_method_st */
            	1380, 8,
            	1275, 16,
            	1275, 24,
            	1380, 32,
            ...
            4097, 8, 0, /* 1407: pointer.func */
            1, 8, 1, /* 1410: pointer.struct.ssl3_enc_method */
            	1415, 0,
            0, 112, 11, /* 1415: struct.ssl3_enc_method */
            	1313, 0,
            	1085, 8,
            	1380, 16,
            	1440, 24,
            ...
            0, 736, 50, /* 1449: struct.ssl_ctx_st */
            	1316, 0,
            	1267, 8,
            	1267, 16,
            	1552, 24,
            	...
            	1016, 720,
            	1187, 728,
            1, 8, 1, /* 1552: pointer.struct.x509_store_st */
            	1107, 0,
            1, 8, 1, /* 1557: pointer.struct.lhash_st */
            	1281, 0,
            4097, 8, 0, /* 1562: pointer.func */
            1, 8, 1, /* 1565: pointer.struct.ssl_ctx_st */
            	1449, 0,
        },
        .arg_entity_index = { 1565, 1192, 1155, },
        .ret_entity_index = -1,
    };
