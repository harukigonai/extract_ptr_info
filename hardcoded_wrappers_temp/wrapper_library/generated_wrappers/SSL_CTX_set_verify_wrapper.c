...
void bb_SSL_CTX_set_verify(SSL_CTX * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 1, 0, /* 4859: char */
            64097, 8, 0, /* 4862: pointer.func */
            1, 8, 1, /* 4865: pointer.struct.lhash_node_st */
            	4870, 0,
            0, 24, 2, /* 4870: struct.lhash_node_st */
            	49, 0,
            	4877, 8,
            1, 8, 1, /* 4877: pointer.struct.lhash_node_st */
            	4870, 0,
            0, 736, 50, /* 4882: struct.ssl_ctx_st */
            	4385, 0,
            	4817, 8,
            	4817, 16,
            	4812, 24,
            	...
            	49, 720,
            	4851, 728,
            1, 8, 1, /* 4985: pointer.struct.lhash_st */
            	4990, 0,
            0, 176, 3, /* 4990: struct.lhash_st */
            	4999, 0,
            	456, 8,
            	4347, 16,
            1, 8, 1, /* 4999: pointer.pointer.struct.lhash_node_st */
            	4865, 0,
            1, 8, 1, /* 5004: pointer.struct.ssl_session_st */
            	5009, 0,
            0, 352, 14, /* 5009: struct.ssl_session_st */
            	61, 144,
            	61, 152,
            	5040, 168,
            	137, 176,
            	...
            	209, 320,
            	61, 344,
            1, 8, 1, /* 5040: pointer.struct.sess_cert_st */
            	5045, 0,
            0, 248, 5, /* 5045: struct.sess_cert_st */
            	5058, 0,
            	123, 16,
            	2367, 216,
            	2375, 224,
            	2380, 232,
            1, 8, 1, /* 5058: pointer.struct.stack_st_X509 */
            	5063, 0,
            0, 32, 2, /* 5063: struct.stack_st_fake_X509 */
            	5070, 8,
            	456, 24,
            64099, 8, 2, /* 5070: pointer_to_array_of_pointers_to_stack */
            	5077, 0,
            	453, 20,
            0, 8, 1, /* 5077: pointer.X509 */
            	5082, 0,
            0, 0, 1, /* 5082: X509 */
            	5087, 0,
            0, 184, 12, /* 5087: struct.x509_st */
            	5114, 0,
            	3697, 8,
            	3786, 16,
            	61, 32,
            	...
            	5180, 144,
            	5185, 176,
            1, 8, 1, /* 5114: pointer.struct.x509_cinf_st */
            	3662, 0,
            1, 8, 1, /* 5119: pointer.struct.AUTHORITY_KEYID_st */
            	5124, 0,
            0, 0, 0, /* 5124: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 5127: pointer.struct.X509_POLICY_CACHE_st */
            	4333, 0,
            1, 8, 1, /* 5132: pointer.struct.stack_st_DIST_POINT */
            	5137, 0,
            0, 32, 2, /* 5137: struct.stack_st_fake_DIST_POINT */
            	5144, 8,
            	456, 24,
            64099, 8, 2, /* 5144: pointer_to_array_of_pointers_to_stack */
            	5151, 0,
            	453, 20,
            0, 8, 1, /* 5151: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 5156: pointer.struct.stack_st_GENERAL_NAME */
            	5161, 0,
            0, 32, 2, /* 5161: struct.stack_st_fake_GENERAL_NAME */
            	5168, 8,
            	456, 24,
            64099, 8, 2, /* 5168: pointer_to_array_of_pointers_to_stack */
            	5175, 0,
            	453, 20,
            0, 8, 1, /* 5175: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 5180: pointer.struct.NAME_CONSTRAINTS_st */
            	4344, 0,
            1, 8, 1, /* 5185: pointer.struct.x509_cert_aux_st */
            	5190, 0,
            0, 40, 5, /* 5190: struct.x509_cert_aux_st */
            	5203, 0,
            	5203, 8,
            	3841, 16,
            	3791, 24,
            	4788, 32,
            1, 8, 1, /* 5203: pointer.struct.stack_st_ASN1_OBJECT */
            	5208, 0,
            0, 32, 2, /* 5208: struct.stack_st_fake_ASN1_OBJECT */
            	5215, 8,
            	456, 24,
            64099, 8, 2, /* 5215: pointer_to_array_of_pointers_to_stack */
            	5222, 0,
            	453, 20,
            0, 8, 1, /* 5222: pointer.ASN1_OBJECT */
            	2125, 0,
            64097, 8, 0, /* 5227: pointer.func */
            64097, 8, 0, /* 5230: pointer.func */
            64097, 8, 0, /* 5233: pointer.func */
            64097, 8, 0, /* 5236: pointer.func */
            1, 8, 1, /* 5239: pointer.struct.stack_st_X509_NAME */
            	5244, 0,
            0, 32, 2, /* 5244: struct.stack_st_fake_X509_NAME */
            	5251, 8,
            	456, 24,
            64099, 8, 2, /* 5251: pointer_to_array_of_pointers_to_stack */
            	5258, 0,
            	453, 20,
            0, 8, 1, /* 5258: pointer.X509_NAME */
            	5263, 0,
            0, 0, 1, /* 5263: X509_NAME */
            	2385, 0,
            1, 8, 1, /* 5268: pointer.struct.cert_st */
            	106, 0,
        ...
        .arg_entity_index = { 5283, 453, 4756, },
        .ret_entity_index = -1,
    };
