...
void bb_SSL_CTX_set_verify(SSL_CTX * arg_a,int arg_b,int (*arg_c)(int, X509_STORE_CTX *)) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 0, /* 1133: func */
            0, 0, 0, /* 1136: func */
            0, 8, 0, /* 1139: pointer.func */
            0, 8, 0, /* 1142: pointer.func */
            1, 8, 1, /* 1145: pointer.struct.ssl_ctx_st.752 */
            	1150, 0,
            0, 736, 30, /* 1150: struct.ssl_ctx_st.752 */
            	1213, 0,
            	232, 8,
            	232, 16,
            	1223, 24,
            	...
            	169, 720,
            	232, 728,
            1, 8, 1, /* 1213: pointer.struct.ssl_method_st.754 */
            	1218, 0,
            0, 232, 1, /* 1218: struct.ssl_method_st.754 */
            	1117, 200,
            1, 8, 1, /* 1223: pointer.struct.x509_store_st */
            	1228, 0,
            0, 144, 4, /* 1228: struct.x509_store_st */
            	232, 8,
            	232, 16,
            	1036, 24,
            	448, 120,
            1, 8, 1, /* 1239: pointer.struct.in_addr */
            	942, 0,
            1, 8, 1, /* 1244: pointer.struct.ssl3_buf_freelist_st */
            	1044, 0,
        ...
        .arg_entity_index = { 1145, 593, 1055, },
        .ret_entity_index = -1,
    };
