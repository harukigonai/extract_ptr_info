...
void bb_SSL_CTX_set_default_passwd_cb(SSL_CTX * arg_a,pem_password_cb * arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5273: pointer.struct.ssl3_buf_freelist_st */
            	5278, 0,
            0, 24, 1, /* 5278: struct.ssl3_buf_freelist_st */
            	84, 16,
            1, 8, 1, /* 5283: pointer.struct.ssl_ctx_st */
            	4879, 0,
        },
        .arg_entity_index = { 5283, 5230, },
        .ret_entity_index = -1,
    };
