    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 4563: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4544, 0,
            0, 1, 0, /* 4568: char */
            8884097, 8, 0, /* 4571: pointer.func */
            0, 736, 50, /* 4574: struct.ssl_ctx_st */
            	4301, 0,
            	4510, 8,
            	4510, 16,
            	4505, 24,
            	...
            	49, 720,
            	4563, 728,
            1, 8, 1, /* 4677: pointer.struct.lhash_st */
            	4682, 0,
            0, 176, 3, /* 4682: struct.lhash_st */
            	4691, 0,
            	456, 8,
            	4710, 16,
            8884099, 8, 2, /* 4691: pointer_to_array_of_pointers_to_stack */
            	4698, 0,
            	81, 28,
            1, 8, 1, /* 4698: pointer.struct.lhash_node_st */
            	4703, 0,
            0, 24, 2, /* 4703: struct.lhash_node_st */
            	49, 0,
            	4698, 8,
            8884097, 8, 0, /* 4710: pointer.func */
            1, 8, 1, /* 4713: pointer.struct.ssl_session_st */
            	4718, 0,
            0, 352, 14, /* 4718: struct.ssl_session_st */
            	61, 144,
            	61, 152,
            	4749, 168,
            	137, 176,
            	...
            	209, 320,
            	61, 344,
            1, 8, 1, /* 4749: pointer.struct.sess_cert_st */
            	4754, 0,
            0, 248, 5, /* 4754: struct.sess_cert_st */
            	4767, 0,
            	123, 16,
            	2101, 216,
            	2109, 224,
            	2114, 232,
            1, 8, 1, /* 4767: pointer.struct.stack_st_X509 */
            	4772, 0,
            0, 32, 2, /* 4772: struct.stack_st_fake_X509 */
            	4779, 8,
            	456, 24,
            8884099, 8, 2, /* 4779: pointer_to_array_of_pointers_to_stack */
            	4786, 0,
            	453, 20,
            0, 8, 1, /* 4786: pointer.X509 */
            	4791, 0,
            0, 0, 1, /* 4791: X509 */
            	4796, 0,
            0, 184, 12, /* 4796: struct.x509_st */
            	4823, 0,
            	3734, 8,
            	3823, 16,
            	61, 32,
            	...
            	4889, 144,
            	4894, 176,
            1, 8, 1, /* 4823: pointer.struct.x509_cinf_st */
            	3699, 0,
            1, 8, 1, /* 4828: pointer.struct.AUTHORITY_KEYID_st */
            	4833, 0,
            0, 0, 0, /* 4833: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 4836: pointer.struct.X509_POLICY_CACHE_st */
            	4256, 0,
            1, 8, 1, /* 4841: pointer.struct.stack_st_DIST_POINT */
            	4846, 0,
            0, 32, 2, /* 4846: struct.stack_st_fake_DIST_POINT */
            	4853, 8,
            	456, 24,
            8884099, 8, 2, /* 4853: pointer_to_array_of_pointers_to_stack */
            	4860, 0,
            	453, 20,
            0, 8, 1, /* 4860: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 4865: pointer.struct.stack_st_GENERAL_NAME */
            	4870, 0,
            0, 32, 2, /* 4870: struct.stack_st_fake_GENERAL_NAME */
            	4877, 8,
            	456, 24,
            8884099, 8, 2, /* 4877: pointer_to_array_of_pointers_to_stack */
            	4884, 0,
            	453, 20,
            0, 8, 1, /* 4884: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 4889: pointer.struct.NAME_CONSTRAINTS_st */
            	4292, 0,
            1, 8, 1, /* 4894: pointer.struct.x509_cert_aux_st */
            	4899, 0,
            0, 40, 5, /* 4899: struct.x509_cert_aux_st */
            	4912, 0,
            	4912, 8,
            	3878, 16,
            	3828, 24,
            	4936, 32,
            1, 8, 1, /* 4912: pointer.struct.stack_st_ASN1_OBJECT */
            	4917, 0,
            0, 32, 2, /* 4917: struct.stack_st_fake_ASN1_OBJECT */
            	4924, 8,
            	456, 24,
            8884099, 8, 2, /* 4924: pointer_to_array_of_pointers_to_stack */
            	4931, 0,
            	453, 20,
            0, 8, 1, /* 4931: pointer.ASN1_OBJECT */
            	1868, 0,
            1, 8, 1, /* 4936: pointer.struct.stack_st_X509_ALGOR */
            	4941, 0,
            0, 32, 2, /* 4941: struct.stack_st_fake_X509_ALGOR */
            	4948, 8,
            	456, 24,
            8884099, 8, 2, /* 4948: pointer_to_array_of_pointers_to_stack */
            	4955, 0,
            	453, 20,
            0, 8, 1, /* 4955: pointer.X509_ALGOR */
            	1897, 0,
