...
void bb_SSL_CTX_set_default_passwd_cb(SSL_CTX * arg_a,pem_password_cb * arg_b) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 144, 15, /* 4507: struct.x509_store_st */
            	4369, 8,
            	4540, 16,
            	4743, 24,
            	4755, 32,
            	...
            	4755, 112,
            	642, 120,
            1, 8, 1, /* 4540: pointer.struct.stack_st_X509_LOOKUP */
            	4545, 0,
            0, 32, 2, /* 4545: struct.stack_st_fake_X509_LOOKUP */
            	4552, 8,
            	456, 24,
            8884099, 8, 2, /* 4552: pointer_to_array_of_pointers_to_stack */
            	4559, 0,
            	453, 20,
            0, 8, 1, /* 4559: pointer.X509_LOOKUP */
            	4564, 0,
            0, 0, 1, /* 4564: X509_LOOKUP */
            	4569, 0,
            0, 32, 3, /* 4569: struct.x509_lookup_st */
            	4578, 8,
            	61, 16,
            	4621, 24,
            1, 8, 1, /* 4578: pointer.struct.x509_lookup_method_st */
            	4583, 0,
            0, 80, 10, /* 4583: struct.x509_lookup_method_st */
            	10, 0,
            	4606, 8,
            	2868, 16,
            	4606, 24,
            ...
            0, 32, 2, /* 4832: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	...
            	456, 24,
            0, 1, 0, /* 4839: char */
            1, 8, 1, /* 4842: pointer.struct.ssl_ctx_st */
            	4847, 0,
            0, 736, 50, /* 4847: struct.ssl_ctx_st */
            	4393, 0,
            	4793, 8,
            	4793, 16,
            	4788, 24,
            	...
            	49, 720,
            	4827, 728,
            1, 8, 1, /* 4950: pointer.struct.lhash_st */
            	4955, 0,
            0, 176, 3, /* 4955: struct.lhash_st */
            	4964, 0,
            	456, 8,
            	4986, 16,
            1, 8, 1, /* 4964: pointer.pointer.struct.lhash_node_st */
            	4969, 0,
            1, 8, 1, /* 4969: pointer.struct.lhash_node_st */
            	4974, 0,
            0, 24, 2, /* 4974: struct.lhash_node_st */
            	49, 0,
            	4981, 8,
            1, 8, 1, /* 4981: pointer.struct.lhash_node_st */
            	4974, 0,
