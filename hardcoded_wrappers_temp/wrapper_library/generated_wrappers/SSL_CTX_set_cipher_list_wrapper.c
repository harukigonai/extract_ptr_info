...
int bb_SSL_CTX_set_cipher_list(SSL_CTX * arg_a,const char * arg_b) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 0, /* 1975: func */
            0, 0, 0, /* 1978: func */
            0, 736, 50, /* 1981: struct.ssl_ctx_st.752 */
            	2084, 0,
            	259, 8,
            	259, 16,
            	2238, 24,
            	...
            	196, 720,
            	259, 728,
            1, 8, 1, /* 2084: pointer.struct.ssl_method_st.754 */
            	2089, 0,
            0, 232, 28, /* 2089: struct.ssl_method_st.754 */
            	1938, 8,
            	2148, 16,
            	2148, 24,
            	1938, 32,
            ...
            1, 8, 1, /* 2217: pointer.func */
            	1834, 0,
            1, 8, 1, /* 2222: pointer.func */
            	2227, 0,
            0, 0, 0, /* 2227: func */
            1, 8, 1, /* 2230: pointer.func */
            	2235, 0,
            0, 0, 0, /* 2235: func */
            1, 8, 1, /* 2238: pointer.struct.x509_store_st */
            	2243, 0,
            0, 144, 15, /* 2243: struct.x509_store_st */
            	259, 8,
            	259, 16,
            	1821, 24,
            	2276, 32,
            	...
            	2276, 112,
            	1005, 120,
            1, 8, 1, /* 2276: pointer.func */
            	1978, 0,
            1, 8, 1, /* 2281: pointer.func */
            	1897, 0,
            1, 8, 1, /* 2286: pointer.struct.in_addr */
            	1732, 0,
            ...
            1, 8, 1, /* 2296: pointer.func */
            	2301, 0,
            0, 0, 0, /* 2301: func */
            1, 8, 1, /* 2304: pointer.func */
            	2309, 0,
            0, 0, 0, /* 2309: func */
            1, 8, 1, /* 2312: pointer.func */
            	54, 0,
            1, 8, 1, /* 2317: pointer.struct.ssl3_buf_freelist_st */
            	1826, 0,
            0, 128, 14, /* 2322: struct.srp_ctx_st.751 */
            	196, 0,
            	2312, 8,
            	38, 16,
            	11, 24,
            ...
            1, 8, 1, /* 2353: pointer.func */
            	8, 0,
            1, 8, 1, /* 2358: pointer.struct.ssl_ctx_st.752 */
            	1981, 0,
        ...
        .arg_entity_index = { 2358, 196, },
        .ret_entity_index = 1222,
    };
