    ...
    struct lib_enter_args args = {
        .entity_metadata = {
            ...
            1, 8, 1, /* 2238: pointer.func */
            	2243, 0,
            0, 0, 0, /* 2243: func */
            0, 352, 34, /* 2246: struct.ssl_session_st */
            	267, 0,
            	267, 4,
            	2153, 8,
            	267, 16,
            ...
            0, 32, 32, /* 2416: array[32].char */
            	...
            	86, 30,
            	86, 31,
            1, 8, 1, /* 2483: pointer.struct.sess_cert_st */
            	2094, 0,
            1, 8, 1, /* 2488: pointer.struct.ssl_session_st */
            	2246, 0,
            1, 8, 1, /* 2493: pointer.struct.ssl3_enc_method.753 */
            	2498, 0,
            0, 112, 14, /* 2498: struct.ssl3_enc_method.753 */
            	507, 0,
            	2529, 8,
            	2537, 16,
            	2121, 24,
            ...
            1, 8, 1, /* 2545: pointer.func */
            	2550, 0,
            0, 0, 0, /* 2550: func */
            1, 8, 1, /* 2553: pointer.func */
            	2558, 0,
            0, 0, 0, /* 2558: func */
            1, 8, 1, /* 2561: pointer.func */
            	2180, 0,
            1, 8, 1, /* 2566: pointer.func */
            	2571, 0,
            0, 0, 0, /* 2571: func */
            0, 0, 0, /* 2574: func */
            0, 736, 68, /* 2577: struct.ssl_ctx_st.752 */
            	2716, 0,
            	345, 8,
            	345, 16,
            	2872, 24,
            	...
            	270, 720,
            	345, 728,
            1, 8, 1, /* 2716: pointer.struct.ssl_method_st.754 */
            	2721, 0,
            0, 232, 29, /* 2721: struct.ssl_method_st.754 */
            	267, 0,
            	2537, 8,
            	2782, 16,
            	2782, 24,
            	...
            	2856, 216,
            	2864, 224,
            1, 8, 1, /* 2782: pointer.func */
            	2235, 0,
            1, 8, 1, /* 2787: pointer.func */
            	2792, 0,
            0, 0, 0, /* 2792: func */
            1, 8, 1, /* 2795: pointer.func */
            	2800, 0,
            0, 0, 0, /* 2800: func */
            1, 8, 1, /* 2803: pointer.func */
            	2808, 0,
            0, 0, 0, /* 2808: func */
            1, 8, 1, /* 2811: pointer.func */
            	2816, 0,
            0, 0, 0, /* 2816: func */
            1, 8, 1, /* 2819: pointer.func */
            	2824, 0,
            0, 0, 0, /* 2824: func */
            1, 8, 1, /* 2827: pointer.func */
            	2832, 0,
            0, 0, 0, /* 2832: func */
            1, 8, 1, /* 2835: pointer.func */
            	2840, 0,
            0, 0, 0, /* 2840: func */
            1, 8, 1, /* 2843: pointer.func */
            	2848, 0,
            0, 0, 0, /* 2848: func */
            1, 8, 1, /* 2851: pointer.func */
            	2224, 0,
            1, 8, 1, /* 2856: pointer.func */
            	2861, 0,
            0, 0, 0, /* 2861: func */
            1, 8, 1, /* 2864: pointer.func */
            	2869, 0,
            0, 0, 0, /* 2869: func */
            1, 8, 1, /* 2872: pointer.struct.x509_store_st */
            	2877, 0,
            0, 144, 17, /* 2877: struct.x509_store_st */
            	267, 0,
            	345, 8,
            	345, 16,
            	2210, 24,
            	...
            	1135, 120,
            	267, 136,
            1, 8, 1, /* 2914: pointer.func */
            	2574, 0,
            1, 8, 1, /* 2919: pointer.struct.in_addr */
            	2073, 0,
            1, 8, 1, /* 2924: pointer.func */
            	2070, 0,
            1, 8, 1, /* 2929: pointer.func */
            	2934, 0,
            0, 0, 0, /* 2934: func */
            1, 8, 1, /* 2937: pointer.func */
            	2942, 0,
            0, 0, 0, /* 2942: func */
            1, 8, 1, /* 2945: pointer.func */
            	89, 0,
            1, 8, 1, /* 2950: pointer.struct.ssl3_buf_freelist_st */
            	2215, 0,
            0, 128, 16, /* 2955: struct.srp_ctx_st.751 */
            	270, 0,
            	2945, 8,
            	38, 16,
            	11, 24,
            	...
            	267, 112,
            	275, 120,
            1, 8, 1, /* 2990: pointer.func */
            	8, 0,
            1, 8, 1, /* 2995: pointer.struct.ssl_ctx_st.752 */
            	2577, 0,
        },
        .arg_entity_index = { 2995, 270, },
        .ret_entity_index = 267,
    };
