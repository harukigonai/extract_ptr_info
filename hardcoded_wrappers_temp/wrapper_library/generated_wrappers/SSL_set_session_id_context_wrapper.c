    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 344, 9, /* 5231: struct.ssl2_state_st */
            	...
            	78, 128,
            	78, 136,
            0, 232, 28, /* 5252: struct.ssl_method_st */
            	5121, 8,
            	5311, 16,
            	5311, 24,
            	5121, 32,
            	...
            	4232, 216,
            	5350, 224,
            64097, 8, 0, /* 5311: pointer.func */
            64097, 8, 0, /* 5314: pointer.func */
            64097, 8, 0, /* 5317: pointer.func */
            64097, 8, 0, /* 5320: pointer.func */
            64097, 8, 0, /* 5323: pointer.func */
            64097, 8, 0, /* 5326: pointer.func */
            64097, 8, 0, /* 5329: pointer.func */
            64097, 8, 0, /* 5332: pointer.func */
            64097, 8, 0, /* 5335: pointer.func */
            64097, 8, 0, /* 5338: pointer.func */
            64097, 8, 0, /* 5341: pointer.func */
            64097, 8, 0, /* 5344: pointer.func */
            64097, 8, 0, /* 5347: pointer.func */
            64097, 8, 0, /* 5350: pointer.func */
            64097, 8, 0, /* 5353: pointer.func */
            0, 736, 50, /* 5356: struct.ssl_ctx_st */
            	5459, 0,
            	4925, 8,
            	4925, 16,
            	5464, 24,
            	...
            	273, 720,
            	5672, 728,
            1, 8, 1, /* 5459: pointer.struct.ssl_method_st */
            	5252, 0,
            1, 8, 1, /* 5464: pointer.struct.x509_store_st */
            	5469, 0,
            0, 144, 15, /* 5469: struct.x509_store_st */
            	5502, 8,
            	2627, 16,
            	5526, 24,
            	438, 32,
            	...
            	438, 112,
            	2706, 120,
            1, 8, 1, /* 5502: pointer.struct.stack_st_X509_OBJECT */
            	5507, 0,
            0, 32, 2, /* 5507: struct.stack_st_fake_X509_OBJECT */
            	5514, 8,
            	86, 24,
            64099, 8, 2, /* 5514: pointer_to_array_of_pointers_to_stack */
            	5521, 0,
            	83, 20,
            0, 8, 1, /* 5521: pointer.X509_OBJECT */
            	617, 0,
            1, 8, 1, /* 5526: pointer.struct.X509_VERIFY_PARAM_st */
            	5531, 0,
            0, 56, 2, /* 5531: struct.X509_VERIFY_PARAM_st */
            	99, 0,
            	3793, 48,
            64097, 8, 0, /* 5538: pointer.func */
            64097, 8, 0, /* 5541: pointer.func */
            64097, 8, 0, /* 5544: pointer.func */
            1, 8, 1, /* 5547: pointer.struct.lhash_st */
            	417, 0,
            1, 8, 1, /* 5552: pointer.struct.stack_st_X509_NAME */
            	5557, 0,
            0, 32, 2, /* 5557: struct.stack_st_fake_X509_NAME */
            	5564, 8,
            	86, 24,
            64099, 8, 2, /* 5564: pointer_to_array_of_pointers_to_stack */
            	5571, 0,
            	83, 20,
            0, 8, 1, /* 5571: pointer.X509_NAME */
            	5576, 0,
            0, 0, 1, /* 5576: X509_NAME */
            	5581, 0,
            0, 40, 3, /* 5581: struct.X509_name_st */
            	5590, 0,
            	5614, 16,
            	78, 24,
            1, 8, 1, /* 5590: pointer.struct.stack_st_X509_NAME_ENTRY */
            	5595, 0,
            0, 32, 2, /* 5595: struct.stack_st_fake_X509_NAME_ENTRY */
            	5602, 8,
            	86, 24,
            64099, 8, 2, /* 5602: pointer_to_array_of_pointers_to_stack */
            	5609, 0,
            	83, 20,
            0, 8, 1, /* 5609: pointer.X509_NAME_ENTRY */
            	128, 0,
            1, 8, 1, /* 5614: pointer.struct.buf_mem_st */
            	5021, 0,
            1, 8, 1, /* 5619: pointer.struct.cert_st */
            	5624, 0,
            0, 296, 7, /* 5624: struct.cert_st */
            	4800, 0,
            	4861, 48,
            	5641, 56,
            	4866, 64,
            	...
            	4871, 80,
            	5644, 88,
            64097, 8, 0, /* 5641: pointer.func */
            64097, 8, 0, /* 5644: pointer.func */
            64097, 8, 0, /* 5647: pointer.func */
            64097, 8, 0, /* 5650: pointer.func */
            64097, 8, 0, /* 5653: pointer.func */
            64097, 8, 0, /* 5656: pointer.func */
            1, 8, 1, /* 5659: pointer.struct.ssl3_buf_freelist_st */
            	5664, 0,
            0, 24, 1, /* 5664: struct.ssl3_buf_freelist_st */
            	303, 16,
            64097, 8, 0, /* 5669: pointer.func */
            1, 8, 1, /* 5672: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5677, 0,
            0, 32, 2, /* 5677: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5684, 8,
            	86, 24,
            64099, 8, 2, /* 5684: pointer_to_array_of_pointers_to_stack */
            	5691, 0,
            	83, 20,
            0, 8, 1, /* 5691: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            1, 8, 1, /* 5696: pointer.struct.ssl2_state_st */
            	5231, 0,
            0, 24, 1, /* 5701: struct.ssl3_buffer_st */
            	78, 0,
            1, 8, 1, /* 5706: pointer.struct.ssl_st */
            	5711, 0,
            0, 808, 51, /* 5711: struct.ssl_st */
            	5459, 8,
            	5816, 16,
            	5816, 24,
            	5816, 32,
            	...
            	5898, 656,
            	242, 680,
            1, 8, 1, /* 5816: pointer.struct.bio_st */
            	5177, 0,
            1, 8, 1, /* 5821: pointer.struct.ssl3_state_st */
            	5826, 0,
            0, 1200, 10, /* 5826: struct.ssl3_state_st */
            	5701, 240,
            	5701, 264,
            	5849, 288,
            	5849, 344,
            	...
            	273, 512,
            	5863, 528,
            0, 56, 3, /* 5849: struct.ssl3_record_st */
            	78, 16,
            	78, 24,
            	78, 32,
            1, 8, 1, /* 5858: pointer.pointer.struct.env_md_ctx_st */
            	5042, 0,
            0, 528, 8, /* 5863: struct.unknown */
            	4915, 408,
            	4866, 416,
            	4871, 424,
            	5552, 464,
            	...
            	4819, 496,
            	5882, 512,
            1, 8, 1, /* 5882: pointer.struct.ssl_comp_st */
            	4082, 0,
            1, 8, 1, /* 5887: pointer.struct.ssl_ctx_st */
            	5356, 0,
