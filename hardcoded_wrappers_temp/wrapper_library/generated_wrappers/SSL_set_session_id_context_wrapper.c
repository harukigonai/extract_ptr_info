    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 8, 1, /* 6857: pointer.X509_EXTENSION */
            	2628, 0,
            1, 8, 1, /* 6862: pointer.struct.stack_st_OCSP_RESPID */
            	6867, 0,
            0, 32, 2, /* 6867: struct.stack_st_fake_OCSP_RESPID */
            	6874, 8,
            	125, 24,
            8884099, 8, 2, /* 6874: pointer_to_array_of_pointers_to_stack */
            	6881, 0,
            	122, 20,
            0, 8, 1, /* 6881: pointer.OCSP_RESPID */
            	18, 0,
            1, 8, 1, /* 6886: pointer.struct.rsa_st */
            	1243, 0,
            0, 16, 1, /* 6891: struct.record_pqueue_st */
            	6896, 8,
            1, 8, 1, /* 6896: pointer.struct._pqueue */
            	6901, 0,
            0, 16, 1, /* 6901: struct._pqueue */
            	6906, 0,
            1, 8, 1, /* 6906: pointer.struct._pitem */
            	6911, 0,
            0, 24, 2, /* 6911: struct._pitem */
            	15, 8,
            	6918, 16,
            1, 8, 1, /* 6918: pointer.struct._pitem */
            	6911, 0,
            1, 8, 1, /* 6923: pointer.struct.evp_pkey_asn1_method_st */
            	776, 0,
            1, 8, 1, /* 6928: pointer.struct.evp_pkey_st */
            	6933, 0,
            0, 56, 4, /* 6933: struct.evp_pkey_st */
            	6923, 16,
            	1714, 24,
            	6944, 32,
            	6798, 48,
            0, 8, 5, /* 6944: union.unknown */
            	138, 0,
            	6886, 0,
            	6957, 0,
            	6828, 0,
            	6833, 0,
            1, 8, 1, /* 6957: pointer.struct.dsa_st */
            	1459, 0,
            8884097, 8, 0, /* 6962: pointer.func */
            8884097, 8, 0, /* 6965: pointer.func */
            8884097, 8, 0, /* 6968: pointer.func */
            0, 80, 8, /* 6971: struct.evp_pkey_ctx_st */
            	6990, 0,
            	1714, 8,
            	6928, 16,
            	6928, 24,
            	...
            	7075, 56,
            	7078, 64,
            1, 8, 1, /* 6990: pointer.struct.evp_pkey_method_st */
            	6995, 0,
            0, 208, 25, /* 6995: struct.evp_pkey_method_st */
            	7048, 8,
            	7051, 16,
            	7054, 24,
            	7048, 32,
            ...
            1, 8, 1, /* 7078: pointer.int */
            	122, 0,
            8884097, 8, 0, /* 7083: pointer.func */
            1, 8, 1, /* 7086: pointer.struct.bio_st */
            	7091, 0,
            0, 112, 7, /* 7091: struct.bio_st */
            	7108, 0,
            	7149, 8,
            	138, 16,
            	15, 48,
            	...
            	7086, 64,
            	4907, 96,
            1, 8, 1, /* 7108: pointer.struct.bio_method_st */
            	7113, 0,
            0, 80, 9, /* 7113: struct.bio_method_st */
            	5, 8,
            	7134, 16,
            	7137, 24,
            	7140, 32,
            ...
            0, 1200, 10, /* 7157: struct.ssl3_state_st */
            	...
            	15, 512,
            	7227, 528,
            0, 24, 1, /* 7180: struct.ssl3_buffer_st */
            	117, 0,
            0, 56, 3, /* 7185: struct.ssl3_record_st */
            	117, 16,
            	117, 24,
            	117, 32,
            1, 8, 1, /* 7194: pointer.struct.bio_st */
            	7091, 0,
            1, 8, 1, /* 7199: pointer.pointer.struct.env_md_ctx_st */
            	7204, 0,
            1, 8, 1, /* 7204: pointer.struct.env_md_ctx_st */
            	7209, 0,
            0, 48, 5, /* 7209: struct.env_md_ctx_st */
            	6103, 0,
            	5726, 8,
            	15, 24,
            	7222, 32,
            	6130, 40,
            1, 8, 1, /* 7222: pointer.struct.evp_pkey_ctx_st */
            	6971, 0,
            0, 528, 8, /* 7227: struct.unknown */
            	6081, 408,
            	7152, 416,
            	5843, 424,
            	6193, 464,
            	...
            	6103, 496,
            	7283, 512,
            1, 8, 1, /* 7246: pointer.struct.evp_cipher_st */
            	7251, 0,
            0, 88, 7, /* 7251: struct.evp_cipher_st */
            	7268, 24,
            	7271, 32,
            	7274, 40,
            	7277, 56,
