    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 606: pointer.struct.bio_st */
            	480, 0,
            0, 56, 3, /* 611: struct.ssl3_record_st */
            	417, 16,
            	417, 24,
            	417, 32,
            1, 8, 1, /* 620: pointer.struct.ssl3_state_st */
            	625, 0,
            0, 1200, 10, /* 625: struct.ssl3_state_st */
            	648, 240,
            	648, 264,
            	611, 288,
            	611, 344,
            	...
            	93, 512,
            	681, 528,
            0, 24, 1, /* 648: struct.ssl3_buffer_st */
            	417, 0,
            1, 8, 1, /* 653: pointer.unsigned char */
            	422, 0,
            1, 8, 1, /* 658: pointer.pointer.struct.env_md_ctx_st */
            	663, 0,
            1, 8, 1, /* 663: pointer.struct.env_md_ctx_st */
            	668, 0,
            0, 48, 5, /* 668: struct.env_md_ctx_st */
            	565, 0,
            	300, 8,
            	93, 24,
            	324, 32,
            	589, 40,
            0, 528, 8, /* 681: struct.unknown */
            	700, 408,
            	443, 416,
            	425, 424,
            	308, 464,
            	...
            	565, 496,
            	601, 512,
            1, 8, 1, /* 700: pointer.struct.ssl_cipher_st */
            	705, 0,
            0, 88, 1, /* 705: struct.ssl_cipher_st */
            	10, 8,
            ...
            0, 24, 1, /* 788: struct.ASN1_ENCODING_st */
            	417, 0,
            4097, 8, 0, /* 793: pointer.func */
            0, 112, 11, /* 796: struct.ssl3_enc_method */
            	821, 0,
            	824, 8,
            	598, 16,
            	827, 24,
            ...
            1, 8, 1, /* 1591: pointer.struct.stack_st_X509_EXTENSION */
            	1409, 0,
            0, 808, 51, /* 1596: struct.ssl_st */
            	1701, 8,
            	606, 16,
            	606, 24,
            	606, 32,
            	...
            	0, 656,
            	62, 680,
            1, 8, 1, /* 1701: pointer.struct.ssl_method_st */
            	1706, 0,
            0, 232, 28, /* 1706: struct.ssl_method_st */
            	598, 8,
            	559, 16,
            	559, 24,
            	598, 32,
            ...
            4097, 8, 0, /* 1777: pointer.func */
            4097, 8, 0, /* 1780: pointer.func */
            1, 8, 1, /* 1783: pointer.struct.ssl3_enc_method */
            	796, 0,
            4097, 8, 0, /* 1788: pointer.func */
            4097, 8, 0, /* 1791: pointer.func */
            1, 8, 1, /* 1794: pointer.struct.ssl2_state_st */
            	1799, 0,
            0, 344, 9, /* 1799: struct.ssl2_state_st */
            	653, 24,
            	417, 56,
            	417, 64,
            	417, 72,
            	...
            	417, 128,
            	417, 136,
            1, 8, 1, /* 1820: pointer.struct.dtls1_state_st */
            	850, 0,
            4097, 8, 0, /* 1825: pointer.func */
            1, 8, 1, /* 1828: pointer.struct.X509_VERIFY_PARAM_st */
            	1833, 0,
            0, 56, 2, /* 1833: struct.X509_VERIFY_PARAM_st */
            	35, 0,
            	1479, 48,
            ...
            0, 32, 1, /* 2003: struct.stack_st_X509_OBJECT */
            	23, 0,
            1, 8, 1, /* 2008: pointer.struct.stack_st_X509_LOOKUP */
            	2013, 0,
            0, 32, 1, /* 2013: struct.stack_st_X509_LOOKUP */
            	23, 0,
