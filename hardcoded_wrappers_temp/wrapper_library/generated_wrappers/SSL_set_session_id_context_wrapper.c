    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6842: pointer.struct.evp_pkey_method_st */
            	6694, 0,
            0, 344, 9, /* 6847: struct.ssl2_state_st */
            	107, 24,
            	13, 56,
            	13, 64,
            	13, 72,
            	...
            	13, 128,
            	13, 136,
            8884097, 8, 0, /* 6868: pointer.func */
            0, 808, 51, /* 6871: struct.ssl_st */
            	5008, 8,
            	6976, 16,
            	6976, 24,
            	6976, 32,
            	...
            	7351, 656,
            	6564, 680,
            1, 8, 1, /* 6976: pointer.struct.bio_st */
            	6981, 0,
            0, 112, 7, /* 6981: struct.bio_st */
            	6804, 0,
            	6868, 8,
            	26, 16,
            	5, 48,
            	...
            	6998, 64,
            	4883, 96,
            1, 8, 1, /* 6998: pointer.struct.bio_st */
            	6981, 0,
            1, 8, 1, /* 7003: pointer.struct.ssl2_state_st */
            	6847, 0,
            ...
            0, 1200, 10, /* 7013: struct.ssl3_state_st */
            	...
            	5, 512,
            	7133, 528,
            1, 8, 1, /* 7036: pointer.pointer.struct.env_md_ctx_st */
            	7041, 0,
            1, 8, 1, /* 7041: pointer.struct.env_md_ctx_st */
            	7046, 0,
            0, 48, 5, /* 7046: struct.env_md_ctx_st */
            	6037, 0,
            	5663, 8,
            	5, 24,
            	7059, 32,
            	6064, 40,
            1, 8, 1, /* 7059: pointer.struct.evp_pkey_ctx_st */
            	7064, 0,
            0, 80, 8, /* 7064: struct.evp_pkey_ctx_st */
            	6842, 0,
            	6632, 8,
            	7083, 16,
            	7083, 24,
            	...
            	6839, 56,
            	7128, 64,
            1, 8, 1, /* 7083: pointer.struct.evp_pkey_st */
            	7088, 0,
            0, 56, 4, /* 7088: struct.evp_pkey_st */
            	7099, 16,
            	6632, 24,
            	6645, 32,
            	7104, 48,
            1, 8, 1, /* 7099: pointer.struct.evp_pkey_asn1_method_st */
            	823, 0,
            1, 8, 1, /* 7104: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7109, 0,
            0, 32, 2, /* 7109: struct.stack_st_fake_X509_ATTRIBUTE */
            	7116, 8,
            	125, 24,
            8884099, 8, 2, /* 7116: pointer_to_array_of_pointers_to_stack */
            	7123, 0,
            	122, 20,
            0, 8, 1, /* 7123: pointer.X509_ATTRIBUTE */
            	2240, 0,
            1, 8, 1, /* 7128: pointer.int */
            	122, 0,
            0, 528, 8, /* 7133: struct.unknown */
            	6018, 408,
            	7152, 416,
            	5780, 424,
            	6079, 464,
            	...
            	6037, 496,
            	7194, 512,
            1, 8, 1, /* 7152: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 7157: pointer.struct.evp_cipher_st */
            	7162, 0,
            0, 88, 7, /* 7162: struct.evp_cipher_st */
            	7179, 24,
            	7182, 32,
            	7185, 40,
            	7188, 56,
            ...
            8884097, 8, 0, /* 7191: pointer.func */
            1, 8, 1, /* 7194: pointer.struct.ssl_comp_st */
            	7199, 0,
            0, 24, 2, /* 7199: struct.ssl_comp_st */
            	102, 8,
            	7206, 16,
            1, 8, 1, /* 7206: pointer.struct.comp_method_st */
            	7211, 0,
            0, 64, 7, /* 7211: struct.comp_method_st */
            	102, 8,
            	7228, 16,
            	7231, 24,
            	6642, 32,
            	...
            	226, 48,
            	226, 56,
            8884097, 8, 0, /* 7228: pointer.func */
            8884097, 8, 0, /* 7231: pointer.func */
            1, 8, 1, /* 7234: pointer.struct.dtls1_state_st */
            	7239, 0,
            0, 888, 7, /* 7239: struct.dtls1_state_st */
            	7256, 576,
            	7256, 592,
            	7261, 608,
            	7261, 616,
            	...
            	7288, 648,
            	7288, 736,
            0, 16, 1, /* 7256: struct.record_pqueue_st */
            	7261, 8,
            1, 8, 1, /* 7261: pointer.struct._pqueue */
            	7266, 0,
            0, 16, 1, /* 7266: struct._pqueue */
            	7271, 0,
            1, 8, 1, /* 7271: pointer.struct._pitem */
            	7276, 0,
            0, 24, 2, /* 7276: struct._pitem */
            	5, 8,
            	7283, 16,
            1, 8, 1, /* 7283: pointer.struct._pitem */
            	7276, 0,
            0, 88, 1, /* 7288: struct.hm_header_st */
            	7293, 48,
            0, 40, 4, /* 7293: struct.dtls1_retransmit_state */
            	7304, 0,
            	7041, 8,
            	7320, 16,
            	7332, 24,
            1, 8, 1, /* 7304: pointer.struct.evp_cipher_ctx_st */
            	7309, 0,
            0, 168, 4, /* 7309: struct.evp_cipher_ctx_st */
            	7157, 0,
            	5663, 8,
            	5, 96,
            	5, 120,
