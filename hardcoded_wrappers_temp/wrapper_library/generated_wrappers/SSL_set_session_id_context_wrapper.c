    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 5159: pointer.struct.ssl_comp_st */
            	3960, 0,
            0, 232, 28, /* 5164: struct.ssl_method_st */
            	5057, 8,
            	5223, 16,
            	5223, 24,
            	5057, 32,
            	...
            	4104, 216,
            	5262, 224,
            8884097, 8, 0, /* 5223: pointer.func */
            8884097, 8, 0, /* 5226: pointer.func */
            ...
            8884097, 8, 0, /* 5244: pointer.func */
            8884097, 8, 0, /* 5247: pointer.func */
            8884097, 8, 0, /* 5250: pointer.func */
            8884097, 8, 0, /* 5253: pointer.func */
            8884097, 8, 0, /* 5256: pointer.func */
            8884097, 8, 0, /* 5259: pointer.func */
            8884097, 8, 0, /* 5262: pointer.func */
            8884097, 8, 0, /* 5265: pointer.func */
            0, 88, 1, /* 5268: struct.hm_header_st */
            	4954, 48,
            0, 888, 7, /* 5273: struct.dtls1_state_st */
            	5007, 576,
            	5007, 592,
            	4999, 608,
            	4999, 616,
            	...
            	5268, 648,
            	5268, 736,
            0, 736, 50, /* 5290: struct.ssl_ctx_st */
            	5393, 0,
            	4858, 8,
            	4858, 16,
            	5398, 24,
            	...
            	273, 720,
            	5540, 728,
            1, 8, 1, /* 5393: pointer.struct.ssl_method_st */
            	5164, 0,
            1, 8, 1, /* 5398: pointer.struct.x509_store_st */
            	5403, 0,
            0, 144, 15, /* 5403: struct.x509_store_st */
            	5436, 8,
            	2484, 16,
            	5460, 24,
            	437, 32,
            	...
            	437, 112,
            	2629, 120,
            1, 8, 1, /* 5436: pointer.struct.stack_st_X509_OBJECT */
            	5441, 0,
            0, 32, 2, /* 5441: struct.stack_st_fake_X509_OBJECT */
            	5448, 8,
            	86, 24,
            8884099, 8, 2, /* 5448: pointer_to_array_of_pointers_to_stack */
            	5455, 0,
            	83, 20,
            0, 8, 1, /* 5455: pointer.X509_OBJECT */
            	613, 0,
            1, 8, 1, /* 5460: pointer.struct.X509_VERIFY_PARAM_st */
            	5465, 0,
            0, 56, 2, /* 5465: struct.X509_VERIFY_PARAM_st */
            	99, 0,
            	3663, 48,
            8884097, 8, 0, /* 5472: pointer.func */
            8884097, 8, 0, /* 5475: pointer.func */
            8884097, 8, 0, /* 5478: pointer.func */
            8884097, 8, 0, /* 5481: pointer.func */
            8884097, 8, 0, /* 5484: pointer.func */
            1, 8, 1, /* 5487: pointer.struct.cert_st */
            	5492, 0,
            0, 296, 7, /* 5492: struct.cert_st */
            	4741, 0,
            	2524, 48,
            	5509, 56,
            	4802, 64,
            	...
            	4807, 80,
            	5512, 88,
            8884097, 8, 0, /* 5509: pointer.func */
            8884097, 8, 0, /* 5512: pointer.func */
            8884097, 8, 0, /* 5515: pointer.func */
            8884097, 8, 0, /* 5518: pointer.func */
            8884097, 8, 0, /* 5521: pointer.func */
            8884097, 8, 0, /* 5524: pointer.func */
            1, 8, 1, /* 5527: pointer.struct.ssl3_buf_freelist_st */
            	5532, 0,
            0, 24, 1, /* 5532: struct.ssl3_buf_freelist_st */
            	303, 16,
            8884097, 8, 0, /* 5537: pointer.func */
            1, 8, 1, /* 5540: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	5545, 0,
            0, 32, 2, /* 5545: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	5552, 8,
            	86, 24,
            8884099, 8, 2, /* 5552: pointer_to_array_of_pointers_to_stack */
            	5559, 0,
            	83, 20,
            0, 8, 1, /* 5559: pointer.SRTP_PROTECTION_PROFILE */
            	229, 0,
            1, 8, 1, /* 5564: pointer.struct.ssl_st */
            	5569, 0,
            0, 808, 51, /* 5569: struct.ssl_st */
            	5393, 8,
            	4317, 16,
            	4317, 24,
            	4317, 32,
            	...
            	5721, 656,
            	242, 680,
            1, 8, 1, /* 5674: pointer.struct.ssl2_state_st */
            	5679, 0,
            0, 344, 9, /* 5679: struct.ssl2_state_st */
            	60, 24,
            	78, 56,
            	78, 64,
            	78, 72,
            	...
            	78, 128,
            	78, 136,
            1, 8, 1, /* 5700: pointer.struct.ssl3_state_st */
            	5074, 0,
            1, 8, 1, /* 5705: pointer.struct.dtls1_state_st */
            	5273, 0,
            1, 8, 1, /* 5710: pointer.struct.ssl_ctx_st */
            	5290, 0,
