...
void bb_EVP_MD_CTX_destroy(EVP_MD_CTX * arg_a) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 116: pointer.struct.evp_pkey_asn1_method_st */
            	39, 0,
            0, 56, 4, /* 121: struct.evp_pkey_st */
            	116, 16,
            	132, 24,
            	8, 32,
            	458, 48,
            ...
            0, 1, 0, /* 606: char */
            1, 8, 1, /* 609: pointer.struct.env_md_ctx_st */
            	614, 0,
            0, 48, 5, /* 614: struct.env_md_ctx_st */
            	627, 0,
            	132, 8,
            	13, 24,
            	598, 32,
            	654, 40,
            1, 8, 1, /* 627: pointer.struct.env_md_st */
            	632, 0,
            0, 120, 8, /* 632: struct.env_md_st */
            	651, 24,
            	654, 32,
            	657, 40,
            	660, 48,
