...
void bb_EVP_MD_CTX_destroy(EVP_MD_CTX * arg_a) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 2017: pointer.struct.env_md_ctx_st */
            	2022, 0,
            0, 48, 5, /* 2022: struct.env_md_ctx_st */
            	2035, 0,
            	1364, 8,
            	405, 24,
            	1917, 32,
            	2062, 40,
            1, 8, 1, /* 2035: pointer.struct.env_md_st */
            	2040, 0,
            0, 120, 8, /* 2040: struct.env_md_st */
            	2059, 24,
            	2062, 32,
            	2065, 40,
            	762, 48,
            ...
            8884097, 8, 0, /* 2062: pointer.func */
            8884097, 8, 0, /* 2065: pointer.func */
            8884097, 8, 0, /* 2068: pointer.func */
            8884097, 8, 0, /* 2071: pointer.func */
        },
        .arg_entity_index = { 2017, },
        .ret_entity_index = -1,
    };
