...
void bb_SSL_free(SSL * arg_a) 
{
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 344, 9, /* 6774: struct.ssl2_state_st */
            	107, 24,
            	13, 56,
            	13, 64,
            	13, 72,
            	...
            	13, 128,
            	13, 136,
            8884097, 8, 0, /* 6795: pointer.func */
            1, 8, 1, /* 6798: pointer.struct.stack_st_OCSP_RESPID */
            	6803, 0,
            0, 32, 2, /* 6803: struct.stack_st_fake_OCSP_RESPID */
            	6810, 8,
            	125, 24,
            8884099, 8, 2, /* 6810: pointer_to_array_of_pointers_to_stack */
            	6817, 0,
            	122, 20,
            0, 8, 1, /* 6817: pointer.OCSP_RESPID */
            	138, 0,
            8884097, 8, 0, /* 6822: pointer.func */
            1, 8, 1, /* 6825: pointer.struct.bio_method_st */
            	6830, 0,
            0, 80, 9, /* 6830: struct.bio_method_st */
            	102, 8,
            	6795, 16,
            	6822, 24,
            	6679, 32,
            	...
            	6854, 64,
            	6857, 72,
            8884097, 8, 0, /* 6851: pointer.func */
            8884097, 8, 0, /* 6854: pointer.func */
            8884097, 8, 0, /* 6857: pointer.func */
            8884097, 8, 0, /* 6860: pointer.func */
            1, 8, 1, /* 6863: pointer.struct.evp_cipher_ctx_st */
            	6868, 0,
            0, 168, 4, /* 6868: struct.evp_cipher_ctx_st */
            	6879, 0,
            	5663, 8,
            	5, 96,
            	5, 120,
            1, 8, 1, /* 6879: pointer.struct.evp_cipher_st */
            	6884, 0,
            0, 88, 7, /* 6884: struct.evp_cipher_st */
            	6901, 24,
            	6904, 32,
            	6907, 40,
            	6910, 56,
            ...
            8884097, 8, 0, /* 6904: pointer.func */
            8884097, 8, 0, /* 6907: pointer.func */
            8884097, 8, 0, /* 6910: pointer.func */
            8884097, 8, 0, /* 6913: pointer.func */
            0, 112, 7, /* 6916: struct.bio_st */
            	6825, 0,
            	6933, 8,
            	26, 16,
            	5, 48,
            	...
            	6936, 64,
            	4883, 96,
            8884097, 8, 0, /* 6933: pointer.func */
            1, 8, 1, /* 6936: pointer.struct.bio_st */
            	6916, 0,
            1, 8, 1, /* 6941: pointer.struct.bio_st */
            	6916, 0,
            0, 808, 51, /* 6946: struct.ssl_st */
            	5008, 8,
            	6941, 16,
            	6941, 24,
            	6941, 32,
            	...
            	7351, 656,
            	6564, 680,
            1, 8, 1, /* 7051: pointer.struct.ssl2_state_st */
            	6774, 0,
            1, 8, 1, /* 7056: pointer.struct.ssl3_state_st */
            	7061, 0,
            0, 1200, 10, /* 7061: struct.ssl3_state_st */
            	6637, 240,
            	6637, 264,
            	6682, 288,
            	6682, 344,
            	...
            	5, 512,
            	7186, 528,
            1, 8, 1, /* 7084: pointer.pointer.struct.env_md_ctx_st */
            	7089, 0,
            1, 8, 1, /* 7089: pointer.struct.env_md_ctx_st */
            	7094, 0,
            0, 48, 5, /* 7094: struct.env_md_ctx_st */
            	6037, 0,
            	5663, 8,
            	5, 24,
            	7107, 32,
            	6064, 40,
            1, 8, 1, /* 7107: pointer.struct.evp_pkey_ctx_st */
            	7112, 0,
            0, 80, 8, /* 7112: struct.evp_pkey_ctx_st */
            	7131, 0,
            	6632, 8,
            	7136, 16,
            	7136, 24,
            	...
            	6860, 56,
            	7181, 64,
            1, 8, 1, /* 7131: pointer.struct.evp_pkey_method_st */
            	6694, 0,
            1, 8, 1, /* 7136: pointer.struct.evp_pkey_st */
            	7141, 0,
            0, 56, 4, /* 7141: struct.evp_pkey_st */
            	7152, 16,
            	6632, 24,
            	6645, 32,
            	7157, 48,
            1, 8, 1, /* 7152: pointer.struct.evp_pkey_asn1_method_st */
            	823, 0,
            1, 8, 1, /* 7157: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7162, 0,
            0, 32, 2, /* 7162: struct.stack_st_fake_X509_ATTRIBUTE */
            	7169, 8,
            	125, 24,
            8884099, 8, 2, /* 7169: pointer_to_array_of_pointers_to_stack */
            	7176, 0,
            	122, 20,
            0, 8, 1, /* 7176: pointer.X509_ATTRIBUTE */
            	2240, 0,
            1, 8, 1, /* 7181: pointer.int */
            	122, 0,
            0, 528, 8, /* 7186: struct.unknown */
            	6018, 408,
            	7205, 416,
            	5780, 424,
            	6079, 464,
            	...
            	6037, 496,
            	7210, 512,
            1, 8, 1, /* 7205: pointer.struct.dh_st */
            	1619, 0,
            1, 8, 1, /* 7210: pointer.struct.ssl_comp_st */
            	7215, 0,
            0, 24, 2, /* 7215: struct.ssl_comp_st */
            	102, 8,
            	7222, 16,
            1, 8, 1, /* 7222: pointer.struct.comp_method_st */
            	7227, 0,
            0, 64, 7, /* 7227: struct.comp_method_st */
            	102, 8,
            	7244, 16,
            	7247, 24,
            	6642, 32,
            	...
            	226, 48,
            	226, 56,
            8884097, 8, 0, /* 7244: pointer.func */
            8884097, 8, 0, /* 7247: pointer.func */
            1, 8, 1, /* 7250: pointer.struct.dtls1_state_st */
            	7255, 0,
            0, 888, 7, /* 7255: struct.dtls1_state_st */
            	7272, 576,
            	7272, 592,
            	7277, 608,
            	7277, 616,
            	...
            	7304, 648,
            	7304, 736,
            0, 16, 1, /* 7272: struct.record_pqueue_st */
            	7277, 8,
            1, 8, 1, /* 7277: pointer.struct._pqueue */
            	7282, 0,
            0, 16, 1, /* 7282: struct._pqueue */
            	7287, 0,
            1, 8, 1, /* 7287: pointer.struct._pitem */
            	7292, 0,
            0, 24, 2, /* 7292: struct._pitem */
            	5, 8,
            	7299, 16,
            1, 8, 1, /* 7299: pointer.struct._pitem */
            	7292, 0,
            0, 88, 1, /* 7304: struct.hm_header_st */
            	7309, 48,
            0, 40, 4, /* 7309: struct.dtls1_retransmit_state */
            	6863, 0,
            	7089, 8,
            	7320, 16,
            	7332, 24,
            1, 8, 1, /* 7320: pointer.struct.comp_ctx_st */
            	7325, 0,
            0, 56, 2, /* 7325: struct.comp_ctx_st */
            	7222, 0,
            	4883, 40,
            1, 8, 1, /* 7332: pointer.struct.ssl_session_st */
            	5213, 0,
            8884097, 8, 0, /* 7337: pointer.func */
            1, 8, 1, /* 7340: pointer.struct.tls_session_ticket_ext_st */
            	0, 0,
            8884097, 8, 0, /* 7345: pointer.func */
            8884097, 8, 0, /* 7348: pointer.func */
            1, 8, 1, /* 7351: pointer.struct.srtp_protection_profile_st */
            	4445, 0,
            0, 1, 0, /* 7356: char */
            1, 8, 1, /* 7359: pointer.struct.ssl_st */
            	6946, 0,
        },
        .arg_entity_index = { 7359, },
        .ret_entity_index = -1,
    };
