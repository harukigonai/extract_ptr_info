...
int bb_EVP_EncryptInit_ex(EVP_CIPHER_CTX * arg_a,const EVP_CIPHER * arg_b,ENGINE * arg_c,const unsigned char * arg_d,const unsigned char * arg_e) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 46: pointer.struct.evp_cipher_ctx_st */
            	51, 0,
            0, 168, 4, /* 51: struct.evp_cipher_ctx_st */
            	62, 0,
            	67, 8,
            	35, 96,
            	35, 120,
            1, 8, 1, /* 62: pointer.struct.evp_cipher_st */
            	3, 0,
            1, 8, 1, /* 67: pointer.struct.engine_st */
            	72, 0,
            0, 0, 0, /* 72: struct.engine_st */
        },
        .arg_entity_index = { 46, 62, 67, 38, 38, },
        .ret_entity_index = 0,
    };
