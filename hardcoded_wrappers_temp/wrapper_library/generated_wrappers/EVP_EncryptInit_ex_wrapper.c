...
{
    if (syscall(890))
        return _EVP_EncryptInit_ex(arg_a,arg_b,arg_c,arg_d,arg_e);
    else {
...
int _EVP_EncryptInit_ex(EVP_CIPHER_CTX * arg_a,const EVP_CIPHER * arg_b,ENGINE * arg_c,const unsigned char * arg_d,const unsigned char * arg_e) 
{
