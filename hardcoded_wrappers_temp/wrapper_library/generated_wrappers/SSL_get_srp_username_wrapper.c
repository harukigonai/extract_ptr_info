...
char * bb_SSL_get_srp_username(SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 7320: pointer.struct.ssl3_state_st */
            	7160, 0,
            0, 808, 51, /* 7325: struct.ssl_st */
            	4621, 8,
            	7197, 16,
            	7197, 24,
            	7197, 32,
            	...
            	6793, 656,
            	6727, 680,
            1, 8, 1, /* 7430: pointer.struct.ssl2_state_st */
            	7435, 0,
            0, 344, 9, /* 7435: struct.ssl2_state_st */
            	99, 24,
            	117, 56,
            	117, 64,
            	117, 72,
            	...
            	117, 128,
            	117, 136,
            1, 8, 1, /* 7456: pointer.struct.dtls1_state_st */
            	7461, 0,
            0, 888, 7, /* 7461: struct.dtls1_state_st */
            	6894, 576,
            	6894, 592,
            	6899, 608,
            	6899, 616,
            	...
            	7478, 648,
            	7478, 736,
            0, 88, 1, /* 7478: struct.hm_header_st */
            	7483, 48,
            0, 40, 4, /* 7483: struct.dtls1_retransmit_state */
            	7494, 0,
            	7207, 8,
            	7510, 16,
            	7522, 24,
            1, 8, 1, /* 7494: pointer.struct.evp_cipher_ctx_st */
            	7499, 0,
            0, 168, 4, /* 7499: struct.evp_cipher_ctx_st */
            	7249, 0,
            	5726, 8,
            	15, 96,
            	15, 120,
            1, 8, 1, /* 7510: pointer.struct.comp_ctx_st */
            	7515, 0,
            0, 56, 2, /* 7515: struct.comp_ctx_st */
            	7295, 0,
            	4907, 40,
            1, 8, 1, /* 7522: pointer.struct.ssl_session_st */
            	4934, 0,
        ...
        .arg_entity_index = { 7539, },
        .ret_entity_index = 138,
    };
