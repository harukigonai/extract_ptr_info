    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            8884099, 8, 2, /* 4501: pointer_to_array_of_pointers_to_stack */
            	4508, 0,
            	453, 20,
            0, 8, 1, /* 4508: pointer.SRTP_PROTECTION_PROFILE */
            	0, 0,
            1, 8, 1, /* 4513: pointer.struct.x509_store_st */
            	4518, 0,
            0, 144, 15, /* 4518: struct.x509_store_st */
            	4366, 8,
            	4551, 16,
            	4760, 24,
            	4772, 32,
            	...
            	4772, 112,
            	642, 120,
            1, 8, 1, /* 4551: pointer.struct.stack_st_X509_LOOKUP */
            	4556, 0,
            0, 32, 2, /* 4556: struct.stack_st_fake_X509_LOOKUP */
            	4563, 8,
            	456, 24,
            8884099, 8, 2, /* 4563: pointer_to_array_of_pointers_to_stack */
            	4570, 0,
            	453, 20,
            0, 8, 1, /* 4570: pointer.X509_LOOKUP */
            	4575, 0,
            0, 0, 1, /* 4575: X509_LOOKUP */
            	4580, 0,
            0, 32, 3, /* 4580: struct.x509_lookup_st */
            	4589, 8,
            	61, 16,
            	4635, 24,
            1, 8, 1, /* 4589: pointer.struct.x509_lookup_method_st */
            	4594, 0,
            0, 80, 10, /* 4594: struct.x509_lookup_method_st */
            	10, 0,
            	4617, 8,
            	2868, 16,
            	4617, 24,
            ...
            0, 88, 1, /* 4822: struct.ssl_cipher_st */
            	10, 8,
            1, 8, 1, /* 4827: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4832, 0,
            0, 32, 2, /* 4832: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	4501, 8,
            	456, 24,
            1, 8, 1, /* 4839: pointer.struct.ssl_ctx_st */
            	4844, 0,
            0, 736, 50, /* 4844: struct.ssl_ctx_st */
            	4390, 0,
            	4793, 8,
            	4793, 16,
            	4513, 24,
            	...
            	49, 720,
            	4827, 728,
            1, 8, 1, /* 4947: pointer.struct.lhash_st */
            	4952, 0,
            0, 176, 3, /* 4952: struct.lhash_st */
            	4961, 0,
            	456, 8,
            	4983, 16,
            1, 8, 1, /* 4961: pointer.pointer.struct.lhash_node_st */
            	4966, 0,
            1, 8, 1, /* 4966: pointer.struct.lhash_node_st */
            	4971, 0,
            0, 24, 2, /* 4971: struct.lhash_node_st */
            	49, 0,
            	4978, 8,
            1, 8, 1, /* 4978: pointer.struct.lhash_node_st */
            	4971, 0,
            8884097, 8, 0, /* 4983: pointer.func */
            1, 8, 1, /* 4986: pointer.struct.ssl_session_st */
            	4991, 0,
            ...
            0, 184, 12, /* 5069: struct.x509_st */
            	...
            	5162, 144,
            	5167, 176,
            1, 8, 1, /* 5096: pointer.struct.x509_cinf_st */
            	2926, 0,
            1, 8, 1, /* 5101: pointer.struct.AUTHORITY_KEYID_st */
            	5106, 0,
            0, 0, 0, /* 5106: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 5109: pointer.struct.X509_POLICY_CACHE_st */
            	3600, 0,
            1, 8, 1, /* 5114: pointer.struct.stack_st_DIST_POINT */
            	5119, 0,
            0, 32, 2, /* 5119: struct.stack_st_fake_DIST_POINT */
            	5126, 8,
            	456, 24,
            8884099, 8, 2, /* 5126: pointer_to_array_of_pointers_to_stack */
            	5133, 0,
            	453, 20,
            0, 8, 1, /* 5133: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 5138: pointer.struct.stack_st_GENERAL_NAME */
            	5143, 0,
            0, 32, 2, /* 5143: struct.stack_st_fake_GENERAL_NAME */
            	5150, 8,
            	456, 24,
            8884099, 8, 2, /* 5150: pointer_to_array_of_pointers_to_stack */
            	5157, 0,
            	453, 20,
            0, 8, 1, /* 5157: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 5162: pointer.struct.NAME_CONSTRAINTS_st */
            	4222, 0,
            1, 8, 1, /* 5167: pointer.struct.x509_cert_aux_st */
            	5172, 0,
            0, 40, 5, /* 5172: struct.x509_cert_aux_st */
            	5185, 0,
            	5185, 8,
            	3105, 16,
            	3055, 24,
            	5209, 32,
            1, 8, 1, /* 5185: pointer.struct.stack_st_ASN1_OBJECT */
            	5190, 0,
            0, 32, 2, /* 5190: struct.stack_st_fake_ASN1_OBJECT */
            	5197, 8,
            	456, 24,
            8884099, 8, 2, /* 5197: pointer_to_array_of_pointers_to_stack */
            	5204, 0,
            	453, 20,
            0, 8, 1, /* 5204: pointer.ASN1_OBJECT */
            	2125, 0,
            1, 8, 1, /* 5209: pointer.struct.stack_st_X509_ALGOR */
            	5214, 0,
            0, 32, 2, /* 5214: struct.stack_st_fake_X509_ALGOR */
            	5221, 8,
            	456, 24,
            8884099, 8, 2, /* 5221: pointer_to_array_of_pointers_to_stack */
            	5228, 0,
            	453, 20,
            0, 8, 1, /* 5228: pointer.X509_ALGOR */
            	2163, 0,
            8884097, 8, 0, /* 5233: pointer.func */
            8884097, 8, 0, /* 5236: pointer.func */
            8884097, 8, 0, /* 5239: pointer.func */
            8884097, 8, 0, /* 5242: pointer.func */
            1, 8, 1, /* 5245: pointer.struct.stack_st_X509_NAME */
            	5250, 0,
            0, 32, 2, /* 5250: struct.stack_st_fake_X509_NAME */
            	5257, 8,
            	456, 24,
            8884099, 8, 2, /* 5257: pointer_to_array_of_pointers_to_stack */
            	5264, 0,
            	453, 20,
            0, 8, 1, /* 5264: pointer.X509_NAME */
            	2520, 0,
            8884097, 8, 0, /* 5269: pointer.func */
