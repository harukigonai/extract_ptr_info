...
int bb_SSL_CTX_check_private_key(const SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 8, 1, /* 6348: pointer.SRTP_PROTECTION_PROFILE */
            	10, 0,
            0, 32, 2, /* 6353: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	6360, 8,
            	193, 24,
            8884099, 8, 2, /* 6360: pointer_to_array_of_pointers_to_stack */
            	6348, 0,
            	33, 20,
            ...
            0, 0, 1, /* 6379: SSL_CIPHER */
            	6384, 0,
            0, 88, 1, /* 6384: struct.ssl_cipher_st */
            	5, 8,
            0, 144, 15, /* 6389: struct.x509_store_st */
            	6422, 8,
            	6270, 16,
            	6446, 24,
            	5289, 32,
            	...
            	5289, 112,
            	5223, 120,
            1, 8, 1, /* 6422: pointer.struct.stack_st_X509_OBJECT */
            	6427, 0,
            0, 32, 2, /* 6427: struct.stack_st_fake_X509_OBJECT */
            	6434, 8,
            	193, 24,
            8884099, 8, 2, /* 6434: pointer_to_array_of_pointers_to_stack */
            	6441, 0,
            	33, 20,
            0, 8, 1, /* 6441: pointer.X509_OBJECT */
            	5496, 0,
            1, 8, 1, /* 6446: pointer.struct.X509_VERIFY_PARAM_st */
            	5292, 0,
            8884097, 8, 0, /* 6451: pointer.func */
            8884097, 8, 0, /* 6454: pointer.func */
            8884097, 8, 0, /* 6457: pointer.func */
            8884097, 8, 0, /* 6460: pointer.func */
            1, 8, 1, /* 6463: pointer.struct.ssl_ctx_st */
            	6468, 0,
            0, 736, 50, /* 6468: struct.ssl_ctx_st */
            	6571, 0,
            	6719, 8,
            	6719, 16,
            	6743, 24,
            	...
            	72, 720,
            	6814, 728,
            1, 8, 1, /* 6571: pointer.struct.ssl_method_st */
            	6576, 0,
            0, 232, 28, /* 6576: struct.ssl_method_st */
            	6339, 8,
            	6635, 16,
            	6635, 24,
            	6339, 32,
            ...
            8884097, 8, 0, /* 6650: pointer.func */
            8884097, 8, 0, /* 6653: pointer.func */
            8884097, 8, 0, /* 6656: pointer.func */
            8884097, 8, 0, /* 6659: pointer.func */
            8884097, 8, 0, /* 6662: pointer.func */
            1, 8, 1, /* 6665: pointer.struct.ssl3_enc_method */
            	6670, 0,
            0, 112, 11, /* 6670: struct.ssl3_enc_method */
            	6695, 0,
            	6698, 8,
            	6701, 16,
            	6704, 24,
            ...
            8884097, 8, 0, /* 6713: pointer.func */
            8884097, 8, 0, /* 6716: pointer.func */
            1, 8, 1, /* 6719: pointer.struct.stack_st_SSL_CIPHER */
            	6724, 0,
            0, 32, 2, /* 6724: struct.stack_st_fake_SSL_CIPHER */
            	6731, 8,
            	193, 24,
            8884099, 8, 2, /* 6731: pointer_to_array_of_pointers_to_stack */
            	6738, 0,
            	33, 20,
            0, 8, 1, /* 6738: pointer.SSL_CIPHER */
            	6379, 0,
            1, 8, 1, /* 6743: pointer.struct.x509_store_st */
            	6389, 0,
            ...
            1, 8, 1, /* 6792: pointer.struct.env_md_st */
            	4452, 0,
            8884097, 8, 0, /* 6797: pointer.func */
            8884097, 8, 0, /* 6800: pointer.func */
            8884097, 8, 0, /* 6803: pointer.func */
            1, 8, 1, /* 6806: pointer.struct.ssl3_buf_freelist_st */
            	2546, 0,
            8884097, 8, 0, /* 6811: pointer.func */
            1, 8, 1, /* 6814: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	6353, 0,
            0, 1, 0, /* 6819: char */
        },
        .arg_entity_index = { 6463, },
        .ret_entity_index = 33,
    };
