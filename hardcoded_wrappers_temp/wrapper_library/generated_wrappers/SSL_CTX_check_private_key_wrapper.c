...
int bb_SSL_CTX_check_private_key(const SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 32, 2, /* 4499: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	4506, 8,
            	456, 24,
            64099, 8, 2, /* 4506: pointer_to_array_of_pointers_to_stack */
            	4339, 0,
            	453, 20,
            1, 8, 1, /* 4513: pointer.struct.stack_st_X509_ALGOR */
            	4518, 0,
            0, 32, 2, /* 4518: struct.stack_st_fake_X509_ALGOR */
            	4525, 8,
            	456, 24,
            64099, 8, 2, /* 4525: pointer_to_array_of_pointers_to_stack */
            	4532, 0,
            	453, 20,
            0, 8, 1, /* 4532: pointer.X509_ALGOR */
            	2163, 0,
            1, 8, 1, /* 4537: pointer.struct.x509_store_st */
            	4542, 0,
            0, 144, 15, /* 4542: struct.x509_store_st */
            	4361, 8,
            	4575, 16,
            	4784, 24,
            	4796, 32,
            	...
            	4796, 112,
            	642, 120,
            1, 8, 1, /* 4575: pointer.struct.stack_st_X509_LOOKUP */
            	4580, 0,
            0, 32, 2, /* 4580: struct.stack_st_fake_X509_LOOKUP */
            	4587, 8,
            	456, 24,
            64099, 8, 2, /* 4587: pointer_to_array_of_pointers_to_stack */
            	4594, 0,
            	453, 20,
            0, 8, 1, /* 4594: pointer.X509_LOOKUP */
            	4599, 0,
            0, 0, 1, /* 4599: X509_LOOKUP */
            	4604, 0,
            0, 32, 3, /* 4604: struct.x509_lookup_st */
            	4613, 8,
            	61, 16,
            	4659, 24,
            1, 8, 1, /* 4613: pointer.struct.x509_lookup_method_st */
            	4618, 0,
            0, 80, 10, /* 4618: struct.x509_lookup_method_st */
            	10, 0,
            	4641, 8,
            	2858, 16,
            	4641, 24,
            ...
            64097, 8, 0, /* 4656: pointer.func */
            1, 8, 1, /* 4659: pointer.struct.x509_store_st */
            	4664, 0,
            0, 144, 15, /* 4664: struct.x509_store_st */
            	4697, 8,
            	4721, 16,
            	4745, 24,
            	4757, 32,
            	...
            	4757, 112,
            	2523, 120,
            1, 8, 1, /* 4697: pointer.struct.stack_st_X509_OBJECT */
            	4702, 0,
            0, 32, 2, /* 4702: struct.stack_st_fake_X509_OBJECT */
            	4709, 8,
            	456, 24,
            64099, 8, 2, /* 4709: pointer_to_array_of_pointers_to_stack */
            	4716, 0,
            	453, 20,
            0, 8, 1, /* 4716: pointer.X509_OBJECT */
            	4356, 0,
            1, 8, 1, /* 4721: pointer.struct.stack_st_X509_LOOKUP */
            	4726, 0,
            0, 32, 2, /* 4726: struct.stack_st_fake_X509_LOOKUP */
            	4733, 8,
            	456, 24,
            64099, 8, 2, /* 4733: pointer_to_array_of_pointers_to_stack */
            	4740, 0,
            	453, 20,
            0, 8, 1, /* 4740: pointer.X509_LOOKUP */
            	4599, 0,
            1, 8, 1, /* 4745: pointer.struct.X509_VERIFY_PARAM_st */
            	4750, 0,
            0, 56, 2, /* 4750: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	3402, 48,
            ...
            1, 8, 1, /* 4784: pointer.struct.X509_VERIFY_PARAM_st */
            	4789, 0,
            0, 56, 2, /* 4789: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	2101, 48,
            64097, 8, 0, /* 4796: pointer.func */
            64097, 8, 0, /* 4799: pointer.func */
            64097, 8, 0, /* 4802: pointer.func */
            64097, 8, 0, /* 4805: pointer.func */
            64097, 8, 0, /* 4808: pointer.func */
            64097, 8, 0, /* 4811: pointer.func */
            64097, 8, 0, /* 4814: pointer.func */
            ...
            1, 8, 1, /* 4851: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4499, 0,
            1, 8, 1, /* 4856: pointer.struct.ssl_ctx_st */
            	4861, 0,
            0, 736, 50, /* 4861: struct.ssl_ctx_st */
            	4385, 0,
            	4817, 8,
            	4817, 16,
            	4537, 24,
            	...
            	49, 720,
            	4851, 728,
            1, 8, 1, /* 4964: pointer.struct.lhash_st */
            	4969, 0,
            0, 176, 3, /* 4969: struct.lhash_st */
            	4978, 0,
            	456, 8,
            	4347, 16,
            1, 8, 1, /* 4978: pointer.pointer.struct.lhash_node_st */
            	4983, 0,
            1, 8, 1, /* 4983: pointer.struct.lhash_node_st */
            	4988, 0,
            0, 24, 2, /* 4988: struct.lhash_node_st */
            	49, 0,
            	4995, 8,
            1, 8, 1, /* 4995: pointer.struct.lhash_node_st */
            	4988, 0,
            1, 8, 1, /* 5000: pointer.struct.ssl_session_st */
            	5005, 0,
            0, 352, 14, /* 5005: struct.ssl_session_st */
            	61, 144,
            	61, 152,
            	5036, 168,
            	137, 176,
            	...
            	209, 320,
            	61, 344,
            1, 8, 1, /* 5036: pointer.struct.sess_cert_st */
            	5041, 0,
            0, 248, 5, /* 5041: struct.sess_cert_st */
            	5054, 0,
            	123, 16,
            	2367, 216,
            	2375, 224,
            	2380, 232,
            1, 8, 1, /* 5054: pointer.struct.stack_st_X509 */
            	5059, 0,
            0, 32, 2, /* 5059: struct.stack_st_fake_X509 */
            	5066, 8,
            	456, 24,
            64099, 8, 2, /* 5066: pointer_to_array_of_pointers_to_stack */
            	5073, 0,
            	453, 20,
            0, 8, 1, /* 5073: pointer.X509 */
            	5078, 0,
            0, 0, 1, /* 5078: X509 */
            	5083, 0,
            0, 184, 12, /* 5083: struct.x509_st */
            	5110, 0,
            	3697, 8,
            	3786, 16,
            	61, 32,
            	...
            	5176, 144,
            	5181, 176,
            1, 8, 1, /* 5110: pointer.struct.x509_cinf_st */
            	3662, 0,
            1, 8, 1, /* 5115: pointer.struct.AUTHORITY_KEYID_st */
            	5120, 0,
            0, 0, 0, /* 5120: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 5123: pointer.struct.X509_POLICY_CACHE_st */
            	4333, 0,
            ...
            0, 32, 2, /* 5133: struct.stack_st_fake_DIST_POINT */
            	5140, 8,
            	456, 24,
            64099, 8, 2, /* 5140: pointer_to_array_of_pointers_to_stack */
            	5147, 0,
            	453, 20,
            0, 8, 1, /* 5147: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 5152: pointer.struct.stack_st_GENERAL_NAME */
            	5157, 0,
            0, 32, 2, /* 5157: struct.stack_st_fake_GENERAL_NAME */
            	5164, 8,
            	456, 24,
            64099, 8, 2, /* 5164: pointer_to_array_of_pointers_to_stack */
            	5171, 0,
            	453, 20,
            0, 8, 1, /* 5171: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 5176: pointer.struct.NAME_CONSTRAINTS_st */
            	4344, 0,
            1, 8, 1, /* 5181: pointer.struct.x509_cert_aux_st */
            	5186, 0,
            0, 40, 5, /* 5186: struct.x509_cert_aux_st */
            	5199, 0,
            	5199, 8,
            	3841, 16,
            	3791, 24,
            	4513, 32,
            1, 8, 1, /* 5199: pointer.struct.stack_st_ASN1_OBJECT */
            	5204, 0,
            0, 32, 2, /* 5204: struct.stack_st_fake_ASN1_OBJECT */
            	5211, 8,
            	456, 24,
            64099, 8, 2, /* 5211: pointer_to_array_of_pointers_to_stack */
            	5218, 0,
            	453, 20,
            0, 8, 1, /* 5218: pointer.ASN1_OBJECT */
            	2125, 0,
            64097, 8, 0, /* 5223: pointer.func */
            64097, 8, 0, /* 5226: pointer.func */
            64097, 8, 0, /* 5229: pointer.func */
            64097, 8, 0, /* 5232: pointer.func */
            1, 8, 1, /* 5235: pointer.struct.stack_st_X509_NAME */
            	5240, 0,
            0, 32, 2, /* 5240: struct.stack_st_fake_X509_NAME */
            	5247, 8,
            	456, 24,
            64099, 8, 2, /* 5247: pointer_to_array_of_pointers_to_stack */
            	5254, 0,
            	453, 20,
            0, 8, 1, /* 5254: pointer.X509_NAME */
            	5259, 0,
            0, 0, 1, /* 5259: X509_NAME */
            	2385, 0,
            1, 8, 1, /* 5264: pointer.struct.cert_st */
            	106, 0,
            64097, 8, 0, /* 5269: pointer.func */
            64097, 8, 0, /* 5272: pointer.func */
