...
int bb_SSL_CTX_check_private_key(const SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 8, 1, /* 4811: pointer.SRTP_PROTECTION_PROFILE */
            	0, 0,
            1, 8, 1, /* 4816: pointer.struct.x509_store_st */
            	4821, 0,
            0, 144, 15, /* 4821: struct.x509_store_st */
            	4676, 8,
            	3630, 16,
            	4854, 24,
            	4866, 32,
            	...
            	4866, 112,
            	639, 120,
            1, 8, 1, /* 4854: pointer.struct.X509_VERIFY_PARAM_st */
            	4859, 0,
            0, 56, 2, /* 4859: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	2106, 48,
            ...
            8884097, 8, 0, /* 4890: pointer.func */
            0, 32, 2, /* 4893: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	4900, 8,
            	453, 24,
            8884099, 8, 2, /* 4900: pointer_to_array_of_pointers_to_stack */
            	4811, 0,
            	450, 20,
            1, 8, 1, /* 4907: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4893, 0,
            8884097, 8, 0, /* 4912: pointer.func */
            1, 8, 1, /* 4915: pointer.struct.ssl_ctx_st */
            	4920, 0,
            0, 736, 50, /* 4920: struct.ssl_ctx_st */
            	4700, 0,
            	3593, 8,
            	3593, 16,
            	4816, 24,
            	...
            	49, 720,
            	4907, 728,
            1, 8, 1, /* 5023: pointer.struct.lhash_st */
            	5028, 0,
            0, 176, 3, /* 5028: struct.lhash_st */
            	5037, 0,
            	453, 8,
            	4912, 16,
            1, 8, 1, /* 5037: pointer.pointer.struct.lhash_node_st */
            	5042, 0,
            1, 8, 1, /* 5042: pointer.struct.lhash_node_st */
            	5047, 0,
            0, 24, 2, /* 5047: struct.lhash_node_st */
            	49, 0,
            	5054, 8,
            1, 8, 1, /* 5054: pointer.struct.lhash_node_st */
            	5047, 0,
            8884097, 8, 0, /* 5059: pointer.func */
            8884097, 8, 0, /* 5062: pointer.func */
            8884097, 8, 0, /* 5065: pointer.func */
            8884097, 8, 0, /* 5068: pointer.func */
            8884097, 8, 0, /* 5071: pointer.func */
            1, 8, 1, /* 5074: pointer.struct.stack_st_X509_NAME */
            	5079, 0,
            0, 32, 2, /* 5079: struct.stack_st_fake_X509_NAME */
            	5086, 8,
            	453, 24,
            8884099, 8, 2, /* 5086: pointer_to_array_of_pointers_to_stack */
            	5093, 0,
            	450, 20,
            0, 8, 1, /* 5093: pointer.X509_NAME */
            	2259, 0,
            8884097, 8, 0, /* 5098: pointer.func */
            1, 8, 1, /* 5101: pointer.struct.ssl3_buf_freelist_st */
            	5106, 0,
            0, 24, 1, /* 5106: struct.ssl3_buf_freelist_st */
            	84, 16,
        },
        .arg_entity_index = { 4915, },
        .ret_entity_index = 450,
    };
