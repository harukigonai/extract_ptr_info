...
int bb_SSL_CTX_check_private_key(const SSL_CTX * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 4412: pointer.struct.x509_store_st */
            	4417, 0,
            0, 144, 15, /* 4417: struct.x509_store_st */
            	4265, 8,
            	4450, 16,
            	4474, 24,
            	4486, 32,
            	...
            	4486, 112,
            	642, 120,
            1, 8, 1, /* 4450: pointer.struct.stack_st_X509_LOOKUP */
            	4455, 0,
            0, 32, 2, /* 4455: struct.stack_st_fake_X509_LOOKUP */
            	4462, 8,
            	456, 24,
            8884099, 8, 2, /* 4462: pointer_to_array_of_pointers_to_stack */
            	4469, 0,
            	453, 20,
            0, 8, 1, /* 4469: pointer.X509_LOOKUP */
            	2421, 0,
            1, 8, 1, /* 4474: pointer.struct.X509_VERIFY_PARAM_st */
            	4479, 0,
            0, 56, 2, /* 4479: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	1844, 48,
            ...
            1, 8, 1, /* 4563: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4544, 0,
            1, 8, 1, /* 4568: pointer.struct.ssl_ctx_st */
            	4573, 0,
            0, 736, 50, /* 4573: struct.ssl_ctx_st */
            	4301, 0,
            	4510, 8,
            	4510, 16,
            	4412, 24,
            	...
            	49, 720,
            	4563, 728,
            1, 8, 1, /* 4676: pointer.struct.lhash_st */
            	4681, 0,
            0, 176, 3, /* 4681: struct.lhash_st */
            	4690, 0,
            	456, 8,
            	4709, 16,
            8884099, 8, 2, /* 4690: pointer_to_array_of_pointers_to_stack */
            	4697, 0,
            	81, 28,
            1, 8, 1, /* 4697: pointer.struct.lhash_node_st */
            	4702, 0,
            0, 24, 2, /* 4702: struct.lhash_node_st */
            	49, 0,
            	4697, 8,
            8884097, 8, 0, /* 4709: pointer.func */
            1, 8, 1, /* 4712: pointer.struct.ssl_session_st */
            	4717, 0,
            0, 352, 14, /* 4717: struct.ssl_session_st */
            	61, 144,
            	61, 152,
            	4748, 168,
            	137, 176,
            	...
            	209, 320,
            	61, 344,
            1, 8, 1, /* 4748: pointer.struct.sess_cert_st */
            	4753, 0,
            0, 248, 5, /* 4753: struct.sess_cert_st */
            	4766, 0,
            	123, 16,
            	2101, 216,
            	2109, 224,
            	2114, 232,
            1, 8, 1, /* 4766: pointer.struct.stack_st_X509 */
            	4771, 0,
            0, 32, 2, /* 4771: struct.stack_st_fake_X509 */
            	4778, 8,
            	456, 24,
            8884099, 8, 2, /* 4778: pointer_to_array_of_pointers_to_stack */
            	4785, 0,
            	453, 20,
            0, 8, 1, /* 4785: pointer.X509 */
            	4790, 0,
            0, 0, 1, /* 4790: X509 */
            	4795, 0,
            0, 184, 12, /* 4795: struct.x509_st */
            	4822, 0,
            	3734, 8,
            	3823, 16,
            	61, 32,
            	...
            	4888, 144,
            	4893, 176,
            1, 8, 1, /* 4822: pointer.struct.x509_cinf_st */
            	3699, 0,
            1, 8, 1, /* 4827: pointer.struct.AUTHORITY_KEYID_st */
            	4832, 0,
            0, 0, 0, /* 4832: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 4835: pointer.struct.X509_POLICY_CACHE_st */
            	4256, 0,
            1, 8, 1, /* 4840: pointer.struct.stack_st_DIST_POINT */
            	4845, 0,
            0, 32, 2, /* 4845: struct.stack_st_fake_DIST_POINT */
            	4852, 8,
            	456, 24,
            8884099, 8, 2, /* 4852: pointer_to_array_of_pointers_to_stack */
            	4859, 0,
            	453, 20,
            0, 8, 1, /* 4859: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 4864: pointer.struct.stack_st_GENERAL_NAME */
            	4869, 0,
            0, 32, 2, /* 4869: struct.stack_st_fake_GENERAL_NAME */
            	4876, 8,
            	456, 24,
            8884099, 8, 2, /* 4876: pointer_to_array_of_pointers_to_stack */
            	4883, 0,
            	453, 20,
            0, 8, 1, /* 4883: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 4888: pointer.struct.NAME_CONSTRAINTS_st */
            	4292, 0,
            1, 8, 1, /* 4893: pointer.struct.x509_cert_aux_st */
            	4898, 0,
            0, 40, 5, /* 4898: struct.x509_cert_aux_st */
            	4911, 0,
            	4911, 8,
            	3878, 16,
            	3828, 24,
            	4935, 32,
            1, 8, 1, /* 4911: pointer.struct.stack_st_ASN1_OBJECT */
            	4916, 0,
            0, 32, 2, /* 4916: struct.stack_st_fake_ASN1_OBJECT */
            	4923, 8,
            	456, 24,
            8884099, 8, 2, /* 4923: pointer_to_array_of_pointers_to_stack */
            	4930, 0,
            	453, 20,
            0, 8, 1, /* 4930: pointer.ASN1_OBJECT */
            	1868, 0,
            1, 8, 1, /* 4935: pointer.struct.stack_st_X509_ALGOR */
            	4940, 0,
            0, 32, 2, /* 4940: struct.stack_st_fake_X509_ALGOR */
            	4947, 8,
            	456, 24,
            8884099, 8, 2, /* 4947: pointer_to_array_of_pointers_to_stack */
            	4954, 0,
            	453, 20,
            0, 8, 1, /* 4954: pointer.X509_ALGOR */
            	1897, 0,
            8884097, 8, 0, /* 4959: pointer.func */
            8884097, 8, 0, /* 4962: pointer.func */
            8884097, 8, 0, /* 4965: pointer.func */
            8884097, 8, 0, /* 4968: pointer.func */
            1, 8, 1, /* 4971: pointer.struct.stack_st_X509_NAME */
            	4976, 0,
            0, 32, 2, /* 4976: struct.stack_st_fake_X509_NAME */
            	4983, 8,
            	456, 24,
            8884099, 8, 2, /* 4983: pointer_to_array_of_pointers_to_stack */
            	4990, 0,
            	453, 20,
            0, 8, 1, /* 4990: pointer.X509_NAME */
            	4995, 0,
            0, 0, 1, /* 4995: X509_NAME */
            	2210, 0,
            8884097, 8, 0, /* 5000: pointer.func */
            8884097, 8, 0, /* 5003: pointer.func */
            1, 8, 1, /* 5006: pointer.struct.ssl3_buf_freelist_st */
            	5011, 0,
            0, 24, 1, /* 5011: struct.ssl3_buf_freelist_st */
            	84, 16,
            0, 1, 0, /* 5016: char */
        },
        .arg_entity_index = { 4568, },
