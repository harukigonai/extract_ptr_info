...
long bb_SSL_CTX_ctrl(SSL_CTX * arg_a,int arg_b,long arg_c,void * arg_d) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            4097, 8, 0, /* 1285: pointer.func */
            4097, 8, 0, /* 1288: pointer.func */
            4097, 8, 0, /* 1291: pointer.func */
            0, 176, 3, /* 1294: struct.lhash_st */
            	1303, 0,
            	204, 8,
            	1320, 16,
            1, 8, 1, /* 1303: pointer.pointer.struct.lhash_node_st */
            	1308, 0,
            1, 8, 1, /* 1308: pointer.struct.lhash_node_st */
            	1313, 0,
            0, 24, 2, /* 1313: struct.lhash_node_st */
            	1174, 0,
            	1308, 8,
            4097, 8, 0, /* 1320: pointer.func */
            4097, 8, 0, /* 1323: pointer.func */
            1, 8, 1, /* 1326: pointer.struct.ssl_session_st */
            	1331, 0,
            0, 352, 14, /* 1331: struct.ssl_session_st */
            	122, 144,
            	122, 152,
            	1362, 168,
            	50, 176,
            	...
            	122, 320,
            	122, 344,
            1, 8, 1, /* 1362: pointer.struct.sess_cert_st */
            	1367, 0,
            0, 248, 6, /* 1367: struct.sess_cert_st */
            	182, 0,
            	36, 16,
            	1189, 24,
            	808, 216,
            	912, 224,
            	947, 232,
            1, 8, 1, /* 1382: pointer.struct.ssl_cipher_st */
            	1223, 0,
            ...
            1, 8, 1, /* 1473: pointer.struct.ssl_ctx_st */
            	1478, 0,
            0, 736, 50, /* 1478: struct.ssl_ctx_st */
            	1581, 0,
            	182, 8,
            	182, 16,
            	1450, 24,
            	...
            	122, 720,
            	182, 728,
            1, 8, 1, /* 1581: pointer.struct.ssl_method_st */
            	1586, 0,
            0, 232, 28, /* 1586: struct.ssl_method_st */
            	1645, 8,
            	1648, 16,
            	1648, 24,
            	1645, 32,
            ...
            1, 8, 1, /* 1675: pointer.struct.ssl3_enc_method */
            	1680, 0,
            0, 112, 11, /* 1680: struct.ssl3_enc_method */
            	315, 0,
            	1651, 8,
            	1645, 16,
            	1705, 24,
            	...
            	1461, 96,
            	1458, 104,
            4097, 8, 0, /* 1705: pointer.func */
            4097, 8, 0, /* 1708: pointer.func */
            4097, 8, 0, /* 1711: pointer.func */
            1, 8, 1, /* 1714: pointer.struct.lhash_st */
            	1294, 0,
        ...
        .arg_entity_index = { 1473, 865, 1737, 1174, },
