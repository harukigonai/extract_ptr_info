    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1782: pointer.func */
            	1787, 0,
            0, 0, 0, /* 1787: func */
            1, 8, 1, /* 1790: pointer.func */
            	1795, 0,
            0, 0, 0, /* 1795: func */
            1, 8, 1, /* 1798: pointer.func */
            	1803, 0,
            0, 0, 0, /* 1803: func */
            0, 0, 0, /* 1806: func */
            1, 8, 1, /* 1809: pointer.func */
            	1806, 0,
            0, 56, 2, /* 1814: struct.X509_VERIFY_PARAM_st */
            	196, 0,
            	259, 48,
            1, 8, 1, /* 1821: pointer.struct.X509_VERIFY_PARAM_st */
            	1814, 0,
            0, 24, 1, /* 1826: struct.ssl3_buf_freelist_st */
            	73, 16,
            0, 8, 0, /* 1831: long */
            0, 0, 0, /* 1834: func */
            1, 8, 1, /* 1837: pointer.func */
            	1842, 0,
            0, 0, 0, /* 1842: func */
            0, 0, 0, /* 1845: func */
            1, 8, 1, /* 1848: pointer.func */
            	1853, 0,
            0, 0, 0, /* 1853: func */
            0, 352, 14, /* 1856: struct.ssl_session_st */
            	196, 144,
            	196, 152,
            	1887, 168,
            	124, 176,
            	...
            	196, 320,
            	196, 344,
            1, 8, 1, /* 1887: pointer.struct.sess_cert_st */
            	1751, 0,
            1, 8, 1, /* 1892: pointer.struct.ssl_session_st */
            	1856, 0,
            0, 0, 0, /* 1897: func */
            1, 8, 1, /* 1900: pointer.struct.ssl3_enc_method.753 */
            	1905, 0,
            0, 112, 11, /* 1905: struct.ssl3_enc_method.753 */
            	397, 0,
            	1930, 8,
            	1938, 16,
            	1774, 24,
            ...
            0, 0, 0, /* 1975: func */
            0, 0, 0, /* 1978: func */
            1, 8, 1, /* 1981: pointer.struct.in_addr */
            	1732, 0,
            1, 8, 1, /* 1986: pointer.func */
            	1991, 0,
            0, 0, 0, /* 1991: func */
            1, 8, 1, /* 1994: pointer.struct.ssl_ctx_st.752 */
            	1999, 0,
            0, 736, 50, /* 1999: struct.ssl_ctx_st.752 */
            	2102, 0,
            	259, 8,
            	259, 16,
            	2245, 24,
            	...
            	196, 720,
            	259, 728,
            1, 8, 1, /* 2102: pointer.struct.ssl_method_st.754 */
            	2107, 0,
            0, 232, 28, /* 2107: struct.ssl_method_st.754 */
            	1938, 8,
            	2166, 16,
            	2166, 24,
            	1938, 32,
            	...
            	2237, 216,
            	1986, 224,
            1, 8, 1, /* 2166: pointer.func */
            	1845, 0,
            1, 8, 1, /* 2171: pointer.func */
            	1978, 0,
            ...
            1, 8, 1, /* 2184: pointer.func */
            	2189, 0,
            0, 0, 0, /* 2189: func */
            1, 8, 1, /* 2192: pointer.func */
            	2197, 0,
            0, 0, 0, /* 2197: func */
            1, 8, 1, /* 2200: pointer.func */
            	2205, 0,
            0, 0, 0, /* 2205: func */
            1, 8, 1, /* 2208: pointer.func */
            	2213, 0,
            0, 0, 0, /* 2213: func */
            1, 8, 1, /* 2216: pointer.func */
            	2221, 0,
            0, 0, 0, /* 2221: func */
            1, 8, 1, /* 2224: pointer.func */
            	2229, 0,
            0, 0, 0, /* 2229: func */
            1, 8, 1, /* 2232: pointer.func */
            	1834, 0,
            1, 8, 1, /* 2237: pointer.func */
            	2242, 0,
            0, 0, 0, /* 2242: func */
            1, 8, 1, /* 2245: pointer.struct.x509_store_st */
            	2250, 0,
            0, 144, 15, /* 2250: struct.x509_store_st */
            	259, 8,
            	259, 16,
            	1821, 24,
            	2283, 32,
            	...
            	2283, 112,
            	1005, 120,
            1, 8, 1, /* 2283: pointer.func */
            	2288, 0,
            0, 0, 0, /* 2288: func */
            1, 8, 1, /* 2291: pointer.func */
            	1897, 0,
            1, 8, 1, /* 2296: pointer.func */
            	1729, 0,
            1, 8, 1, /* 2301: pointer.func */
            	2306, 0,
            0, 0, 0, /* 2306: func */
            1, 8, 1, /* 2309: pointer.func */
            	2314, 0,
            0, 0, 0, /* 2314: func */
            1, 8, 1, /* 2317: pointer.func */
            	54, 0,
            1, 8, 1, /* 2322: pointer.struct.ssl3_buf_freelist_st */
            	1826, 0,
            0, 128, 14, /* 2327: struct.srp_ctx_st.751 */
            	196, 0,
            	2317, 8,
            	38, 16,
            	11, 24,
            	...
            	1207, 96,
            	196, 104,
            1, 8, 1, /* 2358: pointer.func */
            	8, 0,
            0, 20, 0, /* 2363: array[5].int */
            0, 8, 0, /* 2366: array[8].char */
            0, 32, 0, /* 2369: array[32].char */
            0, 48, 0, /* 2372: array[48].char */
            0, 20, 0, /* 2375: array[20].char */
        },
        .arg_entity_index = { 1994, 1222, 1831, 196, },
        .ret_entity_index = 1831,
    };
