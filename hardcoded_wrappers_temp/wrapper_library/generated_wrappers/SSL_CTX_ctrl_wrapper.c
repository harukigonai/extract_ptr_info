...
long bb_SSL_CTX_ctrl(SSL_CTX * arg_a,int arg_b,long arg_c,void * arg_d) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 8, 0, /* 1061: pointer.func */
            0, 8, 0, /* 1064: pointer.func */
            0, 0, 0, /* 1067: func */
            0, 8, 0, /* 1070: pointer.func */
            0, 8, 0, /* 1073: pointer.func */
            0, 8, 0, /* 1076: pointer.func */
            0, 352, 14, /* 1079: struct.ssl_session_st */
            	169, 144,
            	169, 152,
            	1110, 168,
            	97, 176,
            	...
            	169, 320,
            	169, 344,
            1, 8, 1, /* 1110: pointer.struct.sess_cert_st */
            	972, 0,
            1, 8, 1, /* 1115: pointer.struct.ssl_session_st */
            	1079, 0,
            0, 0, 0, /* 1120: func */
            1, 8, 1, /* 1123: pointer.struct.ssl3_enc_method.753 */
            	1128, 0,
            0, 112, 4, /* 1128: struct.ssl3_enc_method.753 */
            	318, 0,
            	318, 32,
            	169, 64,
            	169, 80,
            0, 0, 0, /* 1139: func */
            0, 8, 0, /* 1142: pointer.func */
            0, 8, 0, /* 1145: pointer.func */
            0, 0, 0, /* 1148: func */
            0, 8, 0, /* 1151: pointer.func */
            0, 8, 0, /* 1154: pointer.func */
            1, 8, 1, /* 1157: pointer.struct.in_addr */
            	942, 0,
            0, 0, 0, /* 1162: func */
            0, 0, 0, /* 1165: func */
            0, 8, 0, /* 1168: pointer.func */
            0, 8, 0, /* 1171: pointer.func */
            1, 8, 1, /* 1174: pointer.struct.ssl_ctx_st.752 */
            	1179, 0,
            0, 736, 30, /* 1179: struct.ssl_ctx_st.752 */
            	1242, 0,
            	232, 8,
            	232, 16,
            	1252, 24,
            	...
            	169, 720,
            	232, 728,
            1, 8, 1, /* 1242: pointer.struct.ssl_method_st.754 */
            	1247, 0,
            0, 232, 1, /* 1247: struct.ssl_method_st.754 */
            	1123, 200,
            1, 8, 1, /* 1252: pointer.struct.x509_store_st */
            	1257, 0,
            0, 144, 4, /* 1257: struct.x509_store_st */
            	232, 8,
            	232, 16,
            	1036, 24,
            	448, 120,
            1, 8, 1, /* 1268: pointer.struct.ssl3_buf_freelist_st */
            	1044, 0,
            0, 128, 11, /* 1273: struct.srp_ctx_st.751 */
            	169, 0,
            	169, 32,
            	578, 40,
            	578, 48,
            ...
            0, 8, 0, /* 1331: pointer.func */
            0, 8, 0, /* 1334: pointer.func */
            0, 0, 0, /* 1337: func */
            0, 20, 0, /* 1340: array[5].int */
            0, 0, 0, /* 1343: func */
            ...
            0, 8, 0, /* 1466: array[8].char */
            0, 0, 0, /* 1469: func */
            0, 32, 0, /* 1472: array[32].char */
        ...
        .arg_entity_index = { 1174, 593, 1049, 169, },
        .ret_entity_index = 1049,
    };
