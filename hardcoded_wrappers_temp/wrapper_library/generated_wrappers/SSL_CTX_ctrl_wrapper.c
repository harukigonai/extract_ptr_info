    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 56, 2, /* 1023: struct.X509_VERIFY_PARAM_st */
            	149, 0,
            	209, 48,
            0, 144, 4, /* 1030: struct.x509_store_st */
            	209, 8,
            	209, 16,
            	1041, 24,
            	425, 120,
            1, 8, 1, /* 1041: pointer.struct.X509_VERIFY_PARAM_st */
            	1023, 0,
            1, 8, 1, /* 1046: pointer.struct.x509_store_st */
            	1030, 0,
            ...
            0, 0, 0, /* 1099: func */
            0, 0, 0, /* 1102: func */
            1, 8, 1, /* 1105: pointer.struct.ssl_ctx_st.752 */
            	1110, 0,
            0, 736, 30, /* 1110: struct.ssl_ctx_st.752 */
            	1173, 0,
            	209, 8,
            	209, 16,
            	1046, 24,
            	...
            	149, 720,
            	209, 728,
            1, 8, 1, /* 1173: pointer.struct.ssl_method_st.754 */
            	1178, 0,
            0, 232, 1, /* 1178: struct.ssl_method_st.754 */
            	1183, 200,
            1, 8, 1, /* 1183: pointer.struct.ssl3_enc_method.753 */
            	1188, 0,
            0, 112, 4, /* 1188: struct.ssl3_enc_method.753 */
            	295, 0,
            	295, 32,
            	149, 64,
            	149, 80,
            1, 8, 1, /* 1199: pointer.struct.ssl_session_st */
            	1204, 0,
            0, 352, 14, /* 1204: struct.ssl_session_st */
            	149, 144,
            	149, 152,
            	1235, 168,
            	77, 176,
            	...
            	149, 320,
            	149, 344,
            1, 8, 1, /* 1235: pointer.struct.sess_cert_st */
            	958, 0,
            0, 128, 11, /* 1240: struct.srp_ctx_st.751 */
            	149, 0,
            	149, 32,
            	555, 40,
            	555, 48,
            ...
            0, 0, 0, /* 1286: func */
            0, 0, 0, /* 1289: func */
            0, 20, 0, /* 1292: array[5].int */
            0, 0, 0, /* 1295: func */
            4097, 8, 0, /* 1298: pointer.func */
            4097, 8, 0, /* 1301: pointer.func */
            0, 0, 0, /* 1304: func */
        ...
        .arg_entity_index = { 1105, 570, 1343, 149, },
        .ret_entity_index = 1343,
    };
