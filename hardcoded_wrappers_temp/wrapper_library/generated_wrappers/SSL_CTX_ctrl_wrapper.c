    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 6297: pointer.struct.AUTHORITY_KEYID_st */
            	2706, 0,
            1, 8, 1, /* 6302: pointer.struct.ssl3_buf_freelist_st */
            	2546, 0,
            1, 8, 1, /* 6307: pointer.struct.x509_st */
            	6312, 0,
            0, 184, 12, /* 6312: struct.x509_st */
            	6339, 0,
            	4679, 8,
            	4762, 16,
            	84, 32,
            	...
            	4575, 144,
            	4570, 176,
            1, 8, 1, /* 6339: pointer.struct.x509_cinf_st */
            	4689, 0,
            8884097, 8, 0, /* 6344: pointer.func */
            8884097, 8, 0, /* 6347: pointer.func */
            0, 144, 15, /* 6350: struct.x509_store_st */
            	6383, 8,
            	6270, 16,
            	6407, 24,
            	5289, 32,
            	...
            	5289, 112,
            	5223, 120,
            1, 8, 1, /* 6383: pointer.struct.stack_st_X509_OBJECT */
            	6388, 0,
            0, 32, 2, /* 6388: struct.stack_st_fake_X509_OBJECT */
            	6395, 8,
            	193, 24,
            8884099, 8, 2, /* 6395: pointer_to_array_of_pointers_to_stack */
            	6402, 0,
            	33, 20,
            0, 8, 1, /* 6402: pointer.X509_OBJECT */
            	5496, 0,
            1, 8, 1, /* 6407: pointer.struct.X509_VERIFY_PARAM_st */
            	5292, 0,
            8884097, 8, 0, /* 6412: pointer.func */
            ...
            0, 8, 1, /* 6430: pointer.SRTP_PROTECTION_PROFILE */
            	10, 0,
            0, 32, 2, /* 6435: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	6442, 8,
            	193, 24,
            8884099, 8, 2, /* 6442: pointer_to_array_of_pointers_to_stack */
            	6430, 0,
            	33, 20,
            8884097, 8, 0, /* 6449: pointer.func */
            8884097, 8, 0, /* 6452: pointer.func */
            8884097, 8, 0, /* 6455: pointer.func */
            8884097, 8, 0, /* 6458: pointer.func */
            0, 88, 1, /* 6461: struct.ssl_cipher_st */
            	5, 8,
            0, 0, 1, /* 6466: SSL_CIPHER */
            	6461, 0,
            0, 1, 0, /* 6471: char */
            0, 232, 28, /* 6474: struct.ssl_method_st */
            	6344, 8,
            	6533, 16,
            	6533, 24,
            	6344, 32,
            ...
            1, 8, 1, /* 6563: pointer.struct.ssl3_enc_method */
            	6568, 0,
            0, 112, 11, /* 6568: struct.ssl3_enc_method */
            	6593, 0,
            	6596, 8,
            	6599, 16,
            	6602, 24,
            ...
            0, 736, 50, /* 6614: struct.ssl_ctx_st */
            	6717, 0,
            	6722, 8,
            	6722, 16,
            	6746, 24,
            	...
            	72, 720,
            	6812, 728,
            1, 8, 1, /* 6717: pointer.struct.ssl_method_st */
            	6474, 0,
            1, 8, 1, /* 6722: pointer.struct.stack_st_SSL_CIPHER */
            	6727, 0,
            0, 32, 2, /* 6727: struct.stack_st_fake_SSL_CIPHER */
            	6734, 8,
            	193, 24,
            8884099, 8, 2, /* 6734: pointer_to_array_of_pointers_to_stack */
            	6741, 0,
            	33, 20,
            0, 8, 1, /* 6741: pointer.SSL_CIPHER */
            	6466, 0,
            1, 8, 1, /* 6746: pointer.struct.x509_store_st */
            	6350, 0,
        ...
        .arg_entity_index = { 6817, 33, 6822, 72, },
