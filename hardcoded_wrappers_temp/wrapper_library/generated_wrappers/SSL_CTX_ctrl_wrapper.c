...
long bb_SSL_CTX_ctrl(SSL_CTX * arg_a,int arg_b,long arg_c,void * arg_d) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 0, 1, /* 4251: X509_OBJECT */
            	4256, 0,
            0, 16, 1, /* 4256: struct.x509_object_st */
            	4261, 8,
            0, 8, 4, /* 4261: union.unknown */
            	61, 0,
            	4240, 0,
            	4272, 0,
            	3848, 0,
            1, 8, 1, /* 4272: pointer.struct.X509_crl_st */
            	4277, 0,
            0, 120, 10, /* 4277: struct.X509_crl_st */
            	4300, 0,
            	2666, 8,
            	2765, 16,
            	2863, 32,
            	...
            	4361, 104,
            	49, 112,
            1, 8, 1, /* 4300: pointer.struct.X509_crl_info_st */
            	4305, 0,
            0, 80, 8, /* 4305: struct.X509_crl_info_st */
            	2755, 0,
            	2666, 8,
            	3769, 16,
            	3829, 24,
            	...
            	4089, 48,
            	4113, 56,
            1, 8, 1, /* 4324: pointer.struct.ISSUING_DIST_POINT_st */
            	4329, 0,
            0, 0, 0, /* 4329: struct.ISSUING_DIST_POINT_st */
            1, 8, 1, /* 4332: pointer.struct.stack_st_GENERAL_NAMES */
            	4337, 0,
            0, 32, 2, /* 4337: struct.stack_st_fake_GENERAL_NAMES */
            	4344, 8,
            	456, 24,
            8884099, 8, 2, /* 4344: pointer_to_array_of_pointers_to_stack */
            	4351, 0,
            	453, 20,
            0, 8, 1, /* 4351: pointer.GENERAL_NAMES */
            	4356, 0,
            0, 0, 1, /* 4356: GENERAL_NAMES */
            	4225, 0,
            1, 8, 1, /* 4361: pointer.struct.x509_crl_method_st */
            	4366, 0,
            0, 0, 0, /* 4366: struct.x509_crl_method_st */
            1, 8, 1, /* 4369: pointer.struct.stack_st_X509_OBJECT */
            	4374, 0,
            0, 32, 2, /* 4374: struct.stack_st_fake_X509_OBJECT */
            	4381, 8,
            	456, 24,
            8884099, 8, 2, /* 4381: pointer_to_array_of_pointers_to_stack */
            	4388, 0,
            	453, 20,
            0, 8, 1, /* 4388: pointer.X509_OBJECT */
            	4251, 0,
            1, 8, 1, /* 4393: pointer.struct.ssl_method_st */
            	4398, 0,
            0, 232, 28, /* 4398: struct.ssl_method_st */
            	2905, 8,
            	4216, 16,
            	4216, 24,
            	2905, 32,
            ...
            1, 8, 1, /* 4493: pointer.struct.ssl3_enc_method */
            	2874, 0,
            ...
            8884099, 8, 2, /* 4504: pointer_to_array_of_pointers_to_stack */
            	4511, 0,
            	453, 20,
            0, 8, 1, /* 4511: pointer.SRTP_PROTECTION_PROFILE */
            	0, 0,
            1, 8, 1, /* 4516: pointer.struct.x509_store_st */
            	4521, 0,
            0, 144, 15, /* 4521: struct.x509_store_st */
            	4369, 8,
            	4554, 16,
            	4760, 24,
            	4772, 32,
            	...
            	4772, 112,
            	642, 120,
            1, 8, 1, /* 4554: pointer.struct.stack_st_X509_LOOKUP */
            	4559, 0,
            0, 32, 2, /* 4559: struct.stack_st_fake_X509_LOOKUP */
            	4566, 8,
            	456, 24,
            8884099, 8, 2, /* 4566: pointer_to_array_of_pointers_to_stack */
            	4573, 0,
            	453, 20,
            0, 8, 1, /* 4573: pointer.X509_LOOKUP */
            	4578, 0,
            0, 0, 1, /* 4578: X509_LOOKUP */
            	4583, 0,
            0, 32, 3, /* 4583: struct.x509_lookup_st */
            	4592, 8,
            	61, 16,
            	4635, 24,
            1, 8, 1, /* 4592: pointer.struct.x509_lookup_method_st */
            	4597, 0,
            0, 80, 10, /* 4597: struct.x509_lookup_method_st */
            	10, 0,
            	4620, 8,
            	2868, 16,
            	4620, 24,
            ...
            1, 8, 1, /* 4635: pointer.struct.x509_store_st */
            	4640, 0,
            0, 144, 15, /* 4640: struct.x509_store_st */
            	4673, 8,
            	4697, 16,
            	4721, 24,
            	4733, 32,
            	...
            	4733, 112,
            	2533, 120,
            1, 8, 1, /* 4673: pointer.struct.stack_st_X509_OBJECT */
            	4678, 0,
            0, 32, 2, /* 4678: struct.stack_st_fake_X509_OBJECT */
            	4685, 8,
            	456, 24,
            8884099, 8, 2, /* 4685: pointer_to_array_of_pointers_to_stack */
            	4692, 0,
            	453, 20,
            0, 8, 1, /* 4692: pointer.X509_OBJECT */
            	4251, 0,
            1, 8, 1, /* 4697: pointer.struct.stack_st_X509_LOOKUP */
            	4702, 0,
            0, 32, 2, /* 4702: struct.stack_st_fake_X509_LOOKUP */
            	4709, 8,
            	456, 24,
            8884099, 8, 2, /* 4709: pointer_to_array_of_pointers_to_stack */
            	4716, 0,
            	453, 20,
            0, 8, 1, /* 4716: pointer.X509_LOOKUP */
            	4578, 0,
            1, 8, 1, /* 4721: pointer.struct.X509_VERIFY_PARAM_st */
            	4726, 0,
            0, 56, 2, /* 4726: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	4168, 48,
            ...
            1, 8, 1, /* 4760: pointer.struct.X509_VERIFY_PARAM_st */
            	4765, 0,
            0, 56, 2, /* 4765: struct.X509_VERIFY_PARAM_st */
            	61, 0,
            	2101, 48,
            ...
            0, 88, 1, /* 4822: struct.ssl_cipher_st */
            	10, 8,
            0, 32, 2, /* 4827: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	4504, 8,
            	456, 24,
            1, 8, 1, /* 4834: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	4827, 0,
            0, 1, 0, /* 4839: char */
            8884097, 8, 0, /* 4842: pointer.func */
            1, 8, 1, /* 4845: pointer.struct.ssl_ctx_st */
            	4850, 0,
            0, 736, 50, /* 4850: struct.ssl_ctx_st */
            	4393, 0,
            	4793, 8,
            	4793, 16,
            	4516, 24,
            	...
            	49, 720,
            	4834, 728,
            1, 8, 1, /* 4953: pointer.struct.lhash_st */
            	4958, 0,
            0, 176, 3, /* 4958: struct.lhash_st */
            	4967, 0,
            	456, 8,
            	4989, 16,
            1, 8, 1, /* 4967: pointer.pointer.struct.lhash_node_st */
            	4972, 0,
            1, 8, 1, /* 4972: pointer.struct.lhash_node_st */
            	4977, 0,
            0, 24, 2, /* 4977: struct.lhash_node_st */
            	49, 0,
            	4984, 8,
            1, 8, 1, /* 4984: pointer.struct.lhash_node_st */
            	4977, 0,
            8884097, 8, 0, /* 4989: pointer.func */
            1, 8, 1, /* 4992: pointer.struct.ssl_session_st */
            	4997, 0,
            0, 352, 14, /* 4997: struct.ssl_session_st */
            	61, 144,
            	61, 152,
            	5028, 168,
            	137, 176,
            	...
            	209, 320,
            	61, 344,
            1, 8, 1, /* 5028: pointer.struct.sess_cert_st */
            	5033, 0,
            0, 248, 5, /* 5033: struct.sess_cert_st */
            	5046, 0,
            	123, 16,
            	2367, 216,
            	2375, 224,
            	2380, 232,
            1, 8, 1, /* 5046: pointer.struct.stack_st_X509 */
            	5051, 0,
            0, 32, 2, /* 5051: struct.stack_st_fake_X509 */
            	5058, 8,
            	456, 24,
            8884099, 8, 2, /* 5058: pointer_to_array_of_pointers_to_stack */
            	5065, 0,
            	453, 20,
            0, 8, 1, /* 5065: pointer.X509 */
            	5070, 0,
            0, 0, 1, /* 5070: X509 */
            	5075, 0,
            0, 184, 12, /* 5075: struct.x509_st */
            	5102, 0,
            	2961, 8,
            	3050, 16,
            	61, 32,
            	...
            	5168, 144,
            	5173, 176,
            1, 8, 1, /* 5102: pointer.struct.x509_cinf_st */
            	2926, 0,
            1, 8, 1, /* 5107: pointer.struct.AUTHORITY_KEYID_st */
            	5112, 0,
            0, 0, 0, /* 5112: struct.AUTHORITY_KEYID_st */
            1, 8, 1, /* 5115: pointer.struct.X509_POLICY_CACHE_st */
            	3600, 0,
            1, 8, 1, /* 5120: pointer.struct.stack_st_DIST_POINT */
            	5125, 0,
            0, 32, 2, /* 5125: struct.stack_st_fake_DIST_POINT */
            	5132, 8,
            	456, 24,
            8884099, 8, 2, /* 5132: pointer_to_array_of_pointers_to_stack */
            	5139, 0,
            	453, 20,
            0, 8, 1, /* 5139: pointer.DIST_POINT */
            	1632, 0,
            1, 8, 1, /* 5144: pointer.struct.stack_st_GENERAL_NAME */
            	5149, 0,
            0, 32, 2, /* 5149: struct.stack_st_fake_GENERAL_NAME */
            	5156, 8,
            	456, 24,
            8884099, 8, 2, /* 5156: pointer_to_array_of_pointers_to_stack */
            	5163, 0,
            	453, 20,
            0, 8, 1, /* 5163: pointer.GENERAL_NAME */
            	1330, 0,
            1, 8, 1, /* 5168: pointer.struct.NAME_CONSTRAINTS_st */
            	4222, 0,
            1, 8, 1, /* 5173: pointer.struct.x509_cert_aux_st */
            	5178, 0,
            0, 40, 5, /* 5178: struct.x509_cert_aux_st */
            	5191, 0,
            	5191, 8,
            	3105, 16,
            	3055, 24,
            	5215, 32,
            1, 8, 1, /* 5191: pointer.struct.stack_st_ASN1_OBJECT */
            	5196, 0,
            0, 32, 2, /* 5196: struct.stack_st_fake_ASN1_OBJECT */
            	5203, 8,
            	456, 24,
            8884099, 8, 2, /* 5203: pointer_to_array_of_pointers_to_stack */
            	5210, 0,
            	453, 20,
            0, 8, 1, /* 5210: pointer.ASN1_OBJECT */
            	2125, 0,
            1, 8, 1, /* 5215: pointer.struct.stack_st_X509_ALGOR */
            	5220, 0,
            0, 32, 2, /* 5220: struct.stack_st_fake_X509_ALGOR */
            	5227, 8,
            	456, 24,
            8884099, 8, 2, /* 5227: pointer_to_array_of_pointers_to_stack */
            	5234, 0,
            	453, 20,
            0, 8, 1, /* 5234: pointer.X509_ALGOR */
            	2163, 0,
            8884097, 8, 0, /* 5239: pointer.func */
            8884097, 8, 0, /* 5242: pointer.func */
            8884097, 8, 0, /* 5245: pointer.func */
            8884097, 8, 0, /* 5248: pointer.func */
            1, 8, 1, /* 5251: pointer.struct.stack_st_X509_NAME */
            	5256, 0,
            0, 32, 2, /* 5256: struct.stack_st_fake_X509_NAME */
            	5263, 8,
            	456, 24,
            8884099, 8, 2, /* 5263: pointer_to_array_of_pointers_to_stack */
            	5270, 0,
            	453, 20,
            0, 8, 1, /* 5270: pointer.X509_NAME */
            	2520, 0,
            8884097, 8, 0, /* 5275: pointer.func */
            1, 8, 1, /* 5278: pointer.struct.ssl3_buf_freelist_st */
            	5283, 0,
            0, 24, 1, /* 5283: struct.ssl3_buf_freelist_st */
            	84, 16,
            0, 8, 0, /* 5288: long int */
        },
        .arg_entity_index = { 4845, 453, 5288, 49, },
        .ret_entity_index = 5288,
    };
