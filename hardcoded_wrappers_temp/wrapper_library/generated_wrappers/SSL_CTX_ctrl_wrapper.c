    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            0, 56, 2, /* 6172: struct.X509_VERIFY_PARAM_st */
            	53, 0,
            	4353, 48,
            1, 8, 1, /* 6179: pointer.struct.stack_st_X509_OBJECT */
            	6184, 0,
            0, 32, 2, /* 6184: struct.stack_st_fake_X509_OBJECT */
            	6191, 8,
            	180, 24,
            8884099, 8, 2, /* 6191: pointer_to_array_of_pointers_to_stack */
            	6198, 0,
            	1052, 20,
            0, 8, 1, /* 6198: pointer.X509_OBJECT */
            	5454, 0,
            8884097, 8, 0, /* 6203: pointer.func */
            ...
            1, 8, 1, /* 6221: pointer.struct.stack_st_SRTP_PROTECTION_PROFILE */
            	6226, 0,
            0, 32, 2, /* 6226: struct.stack_st_fake_SRTP_PROTECTION_PROFILE */
            	6233, 8,
            	180, 24,
            8884099, 8, 2, /* 6233: pointer_to_array_of_pointers_to_stack */
            	6240, 0,
            	1052, 20,
            0, 8, 1, /* 6240: pointer.SRTP_PROTECTION_PROFILE */
            	6158, 0,
            0, 1, 0, /* 6245: char */
            1, 8, 1, /* 6248: pointer.struct.ssl3_enc_method */
            	6253, 0,
            0, 112, 11, /* 6253: struct.ssl3_enc_method */
            	6278, 0,
            	6281, 8,
            	6284, 16,
            	6287, 24,
            ...
            1, 8, 1, /* 6305: pointer.struct.ssl_ctx_st */
            	6310, 0,
            0, 736, 50, /* 6310: struct.ssl_ctx_st */
            	6413, 0,
            	5173, 8,
            	5173, 16,
            	6507, 24,
            	...
            	41, 720,
            	6221, 728,
            1, 8, 1, /* 6413: pointer.struct.ssl_method_st */
            	6418, 0,
            0, 232, 28, /* 6418: struct.ssl_method_st */
            	6477, 8,
            	6480, 16,
            	6480, 24,
            	6477, 32,
            	...
            	6203, 216,
            	6504, 224,
            8884097, 8, 0, /* 6477: pointer.func */
            8884097, 8, 0, /* 6480: pointer.func */
            8884097, 8, 0, /* 6483: pointer.func */
            ...
            1, 8, 1, /* 6507: pointer.struct.x509_store_st */
            	6512, 0,
            0, 144, 15, /* 6512: struct.x509_store_st */
            	6179, 8,
            	6092, 16,
            	6545, 24,
            	5248, 32,
            	...
            	5248, 112,
            	5141, 120,
            1, 8, 1, /* 6545: pointer.struct.X509_VERIFY_PARAM_st */
            	6172, 0,
        ...
        .arg_entity_index = { 6305, 1052, 6579, 41, },
