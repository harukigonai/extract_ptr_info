    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1210: pointer.struct.lhash_node_st */
            	1203, 0,
            0, 176, 3, /* 1215: struct.lhash_st */
            	1224, 0,
            	22, 8,
            	1229, 16,
            1, 8, 1, /* 1224: pointer.pointer.struct.lhash_node_st */
            	1198, 0,
            ...
            1, 8, 1, /* 1250: pointer.struct.ssl_method_st */
            	1255, 0,
            0, 232, 28, /* 1255: struct.ssl_method_st */
            	1314, 8,
            	1238, 16,
            	1238, 24,
            	1314, 32,
            ...
            4097, 8, 0, /* 1350: pointer.func */
            4097, 8, 0, /* 1353: pointer.func */
            4097, 8, 0, /* 1356: pointer.func */
            1, 8, 1, /* 1359: pointer.struct.ssl3_enc_method */
            	1364, 0,
            0, 112, 11, /* 1364: struct.ssl3_enc_method */
            	1247, 0,
            	1085, 8,
            	1314, 16,
            	1389, 24,
            ...
            0, 736, 50, /* 1401: struct.ssl_ctx_st */
            	1250, 0,
            	1504, 8,
            	1504, 16,
            	1509, 24,
            ...
            1, 8, 1, /* 1504: pointer.struct.stack_st_SSL_CIPHER */
            	1182, 0,
            1, 8, 1, /* 1509: pointer.struct.x509_store_st */
            	1107, 0,
            1, 8, 1, /* 1514: pointer.struct.lhash_st */
            	1215, 0,
            1, 8, 1, /* 1519: pointer.struct.ssl_session_st */
            	1524, 0,
            0, 352, 14, /* 1524: struct.ssl_session_st */
            	17, 144,
            	17, 152,
            	1555, 168,
            	88, 176,
            	...
            	160, 320,
            	17, 344,
            1, 8, 1, /* 1555: pointer.struct.sess_cert_st */
            	1052, 0,
            1, 8, 1, /* 1560: pointer.struct.stack_st_X509_NAME */
            	952, 0,
            4097, 8, 0, /* 1565: pointer.func */
            1, 8, 1, /* 1568: pointer.struct.ssl_ctx_st */
            	1401, 0,
        },
        .arg_entity_index = { 1568, 1192, 1244, 1016, },
        .ret_entity_index = 1244,
    };
