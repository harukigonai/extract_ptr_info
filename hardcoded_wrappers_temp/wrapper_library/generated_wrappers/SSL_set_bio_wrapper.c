...
void bb_SSL_set_bio(SSL * arg_a,BIO * arg_b,BIO * arg_c) 
{
    ...
    em[7228] = 0; em[7229] = 1; em[7230] = 0; /* 7228: char */
    em[7231] = 1; em[7232] = 8; em[7233] = 1; /* 7231: pointer.struct.ssl_st */
    	em[7234] = 6484; em[7235] = 0; 
    args_addr->arg_entity_index[0] = 7231;
