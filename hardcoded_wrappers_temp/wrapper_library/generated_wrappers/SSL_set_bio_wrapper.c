...
void bb_SSL_set_bio(SSL * arg_a,BIO * arg_b,BIO * arg_c) 
{
    ...
    em[7601] = 0; em[7602] = 1; em[7603] = 0; /* 7601: char */
    em[7604] = 1; em[7605] = 8; em[7606] = 1; /* 7604: pointer.struct.ssl_st */
    	em[7607] = 7275; em[7608] = 0; 
    args_addr->arg_entity_index[0] = 7604;
    args_addr->arg_entity_index[1] = 6844;
    args_addr->arg_entity_index[2] = 6844;
