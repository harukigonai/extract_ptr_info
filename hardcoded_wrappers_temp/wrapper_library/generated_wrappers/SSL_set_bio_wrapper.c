    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 1806: pointer.struct.tls_session_ticket_ext_st */
            	3, 0,
            1, 8, 1, /* 1811: pointer.struct.ssl_st */
            	1816, 0,
            0, 808, 51, /* 1816: struct.ssl_st */
            	1921, 8,
            	2072, 16,
            	2072, 24,
            	2072, 32,
            	...
            	1801, 656,
            	1362, 680,
            1, 8, 1, /* 1921: pointer.struct.ssl_method_st */
            	1926, 0,
            0, 232, 28, /* 1926: struct.ssl_method_st */
            	1985, 8,
            	1988, 16,
            	1988, 24,
            	1985, 32,
            	...
            	2066, 216,
            	2069, 224,
            4097, 8, 0, /* 1985: pointer.func */
            4097, 8, 0, /* 1988: pointer.func */
            4097, 8, 0, /* 1991: pointer.func */
            4097, 8, 0, /* 1994: pointer.func */
            4097, 8, 0, /* 1997: pointer.func */
            4097, 8, 0, /* 2000: pointer.func */
            4097, 8, 0, /* 2003: pointer.func */
            4097, 8, 0, /* 2006: pointer.func */
            4097, 8, 0, /* 2009: pointer.func */
            4097, 8, 0, /* 2012: pointer.func */
            4097, 8, 0, /* 2015: pointer.func */
            4097, 8, 0, /* 2018: pointer.func */
            1, 8, 1, /* 2021: pointer.struct.ssl3_enc_method */
            	2026, 0,
            0, 112, 11, /* 2026: struct.ssl3_enc_method */
            	462, 0,
            	1991, 8,
            	1985, 16,
            	2051, 24,
            	...
            	2060, 96,
            	2063, 104,
            4097, 8, 0, /* 2051: pointer.func */
            4097, 8, 0, /* 2054: pointer.func */
            4097, 8, 0, /* 2057: pointer.func */
            4097, 8, 0, /* 2060: pointer.func */
            4097, 8, 0, /* 2063: pointer.func */
            4097, 8, 0, /* 2066: pointer.func */
            4097, 8, 0, /* 2069: pointer.func */
            1, 8, 1, /* 2072: pointer.struct.bio_st */
            	2077, 0,
            0, 112, 7, /* 2077: struct.bio_st */
            	2094, 0,
            	2099, 8,
            	154, 16,
            	154, 48,
            	...
            	2072, 64,
            	180, 96,
            1, 8, 1, /* 2094: pointer.struct.bio_method_st */
            	1765, 0,
            4097, 8, 0, /* 2099: pointer.func */
            1, 8, 1, /* 2102: pointer.struct.ssl2_state_st */
            	2107, 0,
            0, 344, 9, /* 2107: struct.ssl2_state_st */
            	154, 24,
            	154, 56,
            	154, 64,
            	154, 72,
            	...
            	154, 128,
            	154, 136,
            1, 8, 1, /* 2128: pointer.struct.ssl3_state_st */
            	2133, 0,
            0, 1200, 10, /* 2133: struct.ssl3_state_st */
            	2156, 240,
            	2156, 264,
            	2161, 288,
            	2161, 344,
            	...
            	8, 512,
            	2175, 528,
            0, 24, 1, /* 2156: struct.ssl3_buffer_st */
            	154, 0,
            0, 56, 3, /* 2161: struct.ssl3_record_st */
            	154, 16,
            	154, 24,
            	154, 32,
            1, 8, 1, /* 2170: pointer.pointer.struct.env_md_ctx_st */
            	1635, 0,
            0, 528, 8, /* 2175: struct.anon */
            	1755, 408,
            	1054, 416,
            	1089, 424,
            	132, 464,
            	...
            	905, 496,
            	2194, 512,
            1, 8, 1, /* 2194: pointer.struct.ssl_comp_st */
            	2199, 0,
            0, 24, 2, /* 2199: struct.ssl_comp_st */
            	154, 8,
            	1665, 16,
            4097, 8, 0, /* 2206: pointer.func */
            1, 8, 1, /* 2209: pointer.struct.ssl_ctx_st */
            	2214, 0,
            0, 736, 50, /* 2214: struct.ssl_ctx_st */
            	1921, 0,
            	132, 8,
            	132, 16,
            	94, 24,
            	...
            	154, 720,
            	132, 728,
            4097, 8, 0, /* 2317: pointer.func */
            4097, 8, 0, /* 2320: pointer.func */
            4097, 8, 0, /* 2323: pointer.func */
            4097, 8, 0, /* 2326: pointer.func */
            0, 1, 0, /* 2329: char */
        },
        .arg_entity_index = { 1811, 2072, 2072, },
        .ret_entity_index = -1,
    };
