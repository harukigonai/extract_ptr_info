...
BIO * bb_SSL_get_wbio(const SSL * arg_a) 
{
    ...
    em[7387] = 0; em[7388] = 1; em[7389] = 0; /* 7387: char */
    em[7390] = 1; em[7391] = 8; em[7392] = 1; /* 7390: pointer.struct.ssl_st */
    	em[7393] = 7214; em[7394] = 0; 
    args_addr->arg_entity_index[0] = 7390;
