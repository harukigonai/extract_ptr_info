...
X509 * bb_SSL_get_peer_certificate(const SSL * arg_a) 
{
    ...
    struct lib_enter_args args = {
        ...
        .entity_metadata = {
            ...
            1, 8, 1, /* 4465: pointer.struct.stack_st_X509_OBJECT */
            	4470, 0,
            0, 32, 2, /* 4470: struct.stack_st_fake_X509_OBJECT */
            	4477, 8,
            	125, 24,
            8884099, 8, 2, /* 4477: pointer_to_array_of_pointers_to_stack */
            	4484, 0,
            	122, 20,
            0, 8, 1, /* 4484: pointer.X509_OBJECT */
            	401, 0,
            1, 8, 1, /* 4489: pointer.struct.ssl_ctx_st */
            	4494, 0,
            0, 736, 50, /* 4494: struct.ssl_ctx_st */
            	4597, 0,
            	4763, 8,
            	4763, 16,
            	4797, 24,
            	...
            	15, 720,
            	6764, 728,
            1, 8, 1, /* 4597: pointer.struct.ssl_method_st */
            	4602, 0,
            0, 232, 28, /* 4602: struct.ssl_method_st */
            	4661, 8,
            	4664, 16,
            	4664, 24,
            	4661, 32,
            ...
            1, 8, 1, /* 4703: pointer.struct.ssl3_enc_method */
            	4708, 0,
            0, 112, 11, /* 4708: struct.ssl3_enc_method */
            	4733, 0,
            	4736, 8,
            	4739, 16,
            	4742, 24,
            ...
            1, 8, 1, /* 4763: pointer.struct.stack_st_SSL_CIPHER */
            	4768, 0,
            0, 32, 2, /* 4768: struct.stack_st_fake_SSL_CIPHER */
            	4775, 8,
            	125, 24,
            8884099, 8, 2, /* 4775: pointer_to_array_of_pointers_to_stack */
            	4782, 0,
            	122, 20,
            0, 8, 1, /* 4782: pointer.SSL_CIPHER */
            	4787, 0,
            0, 0, 1, /* 4787: SSL_CIPHER */
            	4792, 0,
            0, 88, 1, /* 4792: struct.ssl_cipher_st */
            	5, 8,
            1, 8, 1, /* 4797: pointer.struct.x509_store_st */
            	4802, 0,
            0, 144, 15, /* 4802: struct.x509_store_st */
            	4465, 8,
            	4835, 16,
            	4859, 24,
            	4895, 32,
            	...
            	4895, 112,
            	4907, 120,
            1, 8, 1, /* 4835: pointer.struct.stack_st_X509_LOOKUP */
            	4840, 0,
            0, 32, 2, /* 4840: struct.stack_st_fake_X509_LOOKUP */
            	4847, 8,
            	125, 24,
            8884099, 8, 2, /* 4847: pointer_to_array_of_pointers_to_stack */
            	4854, 0,
            	122, 20,
            0, 8, 1, /* 4854: pointer.X509_LOOKUP */
            	4379, 0,
            ...
            1, 8, 1, /* 6793: pointer.struct.srtp_protection_profile_st */
            	0, 0,
            0, 56, 2, /* 6798: struct.comp_ctx_st */
            	6805, 0,
            	4907, 40,
            1, 8, 1, /* 6805: pointer.struct.comp_method_st */
            	6810, 0,
            0, 64, 7, /* 6810: struct.comp_method_st */
            	5, 8,
            	6827, 16,
            	6830, 24,
            	6833, 32,
            ...
            1, 8, 1, /* 6836: pointer.struct.evp_cipher_ctx_st */
            	6841, 0,
            0, 168, 4, /* 6841: struct.evp_cipher_ctx_st */
            	6852, 0,
            	5726, 8,
            	15, 96,
            	15, 120,
            1, 8, 1, /* 6852: pointer.struct.evp_cipher_st */
            	6857, 0,
            0, 88, 7, /* 6857: struct.evp_cipher_st */
            	6874, 24,
            	6877, 32,
            	6880, 40,
            	6883, 56,
            ...
            0, 40, 4, /* 6889: struct.dtls1_retransmit_state */
            	6836, 0,
            	6900, 8,
            	7122, 16,
            	7127, 24,
            1, 8, 1, /* 6900: pointer.struct.env_md_ctx_st */
            	6905, 0,
            0, 48, 5, /* 6905: struct.env_md_ctx_st */
            	6103, 0,
            	5726, 8,
            	15, 24,
            	6918, 32,
            	6130, 40,
            1, 8, 1, /* 6918: pointer.struct.evp_pkey_ctx_st */
            	6923, 0,
            0, 80, 8, /* 6923: struct.evp_pkey_ctx_st */
            	6942, 0,
            	1714, 8,
            	7036, 16,
            	7036, 24,
            	...
            	7114, 56,
            	7117, 64,
            1, 8, 1, /* 6942: pointer.struct.evp_pkey_method_st */
            	6947, 0,
            0, 208, 25, /* 6947: struct.evp_pkey_method_st */
            	7000, 8,
            	7003, 16,
            	7006, 24,
            	7000, 32,
            ...
            8884097, 8, 0, /* 7012: pointer.func */
            8884097, 8, 0, /* 7015: pointer.func */
            8884097, 8, 0, /* 7018: pointer.func */
            8884097, 8, 0, /* 7021: pointer.func */
            8884097, 8, 0, /* 7024: pointer.func */
            8884097, 8, 0, /* 7027: pointer.func */
            8884097, 8, 0, /* 7030: pointer.func */
            8884097, 8, 0, /* 7033: pointer.func */
            1, 8, 1, /* 7036: pointer.struct.evp_pkey_st */
            	7041, 0,
            0, 56, 4, /* 7041: struct.evp_pkey_st */
            	7052, 16,
            	1714, 24,
            	7057, 32,
            	7090, 48,
            1, 8, 1, /* 7052: pointer.struct.evp_pkey_asn1_method_st */
            	776, 0,
            0, 8, 5, /* 7057: union.unknown */
            	138, 0,
            	7070, 0,
            	7075, 0,
            	7080, 0,
            	7085, 0,
            1, 8, 1, /* 7070: pointer.struct.rsa_st */
            	1243, 0,
            1, 8, 1, /* 7075: pointer.struct.dsa_st */
            	1459, 0,
            1, 8, 1, /* 7080: pointer.struct.dh_st */
            	1598, 0,
            1, 8, 1, /* 7085: pointer.struct.ec_key_st */
            	1724, 0,
            1, 8, 1, /* 7090: pointer.struct.stack_st_X509_ATTRIBUTE */
            	7095, 0,
            0, 32, 2, /* 7095: struct.stack_st_fake_X509_ATTRIBUTE */
            	7102, 8,
            	125, 24,
            8884099, 8, 2, /* 7102: pointer_to_array_of_pointers_to_stack */
            	7109, 0,
            	122, 20,
            0, 8, 1, /* 7109: pointer.X509_ATTRIBUTE */
            	2252, 0,
            8884097, 8, 0, /* 7114: pointer.func */
            1, 8, 1, /* 7117: pointer.int */
            	122, 0,
            1, 8, 1, /* 7122: pointer.struct.comp_ctx_st */
            	6798, 0,
            1, 8, 1, /* 7127: pointer.struct.ssl_session_st */
            	4934, 0,
            0, 88, 1, /* 7132: struct.hm_header_st */
            	6889, 48,
            1, 8, 1, /* 7137: pointer.struct._pitem */
            	7142, 0,
            0, 24, 2, /* 7142: struct._pitem */
            	15, 8,
            	7137, 16,
            1, 8, 1, /* 7149: pointer.struct._pitem */
            	7142, 0,
            0, 16, 1, /* 7154: struct.record_pqueue_st */
            	7159, 8,
            1, 8, 1, /* 7159: pointer.struct._pqueue */
            	7164, 0,
            0, 16, 1, /* 7164: struct._pqueue */
            	7149, 0,
            1, 8, 1, /* 7169: pointer.struct.dtls1_state_st */
            	7174, 0,
            0, 888, 7, /* 7174: struct.dtls1_state_st */
            	7154, 576,
            	7154, 592,
            	7159, 608,
            	7159, 616,
            	...
            	7132, 648,
            	7132, 736,
            0, 24, 2, /* 7191: struct.ssl_comp_st */
            	5, 8,
            	6805, 16,
            1, 8, 1, /* 7198: pointer.struct.ssl_comp_st */
            	7191, 0,
            1, 8, 1, /* 7203: pointer.struct.dh_st */
            	1598, 0,
            0, 528, 8, /* 7208: struct.unknown */
            	6081, 408,
            	7203, 416,
            	5843, 424,
            	6193, 464,
            	...
            	6103, 496,
            	7198, 512,
            1, 8, 1, /* 7227: pointer.pointer.struct.env_md_ctx_st */
            	6900, 0,
            0, 56, 3, /* 7232: struct.ssl3_record_st */
            	117, 16,
            	117, 24,
            	117, 32,
            0, 1200, 10, /* 7241: struct.ssl3_state_st */
            	7264, 240,
            	7264, 264,
            	7232, 288,
            	7232, 344,
            	...
            	15, 512,
            	7208, 528,
            0, 24, 1, /* 7264: struct.ssl3_buffer_st */
            	117, 0,
            1, 8, 1, /* 7269: pointer.struct.bio_st */
            	7274, 0,
            0, 112, 7, /* 7274: struct.bio_st */
            	7291, 0,
            	7335, 8,
            	138, 16,
            	15, 48,
            	...
            	7338, 64,
            	4907, 96,
            1, 8, 1, /* 7291: pointer.struct.bio_method_st */
            	7296, 0,
            0, 80, 9, /* 7296: struct.bio_method_st */
            	5, 8,
            	7317, 16,
            	7320, 24,
            	7323, 32,
            ...
            8884097, 8, 0, /* 7320: pointer.func */
            8884097, 8, 0, /* 7323: pointer.func */
            8884097, 8, 0, /* 7326: pointer.func */
            8884097, 8, 0, /* 7329: pointer.func */
            8884097, 8, 0, /* 7332: pointer.func */
            8884097, 8, 0, /* 7335: pointer.func */
            1, 8, 1, /* 7338: pointer.struct.bio_st */
            	7274, 0,
            1, 8, 1, /* 7343: pointer.struct.ssl3_state_st */
            	7241, 0,
            0, 344, 9, /* 7348: struct.ssl2_state_st */
            	99, 24,
            	117, 56,
            	117, 64,
            	117, 72,
            	...
            	117, 128,
            	117, 136,
            1, 8, 1, /* 7369: pointer.struct.X509_algor_st */
            	499, 0,
            1, 8, 1, /* 7374: pointer.struct.X509_name_st */
            	7379, 0,
            0, 40, 3, /* 7379: struct.X509_name_st */
            	7388, 0,
            	7412, 16,
            	117, 24,
            1, 8, 1, /* 7388: pointer.struct.stack_st_X509_NAME_ENTRY */
            	7393, 0,
            0, 32, 2, /* 7393: struct.stack_st_fake_X509_NAME_ENTRY */
            	7400, 8,
            	125, 24,
            8884099, 8, 2, /* 7400: pointer_to_array_of_pointers_to_stack */
            	7407, 0,
            	122, 20,
            0, 8, 1, /* 7407: pointer.X509_NAME_ENTRY */
            	73, 0,
            1, 8, 1, /* 7412: pointer.struct.buf_mem_st */
            	7417, 0,
            0, 24, 1, /* 7417: struct.buf_mem_st */
            	138, 8,
            1, 8, 1, /* 7422: pointer.struct.ssl_st */
            	7427, 0,
            0, 808, 51, /* 7427: struct.ssl_st */
            	4597, 8,
            	7269, 16,
            	7269, 24,
            	7269, 32,
            	...
            	6793, 656,
            	6727, 680,
            1, 8, 1, /* 7532: pointer.struct.ssl2_state_st */
            	7348, 0,
            8884097, 8, 0, /* 7537: pointer.func */
            1, 8, 1, /* 7540: pointer.struct.stack_st_OCSP_RESPID */
            	7545, 0,
            0, 32, 2, /* 7545: struct.stack_st_fake_OCSP_RESPID */
            	7552, 8,
            	125, 24,
            8884099, 8, 2, /* 7552: pointer_to_array_of_pointers_to_stack */
            	7559, 0,
            	122, 20,
            0, 8, 1, /* 7559: pointer.OCSP_RESPID */
            	18, 0,
            1, 8, 1, /* 7564: pointer.struct.stack_st_X509_EXTENSION */
            	7569, 0,
            0, 32, 2, /* 7569: struct.stack_st_fake_X509_EXTENSION */
            	7576, 8,
            	125, 24,
            8884099, 8, 2, /* 7576: pointer_to_array_of_pointers_to_stack */
            	7583, 0,
            	122, 20,
            0, 8, 1, /* 7583: pointer.X509_EXTENSION */
            	2628, 0,
            8884097, 8, 0, /* 7588: pointer.func */
            8884097, 8, 0, /* 7591: pointer.func */
            1, 8, 1, /* 7594: pointer.struct.stack_st_X509_EXTENSION */
            	7599, 0,
            0, 32, 2, /* 7599: struct.stack_st_fake_X509_EXTENSION */
            	7606, 8,
            	125, 24,
            8884099, 8, 2, /* 7606: pointer_to_array_of_pointers_to_stack */
            	7613, 0,
            	122, 20,
            0, 8, 1, /* 7613: pointer.X509_EXTENSION */
            	2628, 0,
            1, 8, 1, /* 7618: pointer.struct.stack_st_DIST_POINT */
            	7623, 0,
            0, 32, 2, /* 7623: struct.stack_st_fake_DIST_POINT */
            	7630, 8,
            	125, 24,
            8884099, 8, 2, /* 7630: pointer_to_array_of_pointers_to_stack */
            	7637, 0,
            	122, 20,
            0, 8, 1, /* 7637: pointer.DIST_POINT */
            	3402, 0,
            1, 8, 1, /* 7642: pointer.struct.X509_pubkey_st */
            	731, 0,
            1, 8, 1, /* 7647: pointer.struct.x509_st */
            	7652, 0,
            0, 184, 12, /* 7652: struct.x509_st */
            	7679, 0,
            	7369, 8,
            	7736, 16,
            	138, 32,
            	...
            	7802, 144,
            	7807, 176,
            1, 8, 1, /* 7679: pointer.struct.x509_cinf_st */
            	7684, 0,
            0, 104, 11, /* 7684: struct.x509_cinf_st */
            	7709, 0,
            	7709, 8,
            	7369, 16,
            	7374, 24,
            	...
            	7594, 72,
            	7741, 80,
            1, 8, 1, /* 7709: pointer.struct.asn1_string_st */
            	7714, 0,
            0, 24, 1, /* 7714: struct.asn1_string_st */
            	117, 8,
            1, 8, 1, /* 7719: pointer.struct.X509_val_st */
            	7724, 0,
            0, 16, 2, /* 7724: struct.X509_val_st */
            	7731, 0,
            	7731, 8,
            1, 8, 1, /* 7731: pointer.struct.asn1_string_st */
            	7714, 0,
            1, 8, 1, /* 7736: pointer.struct.asn1_string_st */
            	7714, 0,
            0, 24, 1, /* 7741: struct.ASN1_ENCODING_st */
            	117, 0,
            0, 16, 1, /* 7746: struct.crypto_ex_data_st */
            	7751, 0,
            1, 8, 1, /* 7751: pointer.struct.stack_st_void */
            	7756, 0,
            0, 32, 1, /* 7756: struct.stack_st_void */
            	7761, 0,
            0, 32, 2, /* 7761: struct.stack_st */
            	1215, 8,
            	125, 24,
            1, 8, 1, /* 7768: pointer.struct.asn1_string_st */
            	7714, 0,
            1, 8, 1, /* 7773: pointer.struct.AUTHORITY_KEYID_st */
            	2701, 0,
            1, 8, 1, /* 7778: pointer.struct.stack_st_GENERAL_NAME */
            	7783, 0,
            0, 32, 2, /* 7783: struct.stack_st_fake_GENERAL_NAME */
            	7790, 8,
            	125, 24,
            8884099, 8, 2, /* 7790: pointer_to_array_of_pointers_to_stack */
            	7797, 0,
            	122, 20,
            0, 8, 1, /* 7797: pointer.GENERAL_NAME */
            	2744, 0,
            1, 8, 1, /* 7802: pointer.struct.NAME_CONSTRAINTS_st */
            	3546, 0,
            1, 8, 1, /* 7807: pointer.struct.x509_cert_aux_st */
            	7812, 0,
            0, 40, 5, /* 7812: struct.x509_cert_aux_st */
            	7825, 0,
            	7825, 8,
            	7849, 16,
            	7768, 24,
            	7854, 32,
            1, 8, 1, /* 7825: pointer.struct.stack_st_ASN1_OBJECT */
            	7830, 0,
            0, 32, 2, /* 7830: struct.stack_st_fake_ASN1_OBJECT */
            	7837, 8,
            	125, 24,
            8884099, 8, 2, /* 7837: pointer_to_array_of_pointers_to_stack */
            	7844, 0,
            	122, 20,
            0, 8, 1, /* 7844: pointer.ASN1_OBJECT */
            	363, 0,
            1, 8, 1, /* 7849: pointer.struct.asn1_string_st */
            	7714, 0,
            1, 8, 1, /* 7854: pointer.struct.stack_st_X509_ALGOR */
            	7859, 0,
            0, 32, 2, /* 7859: struct.stack_st_fake_X509_ALGOR */
            	7866, 8,
            	125, 24,
            8884099, 8, 2, /* 7866: pointer_to_array_of_pointers_to_stack */
            	7873, 0,
            	122, 20,
            0, 8, 1, /* 7873: pointer.X509_ALGOR */
            	3900, 0,
            0, 1, 0, /* 7878: char */
        },
        .arg_entity_index = { 7422, },
        .ret_entity_index = 7647,
    };
